...
- fix(smart-transactions): unsubscribe the smart transaction publish hook's controller-messenger listeners ([#1956](https://github.com/COG-GTM/metamask-mobile/pull/1956))
