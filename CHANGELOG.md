...
- fix: switch Dockerfile to node:20-bookworm-slim (digest-pinned) and upgrade apt packages to drop vulnerable unused OS packages ([#1895](https://github.com/COG-GTM/metamask-mobile/pull/1895))
