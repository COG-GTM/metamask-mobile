...
require('react-native-browser-polyfill'); // eslint-disable-line import/no-commonjs, @typescript-eslint/no-require-imports, @typescript-eslint/no-var-requires
...
function setupGlobalErrorHandler() {
  const { ErrorUtils: errorUtils } = global as unknown as {
    ErrorUtils: import('react-native').ErrorUtils;
  };
  ...
  errorUtils.setGlobalHandler(handleCustomError as (error: unknown, isFatal?: boolean) => void);
}
