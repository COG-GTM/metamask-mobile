...
// eslint-disable-next-line import/no-nodejs-modules, no-unused-vars, @typescript-eslint/no-unused-vars
...
function setupGlobalErrorHandler(): void {
  const rnGlobal = global as RNGlobal;
  const reactNativeDefaultHandler = rnGlobal.ErrorUtils.getGlobalHandler();
  ...
  rnGlobal.ErrorUtils.setGlobalHandler(handleCustomError as ErrorHandlerCallback);
}
