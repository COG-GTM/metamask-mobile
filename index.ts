...
function setupGlobalErrorHandler(): void {
  ...
  const reactNativeDefaultHandler: ErrorHandlerCallback = globalWithErrorUtils.ErrorUtils.getGlobalHandler();
  ...
  const wrappedHandler: ErrorHandlerCallback = (error: Error, isFatal?: boolean) => {
    handleCustomError(error, isFatal ?? false);
  };
  globalWithErrorUtils.ErrorUtils.setGlobalHandler(wrappedHandler);
}
