...
// Using 'any' for error type to match React Native's ErrorHandlerCallback signature
...
function setupGlobalErrorHandler(): void {
  ...
  // Type assertion needed because handleCustomError has a stricter Error type than the generic ErrorHandler
  ErrorUtils.setGlobalHandler(handleCustomError as ErrorHandler);
}
