...
const errorHandlerWrapper: ErrorHandlerCallback = (error: Error, isFatal?: boolean) => {
...
function setupGlobalErrorHandler(): void {
  const globalErrorUtils = (global as unknown as { ErrorUtils: GlobalErrorUtils }).ErrorUtils;
  const reactNativeDefaultHandler = globalErrorUtils.getGlobalHandler();
  setReactNativeDefaultHandler(reactNativeDefaultHandler);
  globalErrorUtils.setGlobalHandler(errorHandlerWrapper);
}
