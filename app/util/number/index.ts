...
// Setter Maps
export const toBigNumber: Record<string, (n: string | number | BN4) => BigNumber> = {
 ...
 * @returns {string}
 */
export function limitToMaximumDecimalPlaces(num: number, maxDecimalPlaces = 5): string {
 ...
 * If value is less than 5 precision decimals will show '< 0.00001'
 */
export function renderFromWei(value: number | string | BN4, decimalsToShow = 5): string {
  let renderWei = '0';
  // avoid undefined
  if (value) {
 ...
 */
export function calcTokenValueToSend(value: number | string | BN4 | undefined, decimals: number): string | 0 {
 ...
 */
export function safeNumberToBN(value: number | string | undefined): BN4 {
  try {
...
export const toHexadecimal = (decimal: string | number | undefined): string | undefined => {
