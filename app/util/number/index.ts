...
// @ts-expect-error @metamask/ethjs-unit has no TypeScript declarations.
import convert from '@metamask/ethjs-unit';
import { add0x, remove0x } from '@metamask/utils';
// @ts-expect-error number-to-bn has no TypeScript declarations.
 ...
 */
export const hexToBN = (inputHex: any): any =>
...
export function BNToHex(inputBn: any): any {
 ...
 */
export const addHexPrefix = (str: any): any => {
 ...
 */
export function fromWei(value: any = 0, unit: any = 'ether'): any {
...
export function fiatNumberToTokenMinimalUnit(
  ...
  let weiNumber: any = floatFiatConverted * base;
  // avoid decimals
 ...
 * If value is less than 5 precision decimals will show '< 0.00001'
 */
export function renderFromWei(value: any, decimalsToShow: any = 5): any {
  let renderWei = '0';
  // avoid undefined
  if (value) {
 ...
 */
export function calcTokenValueToSend(value: any, decimals: any): any {
 ...
 */
export function isBN(value: any): any {
 ...
 */
export function isDecimal(value: any): any {
  return (
 ...
 */
export function isNumber(str: any): any {
 ...
 */
export function isNumberValue(value: any): any {
...
export const dotAndCommaDecimalFormatter = (value: any): any => {
...
export const isNumberScientificNotationWhenString = (value: any): any => {
  if (typeof value !== 'number') {
    return false;
  }
 ...
 */
export function toWei(value: any, unit: any = 'ether'): any {
 ...
 */
export function toGwei(value: any, unit: any = 'ether'): any {
 ...
 */
export function renderToGwei(value: any, unit: any = 'ether'): any {
...
export function weiToFiatNumber(
  ...
  let value = parseFloat(String(Math.floor(eth * conversionRate * base) / base));
 ...
 */
export function handleWeiNumber(wei: any): any {
 ...
 * @returns {Object} - The converted balance as BN instance
 */
export function fiatNumberToWei(fiat: any, conversionRate: any): any {
  ...
  let weiNumber: any = Math.trunc(base * floatFiatConverted);
  // avoid decimals
  weiNumber = weiNumber.toLocaleString('fullwide', { useGrouping: false });
  const weiBN = safeNumberToBN(weiNumber);
  return weiBN;
...
export function fastSplit(value: any, divider: any = '.'): any {
...
export function getCurrencySymbol(currencyCode: any): any {
  if (currencySymbols[currencyCode]) {
 ...
 */
export function renderWei(value: any): any {
  if (!value) return '0';
  const wei = fromWei(value);
 ...
 */
export function renderNumber(number: any): any {
 ...
 * false otherwise.
 */
export function isPrefixedFormattedHexString(value: any): any {
...
export const toHexadecimal = (decimal: any = undefined): any => {
 ...
 */
export const isZeroValue = (value: any): any => {
...
export const safeBNToHex = (value: any): any => {
  if (value === null || value === undefined) {
    return value;
  }
 ...
 */
export const localizeLargeNumber = (i18n: any, number: any): any => {
...
export const convertDecimalToPercentage = (decimal: any): any => {
