 ...
 */
export function fromWei(value: string | number | BN4 = 0, unit = 'ether'): string {
 ...
 */
export function toTokenMinimalUnit(tokenValue: string | number, decimals: number): BN4 {
  const base = toBN(Math.pow(10, decimals).toString());
 ...
 * If value is less than 5 precision decimals will show '< 0.00001'
 */
export function renderFromWei(value: string | number | BN4 | undefined, decimalsToShow = 5): string {
  let renderWei = '0';
  // avoid undefined
  if (value) {
 ...
 */
export function toWei(value: string | number, unit = 'ether'): string {
 ...
 */
export function toGwei(value: string | number, unit = 'ether'): number {
 ...
 */
export function renderToGwei(value: string | number, unit = 'ether'): number {
...
export function weiToFiat(
  wei: BN4 | string | number | undefined,
 ...
 */
export function weiToFiatNumber(wei: BN4 | string | number, conversionRate: number, decimalsToShow = 5): number {
  const base = Math.pow(10, decimalsToShow);
 ...
 */
export function safeNumberToBN(value: string | number | undefined): BN4 {
  try {
 ...
 */
export function renderWei(value: BN4 | string | number | undefined): string {
  if (!value) return '0';
  const wei = fromWei(value);
...
const converter = ({
  ...
  roundDown,
}: ConverterOptions): string | number | BigNumber | BN4 => {
...
export const localizeLargeNumber = (i18n: I18nTranslator, number: number): string => {
