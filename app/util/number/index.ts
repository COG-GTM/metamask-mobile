...
type BNLike = BN4 | BN5;
type NumericValue = number | string | BNLike;
 ...
 */
export const hexToBN = (inputHex: NumericValue | BigNumber | undefined) =>
  typeof inputHex !== 'string'
    ? new BN4(inputHex as number | BN4, 16)
    : inputHex
...
export function BNToHex(inputBn: BNLike | BigNumber | string) {
...
export const toBigNumber = {
  ...
  BN: (n: BNLike) => new BigNumber(n.toString(16), 16),
};
 ...
 */
export function fromWei(value: NumericValue | BigNumber = 0, unit = 'ether') {
...
export function fromTokenMinimalUnit(
  ...
  const prefixedInput = addHexPrefix(
    typeof minimalInput === 'string' ? minimalInput : minimalInput.toString(16),
  );
...
export function renderFromTokenMinimalUnit(
  tokenValue: NumericValue | undefined,
  decimals: number,
  decimalsToShow = 5,
) {
 ...
 */
export function calcTokenValueToSend(value: number | BNLike, decimals: number) {
 ...
 */
export function toBN(value: number | string | BN4) {
 ...
 */
export function safeNumberToBN(value: NumericValue | undefined) {
  try {
 ...
 */
export function renderWei(value: NumericValue | undefined) {
  if (!value) return '0';
  const wei = fromWei(value);
...
const converter = ({
  ...
  roundDown,
}: ConversionOptions & { value: NumericValue | BigNumber }) => {
...
export const conversionUtil = (
  value: NumericValue | BigNumber | null | undefined,
  {
    fromCurrency = null,
...
// TODO: Replace "any" with type
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const toHexadecimal = (decimal?: number | string): any => {
...
export const safeBNToHex = (
  value: BNLike | string | null | undefined,
  // TODO: Replace "any" with type
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
): any => {
  if (value === null || value === undefined) {
