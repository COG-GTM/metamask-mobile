 ...
 */
export const hexToBN = (inputHex: string | number) =>
...
export function BNToHex(inputBn: { toString: (base: number) => string }): string {
 ...
 */
export function fromWei(value: number | string | object = 0, unit: string = 'ether') {
 ...
 */
export function toTokenMinimalUnit(tokenValue: number | string, decimals: number) {
  const base = toBN(Math.pow(10, decimals).toString());
...
export function renderFromTokenMinimalUnit(
  tokenValue: number | string | object,
  decimals: number,
 ...
 * @returns {string}
 */
export function limitToMaximumDecimalPlaces(num: number, maxDecimalPlaces: number = 5) {
 ...
 * If value is less than 5 precision decimals will show '< 0.00001'
 */
export function renderFromWei(value: number | string | object, decimalsToShow: number = 5) {
  let renderWei = '0';
  // avoid undefined
  if (value) {
 ...
 */
export function calcTokenValueToSend(value: number, decimals: number) {
 ...
 */
export function toBN(value: string) {
 ...
 */
export function toWei(value: number | string, unit: string = 'ether') {
 ...
 */
export function toGwei(value: number | string, unit: string = 'ether') {
 ...
 */
export function renderToGwei(value: number | string, unit: string = 'ether') {
 ...
 */
export function weiToFiatNumber(wei: number | string | object, conversionRate: number, decimalsToShow: number = 5) {
  const base = Math.pow(10, decimalsToShow);
 ...
 */
export function renderWei(value: number | string | object): string {
  if (!value) return '0';
  const wei = fromWei(value);
...
export const conversionUtil = (
  value: string | number,
  {
    ...
    conversionRate,
    invertConversionRate,
  }: Omit<ConverterParams, 'value' | 'roundDown'>,
) =>
  converter({
    fromCurrency,
    toCurrency,
...
export const calculateEthFeeForMultiLayer = ({
  ...
  ethFee = 0,
}: { multiLayerL1FeeTotal?: string; ethFee?: number | string }) => {
 ...
 */
export const isZeroValue = (value: string | number | object | null | undefined): boolean => {
...
export const formatValueToMatchTokenDecimals = (value: string | null | undefined, decimal: number) => {
  if (value === null || value === undefined) {
    return value;
  }
...
export const safeBNToHex = (value: object | null | undefined) => {
  if (value === null || value === undefined) {
    return value;
  }
