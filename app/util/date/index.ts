...
/**
 * Value accepted by the `Date` constructor.
 */
export type DateInput = number | string | Date;

const toDate = (timestamp: DateInput | undefined): Date =>
  new Date(timestamp ?? NaN);

export function toLocaleDateTime(timestamp: DateInput | undefined): string {
...
export function toDateFormat(timestamp: DateInput | undefined): string {
...
export function toLocaleTime(timestamp: DateInput | undefined): string {
