...
export function toLocaleDateTime(timestamp: string | number | Date) {
...
export function toDateFormat(timestamp: string | number | Date) {
...
export function toLocaleDate(timestamp: string | number | Date) {
  return new Date(timestamp).toLocaleDateString();
}

export function toLocaleTime(timestamp: string | number | Date) {
