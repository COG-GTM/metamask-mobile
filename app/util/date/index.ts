...
export function toLocaleDateTime(timestamp: DateInput) {
...
export function toDateFormat(timestamp: DateInput) {
...
export function toLocaleDate(timestamp: DateInput) {
  return new Date(timestamp).toLocaleDateString();
}

export function toLocaleTime(timestamp: DateInput) {
 ...
 */
export const formatTimestampToYYYYMMDD = (timestamp: DateInput) => {
  const date = new Date(timestamp);
