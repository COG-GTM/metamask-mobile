...
export function hexGreaterThan(a: NumericValue, b: NumericValue) {
...
export function addEth(...args: NumericValue[]): ConversionResult {
...
export function addFiat(...args: NumericValue[]): ConversionResult {
