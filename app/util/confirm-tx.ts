...
type ConversionArgs = Record<string, any>;
const untypedConversionUtil: any = conversionUtil;
...
export function increaseLastGasPrice(lastGasPrice: any): any {
  return addHexPrefix(
...
export function hexGreaterThan(a: any, b: any): any {
...
export function getHexGasTotal({ gasLimit, gasPrice }: ConversionArgs): any {
  return addHexPrefix(
...
export function addEth(...args: any[]): any {
...
export function addFiat(...args: any[]): any {
...
export function getValueFromWeiHex({
  ...
  return untypedConversionUtil(value, {
    fromNumericBase: 'hex',
    toNumericBase: 'dec',
    fromCurrency,
    toCurrency,
