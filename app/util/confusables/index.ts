...
/**
 * Collects the code points of `ensName` that are confusable with another
 * character (homoglyphs and zero-width characters).
 */
...
const zeroWidthPoints = new Set<string>([
  '\u200b', // zero width space
...
/**
 * Builds a deduplicated, human readable explanation for each confusable code
 * point returned by {@link collectConfusables}.
 */
