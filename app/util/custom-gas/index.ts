 ...
 */
export function apiEstimateModifiedToWEI(estimate: number) {
 ...
 * @returns {Object} - BN instance containing gas price in wei
 */
export function getWeiGasFee(estimate: number, gasLimit: number = 21000) {
 ...
 * @returns {Object} - BN instance containing gas price in wei
 */
export function getRenderableEthGasFee(estimate: number, gasLimit: number = 21000) {
