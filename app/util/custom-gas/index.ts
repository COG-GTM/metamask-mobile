 ...
 * @returns {Object} - BN instance containing gas price in wei
 */
export function getWeiGasFee(estimate: number, gasLimit = 21000) {
 ...
 * @returns {Object} - BN instance containing gas price in wei
 */
export function getRenderableEthGasFee(estimate: number, gasLimit = 21000) {
...
export async function getGasLimit(
  ...
  try {
    ...
    estimation = await estimateGas(newTransactionObj, networkClientId as string);
  } catch (error) {
    estimation = {
...
export function getValueFromWeiHex({
  ...
  return conversionUtil(value, {
    ...
    toDenomination,
    conversionRate,
  } as Parameters<typeof conversionUtil>[1]);
}
