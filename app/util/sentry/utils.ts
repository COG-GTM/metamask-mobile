...
type MaskValue = boolean | typeof AllProperties | { [key: string]: MaskValue; [AllProperties]?: MaskValue };
...
export const sentryStateMask: Record<string, MaskValue> = {
  accounts: true,
  alert: true,
  bookmarks: true,
  browser: true,
...
const ERROR_URL_ALLOWLIST: string[] = [
  'cryptocompare.com',
  'coingecko.com',
  'etherscan.io',
  'codefi.network',
...
function rewriteBreadcrumb(breadcrumb: Sentry.Breadcrumb): Sentry.Breadcrumb | null {
