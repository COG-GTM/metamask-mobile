...
/**
 * Ganache legacy-style options accepted at runtime.
 * These map to nested config options (e.g. `blockTime` -> `miner.blockTime`).
 */
...
export interface GanacheStartOptions extends GanacheOptions {
  mnemonic: string;
}
