        ...
        pendingApprovals: {
          '72424261-e22f-11ef-8e59-bf627a5d8354': {
            ...
            requestData: {
              ...
              origin: 'metamask.github.io',
              siwe:
              siweSignSignatureRequest.messageParams.
              siwe,
...
export let SignTypedDataMockType = /*#__PURE__*/function (SignTypedDataMockType) {SignTypedDataMockType["BATCH"] = "BATCH";SignTypedDataMockType["DAI"] = "DAI";return SignTypedDataMockType;}({});




const SIGN_TYPE_DATA = {
...
export function generateStateSignTypedData(mockType) {
