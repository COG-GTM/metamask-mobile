...
import {
  ...
  mockSnapAddress1,
  mockSnapAddress2,
  mockSolanaAddress } from
'./keyringControllerTestUtils';

export function createMockUuidFromAddress(address) {
 ...
 */
function getAccountTypeScopes(accountType) {
...
export const MOCK_ACCOUNT_BIP122_P2WPKH = {
...
export const MOCK_ACCOUNT_BIP122_P2WPKH_TESTNET = {
...
const mockQRHardwareInternalAccount =
createMockInternalAccount(
  mockQrKeyringAddress,
  'QR Hardware Account',
  KeyringTypes.qr
);
const mockSimpleKeyringInternalAccount =
createMockInternalAccount(
  mockSimpleKeyringAddress,
  'Simple Keyring Account',
  KeyringTypes.simple
);
const mockSnapAccount1InternalAccount =
createMockInternalAccount(
  mockSnapAddress1,
  'Snap Account 1',
  KeyringTypes.snap
);
const mockSnapAccount2InternalAccount =
createMockInternalAccount(
  mockSnapAddress2,
  'Snap Account 2',
  KeyringTypes.snap
...
export const MOCK_ACCOUNTS_CONTROLLER_STATE_WITH_KEYRING_TYPES =
{
