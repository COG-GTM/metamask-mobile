...
const MOCK_SIMPLE_KEYRING_METADATA = {
  id: '01JNG66ATK17YSN0TSS6H51EE3',
  name: ''
};

const MOCK_QR_KEYRING_METADATA = {
  id: '01JNG66NARF27JY9TGWJX385QW',
  name: ''
};

const MOCK_HD_KEYRING_METADATA = {
  id: '01JNG7170V9X27V5NFDTY04PJ4',
  name: ''
};

const MOCK_SNAP_KEYRING_METADATA = {
  id: '01JNG71B7GTWH0J1TSJY9891S0',
  name: ''
};

const MOCK_SECOND_HD_KEYRING_METADATA = {
  id: '01JSJNVTJEPSHZSNWAD3JT0PJN',
  name: ''
};

const MOCK_DEFAULT_KEYRINGS_METADATA = [
