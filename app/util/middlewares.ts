 ...
 * @returns {Function}
 */
export function createOriginMiddleware(opts: OriginMiddlewareOptions): (req: JsonRpcRequest, _: JsonRpcResponse, next: () => void) => void {
 ...
 * @returns {Function}
 */
export function createLoggerMiddleware(opts: OriginMiddlewareOptions): (req: JsonRpcRequest, res: JsonRpcResponse, next: (cb: (cb: () => void) => void) => void) => void {
  return function loggerMiddleware(
    req: JsonRpcRequest,
    res: JsonRpcResponse,
    next: (cb: (cb: () => void) => void) => void,
  ) {
    next((cb: () => void) => {
      if (res.error) {
