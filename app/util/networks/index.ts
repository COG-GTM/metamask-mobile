 ...
 * false otherwise.
 */
export function isPrefixedFormattedHexString(value: string | number | boolean | null | undefined): boolean {
 ...
 */
export const getNetworkImageSource = ({ networkType, chainId }: { networkType?: string; chainId: string }): unknown => {
