...
interface RpcNetworkConfigLike {
...
export function findBlockExplorerForRpc(
  rpcTargetUrl: string,
  networkConfigurations: Record<string, RpcNetworkConfigLike>,
) {
...
export const getNetworkNameFromProviderConfig = (providerConfig: {
  ...
  if (providerConfig.nickname) {
    ...
    const networkType = providerConfig.type as keyof typeof NetworkList;
    name =
      NetworkList?.[networkType]?.name ||
      NetworkList[RPC as keyof typeof NetworkList].name;
  }
  return name;
};
