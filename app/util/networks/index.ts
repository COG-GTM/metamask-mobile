// eslint-disable-next-line @typescript-eslint/no-shadow -- url-parse shadows the DOM URL global
...
export const NetworkList: Record<string, NetworkListEntry> = NetworkListEntries;
...
export default NetworkListEntries;
...
export const isMainnetByChainId = (chainId?: string | number) =>
  getDecimalChainId(String(chainId)) === String(1);

export const isLineaMainnetByChainId = (chainId?: string | number) =>
