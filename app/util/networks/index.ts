...
import { SolScope, type CaipChainId } from '@metamask/keyring-api';
 ...
 */
export const NetworkList: Record<string, NetworkListEntry> = {
  [MAINNET]: {
 ...
 */
export const getDecimalChainId = (chainId?: string): string | undefined => {
  if (
    !chainId ||
