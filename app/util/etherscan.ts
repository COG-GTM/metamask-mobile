 ...
 * @returns - URL string to the address on the relevant block explorer
 */
 ...
 * @returns - URL string to the transaction on the relevant block explorer
 */
 ...
 *
 * @param networkType - name of the network
 * @returns - Base URL string for the relevant block explorer
 */
