...
interface CurrencyArithmeticOptions extends ConverterInput {
  aBase?: number;
  bBase?: number;
...
const converter = ({
  ...
  let convertedValue: BigNumber = (
    fromNumericBase
      ? toBigNumber[fromNumericBase](value as ConversionValue)
      : value
  ) as BigNumber;
...
const addCurrencies = (
  a: ConversionValue,
  b: ConversionValue,
  options: CurrencyArithmeticOptions = {},
) => {
...
const toNegative = (n: ConversionValue, options: CurrencyArithmeticOptions = {}) =>
