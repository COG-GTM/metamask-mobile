...
interface CurrencyOptions extends Omit<ConverterParams, 'value'> {
  aBase?: number;
  bBase?: number;
...
const toNegative = (n: NumericValue, options: CurrencyOptions = {}): NumericValue =>
