 ...
 */
export const escapeSpecialUnicode = (str) => {
  if (!str) {
    return str;
  }
  if (!isString(str)) {
...
export const stripMultipleNewlines = (str) => {
