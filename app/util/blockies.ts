...
// The toDataUrl function is assigned to module.exports by the UMD factory above.
// We need to re-export it at the module level for TypeScript consumers.
export const toDataUrl: (address: any) => string = (module.exports as any).toDataUrl;
