/* eslint-disable no-var, eqeqeq, @typescript-eslint/prefer-for-of, @typescript-eslint/no-use-before-define, @typescript-eslint/no-unused-vars */
...
class PNG {
  ...
  color(red: number, green: number, blue: number, alpha?: number): string {
    ...
    if (typeof this.palette[colorVal] === 'undefined') {
      ...
      this.palette[colorVal] = String.fromCharCode(this.pindex++);
    }
