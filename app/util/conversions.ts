...
export function hexToDecimal(hexValue: string | number) {
...
interface EthConversionFromWeiHexOptions {
  value: string | number;
  fromCurrency?: string;
...
export function getEthConversionFromWeiHex({
  ...
  conversionRate,
  numberOfDecimals = 6,
}: EthConversionFromWeiHexOptions) {
...
interface WeiHexFromDecimalValueOptions {
  value: string | number;
  fromCurrency?: string;
  conversionRate?: number | null;
...
export function hexGWEIToHexWEI(decGWEI: string | number) {
  return conversionUtil(decGWEI, {
    fromNumericBase: 'hex',
    toNumericBase: 'hex',
    fromDenomination: 'GWEI',
...
export function hexWEIToDecGWEI(decGWEI: string | number) {
  return conversionUtil(decGWEI, {
    fromNumericBase: 'hex',
    toNumericBase: 'dec',
    fromDenomination: 'WEI',
...
export function hexWEIToDecETH(hexWEI: string | number) {
