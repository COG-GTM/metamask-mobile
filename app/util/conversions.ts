...
export function getEthConversionFromWeiHex({
  ...
  conversionRate,
  numberOfDecimals = 6,
}: { value: string; fromCurrency?: string; conversionRate: number; numberOfDecimals?: number }) {
...
export function getValueFromWeiHex({
  ...
  numberOfDecimals,
  toDenomination,
}: { value: string; fromCurrency?: string; toCurrency?: string; conversionRate?: number; numberOfDecimals?: number; toDenomination?: string }) {
...
}: { value: string; fromCurrency: string; conversionRate: number; fromDenomination?: string; invertConversionRate?: boolean }) {
  return conversionUtil(value, {
    fromNumericBase: 'dec',
    toNumericBase: 'hex',
    toCurrency: ETH,
...
export function decGWEIToHexWEI(decGWEI: string) {
...
export function decETHToDecWEI(decEth: string) {
...
export function formatETHFee(ethFee: string, currencySymbol: string = 'ETH', showLessThan?: boolean): string {
