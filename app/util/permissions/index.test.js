...
const mockRequestPermissionsIncremental = Engine.context.PermissionController.requestPermissionsIncremental;
const mockGrantPermissionsIncremental = Engine.context.PermissionController.grantPermissionsIncremental;
const mockReject = Engine.context.ApprovalController.reject;
...
describe('Permission Utils', () => {
  ...
  describe('rejectOriginApprovals', () => {
    ...
    beforeEach(() => {
      Engine.context.ApprovalController.state.pendingApprovals = { [id]: { id, origin } };
    });
