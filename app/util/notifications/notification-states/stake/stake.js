...
const isStaked = (n) => DIRECTION_MAP[n.type] === 'staked';

const descriptionStart = (n) =>
isStaked(n) ? n.data.stake_in.symbol : n.data.stake_out.symbol;

const descriptionEnd = (n) => {
