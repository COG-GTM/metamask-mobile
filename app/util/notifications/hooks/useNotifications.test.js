...
import {
  ...
  createMockNotificationEthSent } from
'../../../components/UI/Notification/__mocks__/mock_notifications';
// eslint-disable-next-line import/no-namespace
...
describe('useNotifications - useListNotifications()', () => {
  ...
  const arrangeAct = async (mutateMocks) => {
    // Arrange
...
describe('useNotifications - useContiguousLoading()', () => {
  ...
  const arrangeHook = (loading1, loading2) =>
  renderHook(
