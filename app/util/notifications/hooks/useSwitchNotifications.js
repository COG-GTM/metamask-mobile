...
import {
  ...
  toggleFeatureAnnouncements } from
...
import {
  ...
  selectIsUpdatingMetamaskNotificationsAccount } from
'../../../selectors/notifications';
import {
  useListNotifications,
  useEnableNotifications,
  useDisableNotifications,
  useContiguousLoading } from
'./useNotifications';
...
export function useFetchAccountNotifications(accounts) {
...
export function useSwitchNotificationLoadingText() {
