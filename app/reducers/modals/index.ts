...
const TOGGLE_NETWORK_MODAL = 'TOGGLE_NETWORK_MODAL' as const;
const TOGGLE_COLLECTIBLE_CONTRACT_MODAL =
  'TOGGLE_COLLECTIBLE_CONTRACT_MODAL' as const;
const TOGGLE_DAPP_TRANSACTION_MODAL =
  'TOGGLE_DAPP_TRANSACTION_MODAL' as const;
const TOGGLE_INFO_NETWORK_MODAL = 'TOGGLE_INFO_NETWORK_MODAL' as const;
const TOGGLE_SIGN_MODAL = 'TOGGLE_SIGN_MODAL' as const;
...
const initialState: Readonly<ModalsState> = {
