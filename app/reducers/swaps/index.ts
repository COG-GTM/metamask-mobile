...
export const setSwapsLiveness = (chainId: string, featureFlags: Record<string, unknown> | null): SwapsSetLivenessAction => ({
...
function addMetadata(chainId: string, tokens: Record<string, unknown>[], tokenList: Record<string, { name: string }>): Record<string, unknown>[] {
