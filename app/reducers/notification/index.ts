...
export type NotificationKind = (typeof NotificationTypes)[keyof typeof NotificationTypes];
...
interface UpdateNotificationStatusAction {
...
export const currentNotificationSelector = createSelector(
  (state: RootState) =>
    (state as unknown as { notifications?: Notification[] })?.notifications,
