...
interface SimpleNotificationFields {
  autodismiss?: number;
  title?: string;
  description?: string;
  status?: string;
...
interface TransactionNotificationFields {
  autodismiss?: number;
  transaction: NotificationTransaction;
  status?: string;
}
...
export type NotificationAction =
  ...
  | { type: typeof ACTIONS.HIDE_NOTIFICATION_BY_ID; id: Notification['id'] }
  | ({
      type: typeof ACTIONS.MODIFY_OR_SHOW_TRANSACTION_NOTIFICATION;
      id?: string;
    } & TransactionNotificationFields)
  | ({
      type: typeof ACTIONS.MODIFY_OR_SHOW_SIMPLE_NOTIFICATION;
      id?: string;
    } & SimpleNotificationFields)
  | {
      type: typeof ACTIONS.REPLACE_NOTIFICATION_BY_ID;
      id: Notification['id'];
      notification: Notification;
    }
  | { type: typeof ACTIONS.REMOVE_NOTIFICATION_BY_ID; id: Notification['id'] }
