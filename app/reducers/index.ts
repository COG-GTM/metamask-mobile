import bookmarksReducer, { type BookmarksState } from './bookmarks';
import browserReducer, { type BrowserState } from './browser';
import engineReducer from '../core/redux/slices/engine';
import privacyReducer, { type PrivacyState } from './privacy';
import modalsReducer, { type ModalsState } from './modals';
import settingsReducer, { type SettingsState } from './settings';
import alertReducer, { type AlertState } from './alert';
import transactionReducer, { type TransactionState } from './transaction';
import legalNoticesReducer from './legalNotices';
import userReducer, { UserState } from './user';
import wizardReducer, { type WizardState } from './wizard';
import onboardingReducer, { OnboardingState } from './onboarding';
import fiatOrders from './fiatOrders';
import swapsReducer, { type SwapsState } from './swaps';
import signatureRequestReducer from './signatureRequest';
import notificationReducer, { type NotificationState } from './notification';
import infuraAvailabilityReducer, {
  type InfuraAvailabilityState,
} from './infuraAvailability';
import collectiblesReducer, { type CollectiblesState } from './collectibles';
