...
import { ActionType } from '../../actions/rpcEvents';
 ...
 */
export const isWhitelistedRPC = (rpcName) =>
rpcToEventGroupMap.has(rpcName);

/**
 * Deference stage in RPC flow
 */
export let RPCStageTypes = /*#__PURE__*/function (RPCStageTypes) {RPCStageTypes["IDLE"] = "idle";RPCStageTypes["REQUEST_SEND"] = "request_send";RPCStageTypes["COMPLETE"] = "complete";RPCStageTypes["ERROR"] = "error";return RPCStageTypes;}({});
...
{
  const eventGroup = rpcToEventGroupMap.get(action.rpcName);
