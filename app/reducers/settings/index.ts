...
const settingsReducer = (
  ...
  switch (action.type) {
    ...
    case 'SET_HIDE_ZERO_BALANCE_TOKENS':
      return {
        ...state,
        hideZeroBalanceTokens: action.hideZeroBalanceTokens ?? state.hideZeroBalanceTokens,
      };
    ...
    case 'TOGGLE_BASIC_FUNCTIONALITY':
      return {
        ...state,
        basicFunctionalityEnabled: action.basicFunctionalityEnabled ?? state.basicFunctionalityEnabled,
      };
