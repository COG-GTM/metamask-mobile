...
const settingsReducer = (
  ...
  switch (action.type) {
    ...
    case SET_SHOW_HEX_DATA:
      return { ...state, showHexData: action.showHexData };
    case SET_SHOW_CUSTOM_NONCE:
      return { ...state, showCustomNonce: action.showCustomNonce };
    case SET_HIDE_ZERO_BALANCE_TOKENS:
      return { ...state, hideZeroBalanceTokens: action.hideZeroBalanceTokens };
    case SET_USE_BLOCKIE_ICON:
      return { ...state, useBlockieIcon: action.useBlockieIcon };
    case SET_PRIMARY_CURRENCY:
      return { ...state, primaryCurrency: action.primaryCurrency };
    case SET_SHOW_FIAT_ON_TESTNETS:
      return { ...state, showFiatOnTestnets: action.showFiatOnTestnets };
