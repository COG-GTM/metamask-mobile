...
): CollectiblesState['favorites'] => state.collectibles.favorites;
...
export const collectibleContractsSelector = createSelector(
  ...
  (address, chainId, allNftContracts) =>
    (address && allNftContracts[address]?.[chainId]) || [],
);
...
export const collectiblesSelector = createDeepEqualSelector(
  ...
  (address, chainId, allNfts) =>
    (address && allNfts[address]?.[chainId]) || [],
);
...
export const isCollectibleInFavoritesSelector = createSelector(
  ...
  (_state: RootStateSlice, collectible: FavoriteCollectible) => collectible,
