...
export const collectibleContractsSelector = createSelector(
  ...
  (address, chainId, allNftContracts) =>
    (allNftContracts as Record<string, Record<string, unknown[]>>)[address as string]?.[chainId] || [],
);

export const multichainCollectibleContractsSelector = createSelector(
  selectSelectedInternalAccountAddress,
  selectAllNftContracts,
  (address, allNftContracts) => (allNftContracts as Record<string, Record<string, unknown[]>>)[address as string] || {},
);
...
export const collectiblesSelector = createDeepEqualSelector(
  ...
  selectChainId,
  selectAllNfts,
  (address, chainId, allNfts) => (allNfts as Record<string, Record<string, unknown[]>>)[address as string]?.[chainId] || [],
);

export const multichainCollectiblesSelector = createDeepEqualSelector(
  selectSelectedInternalAccountAddress,
  selectAllNfts,
  (address, allNfts) => (allNfts as Record<string, Record<string, unknown[]>>)[address as string] || {},
);
