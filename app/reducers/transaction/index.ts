...
import {
  ...
  type TransactionSecurityAlertResponse,
} from '../../actions/transaction';

/**
 * Transaction as it is kept in state. `value` is held as a hex string while a
 * transaction is being edited and as a BN once it is prepared.
 */
export interface StateTransaction extends Omit<TransactionPayload, 'value'> {
  value?: BN | string;
}
