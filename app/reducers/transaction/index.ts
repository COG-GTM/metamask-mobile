...
// TODO: type SelectedAsset properly when TransactionTypes.js is migrated to TS
...
type ReducerAction = TransactionAction | { type: typeof REHYDRATE };

const transactionReducer = (state: TransactionState = initialState, action: ReducerAction): TransactionState => {
  switch (action.type) {
    case REHYDRATE:
      return {
        ...initialState,
