...
export type AssetType = 'ERC721' | 'ETH' | 'ERC20' | undefined;
...
const transactionReducer = (
  ...
  switch (action.type) {
    ...
    case 'PREPARE_TRANSACTION':
      return {
        ...state,
        transaction: action.transaction as Transaction,
      };
    case 'SET_TRANSACTION_OBJECT': {
      ...
      const txMeta = getTxMeta(
        transactionWithAssetType as Record<string, unknown>,
      );
      return {
        ...state,
        transaction: {
          ...state.transaction,
          ...getTxData(transactionWithAssetType as Record<string, unknown>),
        },
        ...txMeta,
