...
import { TransactionAction, SelectedAsset, SecurityAlertResponse } from '../../actions/transaction';

export interface TransactionInnerData {
  data?: string;
  from?: string;
  gas?: string;
  gasPrice?: string;
...
export interface TransactionState {
  ...
  transaction: TransactionInnerData;
...
type TransactionReducerAction = TransactionAction | { type: typeof REHYDRATE };
  ...
  switch (action.type) {
    ...
    case 'SET_ETHER_TRANSACTION':
      return {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        transaction: getTxData(action.transaction as any) as TransactionInnerData,
      };
