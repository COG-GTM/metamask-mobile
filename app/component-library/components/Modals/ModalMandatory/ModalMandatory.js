...
import {
  ...
  WEBVIEW_SCROLL_NOT_END_EVENT } from
'./ModalMandatory.constants';
...
const ModalMandatory = ({ route }) => {
  ...
  scrollEndBottomMargin ?? 1} >= document.documentElement.scrollHeight) {
  ...
  const renderWebView = (webviewBody) => {
