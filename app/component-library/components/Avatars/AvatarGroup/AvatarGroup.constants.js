...
// Mappings
export const TEXTVARIANT_BY_AVATARSIZE = {
...
export const SPACEBETWEENAVATARS_BY_AVATARSIZE =
{
  [AvatarSize.Xs]: -6,
  [AvatarSize.Sm]: -8,
  [AvatarSize.Md]: -12,
...
export const OVERFLOWTEXTMARGIN_BY_AVATARSIZE =
{
  [AvatarSize.Xs]: 2,
  [AvatarSize.Sm]: 4,
  [AvatarSize.Md]: 4,
...
// Sample consts
const SAMPLE_AVATARGROUP_AVATARPROPSLIST = [
{
...
export const SAMPLE_AVATARGROUP_PROPS = {
