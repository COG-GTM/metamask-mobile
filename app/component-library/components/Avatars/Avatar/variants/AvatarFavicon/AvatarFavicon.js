...
import {
  ...
  DEFAULT_AVATARFAVICON_SIZE } from
'./AvatarFavicon.constants';
...
const AvatarFavicon = ({
  ...
  const onSvgError = useCallback((e) => setSvgError(e), [setSvgError]);
  ...
  useEffect(() => {
    ...
    const checkSvgContentType = async (uri) => {
      try {
