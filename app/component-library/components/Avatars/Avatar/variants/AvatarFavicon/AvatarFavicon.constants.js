...
// Sample consts
export const SAMPLE_AVATARFAVICON_IMAGESOURCE_REMOTE = {
  uri: 'https://uniswap.org/favicon.ico'
};
export const SAMPLE_AVATARFAVICON_SVGIMAGESOURCE_REMOTE = {
  uri: 'https://metamask.github.io/test-dapp/metamask-fox.svg'
};
/* eslint-disable-next-line */
export const SAMPLE_AVATARFAVICON_IMAGESOURCE_LOCAL = require('../../../../../../images/branding/fox.png');

export const SAMPLE_AVATARFAVICON_PROPS = {
