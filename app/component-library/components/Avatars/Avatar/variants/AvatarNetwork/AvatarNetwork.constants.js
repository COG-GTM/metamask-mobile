...
// Sample consts
const SAMPLE_AVATARNETWORK_IMAGESOURCE_REMOTE = {
  uri: 'https://assets.coingecko.com/coins/images/279/small/ethereum.png?1595348880'
};

/* eslint-disable-next-line */
export const SAMPLE_AVATARNETWORK_IMAGESOURCE_LOCAL = require('../../../../../../images/ethereum.png');
export const SAMPLE_AVATARNETWORK_NAME = 'Ethereum';
export const SAMPLE_AVATARNETWORK_PROPS = {
