 ...
 * @param options.listAccounts - Returns all internal accounts.
 * @param options.findNetworkClientIdByChainId - Resolves a network client id for a chain id.
 */
