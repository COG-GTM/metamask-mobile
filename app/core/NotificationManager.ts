...
type ShowSimpleNotification = (
  args: SimpleNotification & { id: number; autodismiss?: number },
) => void;

type RemoveNotificationById = (id: TransactionId) => void;

export interface NotificationManagerInitArgs {
...
class NotificationManager {
   ...
   */
  _transactionToView: TransactionId[] = [];
  /**
   ...
   */
  _transactionsWatchTable: Record<string, TransactionId[]> = {};
  ...
  _viewTransaction = (id: TransactionId) => {
   ...
   */
  setTransactionToView = (id: TransactionId) => {
    this._transactionToView.push(id);
  };
