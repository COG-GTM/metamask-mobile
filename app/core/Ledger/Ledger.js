 ...
 */
export const withLedgerKeyring = async (
operation) =>
 ...
 */
export const forgetLedger = async () => {
  await withLedgerKeyring(async ({ keyring }) => {
 ...
 */
export const setHDPath = async (path) => {
  await withLedgerKeyring(async ({ keyring }) => {
    if (isValidPath(path)) {
 ...
 */
export const checkAccountNameExists = async (accountName) => {
 ...
 */
export const unlockLedgerWalletAccount = async (index) => {
  const accountsController = Engine.context.AccountsController;
