...
class MetaMetrics {
   ...
   * @private
   */
  #getIsDataRecordedFromPrefs = async () =>
   ...
   * @private
   */
  #getDeleteRegulationDateFromPrefs = async () =>
   ...
   * @private
   */
  #getDeleteRegulationIdFromPrefs = async () =>
   ...
   */
  #setIsDataRecorded = async (isDataRecorded = false) => {
   ...
   */
  #setDeleteRegulationCreationDate = async () => {
  ...
  #getMetaMetricsId = async () => {
    ...
    const metametricsId = await StorageWrapper.getItem(
      METAMETRICS_ID
    );
    if (!metametricsId) {
   ...
   */
  #storeMetricsOptInPreference = async (enabled) => {
    try {
   ...
   */
  flush = async () => this.segmentClient?.flush();
   ...
   */
  getDeleteRegulationId = () => this.deleteRegulationId;
