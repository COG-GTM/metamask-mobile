...
enum EVENT_NAME {
  ...
  SAFE_CHAINS_LIST_VALIDATION_FAILED = 'Safe Chains List Validation Failed',
...
const events = {
  ...
  SAFE_CHAINS_LIST_VALIDATION_FAILED: generateOpt(
    EVENT_NAME.SAFE_CHAINS_LIST_VALIDATION_FAILED,
  ),
