...
import MobilePortStream, { type MobilePort } from '../MobilePortStream';
...
/**
 * Options accepted by the {@link BackgroundBridge} constructor.
 */
export interface BackgroundBridgeOptions {
  webview: { current?: unknown } | null;
  url: string;
  getRpcMethodMiddleware: (
    args: RPCMethodsMiddleParameters,
      ...
      createEip1193MethodMiddleware({
        ...
        revokePermissionsForOrigin: (permissionKeys: string[]) => {
          try {
            ...
            } as Parameters<typeof PermissionController.revokePermissions>[0]);
          } catch (e) {
