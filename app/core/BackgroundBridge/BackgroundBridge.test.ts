...
// Engine.context is provided by the mocked Engine, whose methods are jest mocks
// returning loosely shaped values that do not match the controller signatures
const asMock = (fn: unknown): jest.Mock => fn as jest.Mock;

const mockedCreateEip1193MethodMiddleware = asMock(
  createEip1193MethodMiddleware,
);
const mockedCreateEthAccountsMethodMiddleware = asMock(
