...
class SecureKeychain {
  static instance: SecureKeychain | null = null;
  ...
  decryptPassword(str: string): Promise<DecryptedPassword> {
    ...
    return encryptor.decrypt(privateData.code, str);
  }
}
...
interface SecureKeychainModule {
  ...
  setGenericPassword: (password: string, type: string) => Promise<void>;
