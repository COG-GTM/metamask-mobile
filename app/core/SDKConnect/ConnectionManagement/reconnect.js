...
async function reconnect({
  ...
  try {
    ...
    if (instance.state.paused && updateKey) {
      ...
      if (currentOtherPublicKey !== otherPublicKey) {
        console.warn(
          ...
          existingConnection !== undefined} - update otherPublicKey -  ${
          currentOtherPublicKey} --> ${otherPublicKey}`
        );
    ...
    DevLogger.log(
      ...
      instance.state.paused} connecting=${
      connecting} socketConnected=${socketConnected} existingConnection=${
