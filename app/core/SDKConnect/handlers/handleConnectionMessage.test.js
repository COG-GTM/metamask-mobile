...
describe('handleConnectionMessage', () => {
  const mockHandleSendMessage = handleSendMessage;



  const mockHandleCustomRpcCalls = handleCustomRpcCalls;



  const mockCheckPermissions = checkPermissions;
  ...
  const mockDevLoggerLog = DevLogger.log;
