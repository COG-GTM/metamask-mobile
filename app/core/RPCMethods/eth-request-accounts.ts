...
/**
 * Hooks into the background required by the `eth_requestAccounts` handler.
 */
...
async function requestEthereumAccountsHandler(
  ...
  // @ts-expect-error `trackDappViewedEvent` takes a single object argument;
  // this call site passes positional arguments and is asserted as such by the
  // unit tests, so it is left untouched by this conversion.
