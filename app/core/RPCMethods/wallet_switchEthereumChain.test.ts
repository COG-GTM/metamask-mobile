import { wallet_switchEthereumChain as wallet_switchEthereumChainImpl } from './wallet_switchEthereumChain';
...
const wallet_switchEthereumChain = (args: Record<string, unknown>) =>
  wallet_switchEthereumChainImpl(
    args as unknown as Parameters<typeof wallet_switchEthereumChainImpl>[0],
  );
