...
import {
  ...
  PermissionDoesNotExistError } from
...
export let ApprovalTypes = /*#__PURE__*/function (ApprovalTypes) {ApprovalTypes["CONNECT_ACCOUNTS"] = "CONNECT_ACCOUNTS";ApprovalTypes["SIGN_MESSAGE"] = "SIGN_MESSAGE";ApprovalTypes["ADD_ETHEREUM_CHAIN"] = "ADD_ETHEREUM_CHAIN";ApprovalTypes["SWITCH_ETHEREUM_CHAIN"] = "SWITCH_ETHEREUM_CHAIN";ApprovalTypes["REQUEST_PERMISSIONS"] = "wallet_requestPermissions";ApprovalTypes["WALLET_CONNECT"] = "WALLET_CONNECT";ApprovalTypes["PERSONAL_SIGN"] = "personal_sign";ApprovalTypes["ETH_SIGN_TYPED_DATA"] = "eth_signTypedData";ApprovalTypes["WATCH_ASSET"] = "wallet_watchAsset";ApprovalTypes["TRANSACTION"] = "transaction";ApprovalTypes["RESULT_ERROR"] = "result_error";ApprovalTypes["RESULT_SUCCESS"] = "result_success";ApprovalTypes["SMART_TRANSACTION_STATUS"] = "smart_transaction_status";
  ...
  ApprovalTypes["INSTALL_SNAP"] = "wallet_installSnap";ApprovalTypes["UPDATE_SNAP"] = "wallet_updateSnap";ApprovalTypes["SNAP_DIALOG"] = "snap_dialog";
 ...
 */
export const getRpcMethodMiddlewareHooks = (origin) => ({
  getCaveat: ({
    target,
    caveatType
...
export const getRpcMethodMiddleware = ({
  ...
  createAsyncMiddleware(async (req, res, next) => {
    ...
    const setApprovalFlowLoadingText = (opts) => {
      ...
      await revokePermissionsHandler.implementation(
        ...
        },
        {
          revokePermissionsForOrigin: (permissionKeys) => {
            ...
            }} }), wallet_getPermissions: async () => // TODO: Replace "any" with type
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      new Promise((resolve) => {
