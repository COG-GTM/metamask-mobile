...
import { Hex, PendingJsonRpcResponse } from '@metamask/utils';
...
describe('RPC Method - wallet_addEthereumChain', () => {
  ...
  let otherOptions: Omit<Parameters<typeof wallet_addEthereumChain>[0], 'req'>;

  beforeEach(() => {
    jest.clearAllMocks();
    otherOptions = {
      res: {} as PendingJsonRpcResponse<null>,
