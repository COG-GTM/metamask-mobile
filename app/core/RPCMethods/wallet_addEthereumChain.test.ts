...
type OtherOptions = Omit<AddEthereumChainParams, 'req'>;

const mockRequest = (req: Record<string, unknown>) =>
  req as unknown as AddEthereumChainParams['req'];
