...
type AddEthereumChainArgs = Parameters<typeof wallet_addEthereumChain>[0];

interface AddChainOtherOptions {
        ...
        backgroundState: {
          NetworkController: {
            ...mockNetworkState(
              ...
              } as unknown as Parameters<typeof mockNetworkState>[number],
            ),
          },
        },
      },
...
describe('RPC Method - wallet_addEthereumChain', () => {
  ...
  let otherOptions: AddChainOtherOptions;
  ...
  it('should report missing params', async () => {
    try {
      await wallet_addEthereumChain({
        ...
        ...otherOptions,
      } as unknown as AddEthereumChainArgs);
    } catch (error) {
  ...
  it('should allow 1 letter native currency symbols', async () => {
    ...
    jest
      ...
      .mockReturnValue(
        networkConfigurationResult as unknown as NetworkConfiguration,
      );
  ...
  it('should update the networkConfiguration that has a chainId that already exists in wallet state, and should switch to the existing network', async () => {
    const spyOnUpdateNetwork = jest
      ...
      .mockReturnValue(
        networkConfigurationResult as unknown as ReturnType<
          typeof Engine.context.NetworkController.updateNetwork
        >,
      );
