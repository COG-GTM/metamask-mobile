          ...
          NetworkController: {
            ...mockNetworkState(
              ...
              },
              {
                ...
                ...(existingNetworkConfiguration as any),
              },
            ),
          },
        },
...
describe('RPC Method - wallet_addEthereumChain', () => {
  ...
  it('should allow 1 letter native currency symbols', async () => {
    ...
    jest
      ...
      .mockReturnValue(networkConfigurationResult as unknown as ReturnType<typeof Engine.context.NetworkController.addNetwork>);
