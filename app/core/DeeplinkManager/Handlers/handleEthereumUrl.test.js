...
import {
  ...
  isDeeplinkRedesignedConfirmationCompatible } from
'../../../components/Views/confirmations/utils/deeplink';
...
describe('handleEthereumUrl', () => {
  ...
  const mockGetDecimalChainId = getDecimalChainId;
  ...
  it('switches to mainnet when isEvmSelected is false', async () => {
    ...
    const mockState = Engine.context.MultichainNetworkController.state;
