...
///: BEGIN:ONLY_INCLUDE_IF(preinstalled-snaps,external-snaps)
import { createSnapRestrictedMethods as createSnapRestrictedMethodsUtil } from './utils/snap-restricted-methods';
///: END:ONLY_INCLUDE_IF
///: BEGIN:ONLY_INCLUDE_IF(keyring-snaps)
import { createKeyringSnapMethods as createKeyringSnapMethodsUtil } from './utils/snap-restricted-methods';
///: END:ONLY_INCLUDE_IF
...
export class Engine {
  ...
  constructor(
    ...
    const snapRestrictedMethods = createSnapRestrictedMethodsUtil({
    ...
    ///: BEGIN:ONLY_INCLUDE_IF(keyring-snaps)
    const keyringSnapMethods = createKeyringSnapMethodsUtil({
  ...
  getTotalEvmFiatAccountBalance = (
    ...
    getTotalEvmFiatAccountBalanceUtil(this.context, account);
   ...
   */
  hasFunds = () => hasFundsUtil(this.context);
