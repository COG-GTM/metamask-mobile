...
import {
  ...
  BITCOIN_WALLET_NAME,
  BitcoinWalletSnapSender } from
'./BitcoinWalletSnap';
import {
  SOLANA_WALLET_SNAP_ID,
  SOLANA_WALLET_NAME,
  SolanaWalletSnapSender } from
'./SolanaWalletSnap';
...
export let WalletClientType = /*#__PURE__*/function (WalletClientType) {WalletClientType["Bitcoin"] = "bitcoin";WalletClientType["Solana"] = "solana";return WalletClientType;}({});
...
export class MultichainWalletSnapClient {
   ...
   * @throws Error if account discovery or addition fails
   */
  async addDiscoveredAccounts(entropySource) {
...
export class BitcoinWalletSnapClient extends MultichainWalletSnapClient {
  constructor(snapKeyringOptions) {
