import {
  ...
  getDefaultInternalOptions } from
...
class SnapKeyringImpl {
  ...
  constructor(
  messenger,
  { persistKeyringHelper, removeAccountHelper })
  {
  ...
  handleUserInput)
  {
    ...
    try {
      ...
      Logger.error(error, `Error removing snap account: ${address}`);
      const snapName = getSnapName(snapId, this.#messenger);
      trackSnapAccountEvent(
        MetaMetricsEvents.ACCOUNT_REMOVED,
        snapId,
