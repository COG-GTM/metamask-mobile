...
export default {
  ...
  // Core Settings
  DEFAULT_LOCK_TIMEOUT: 30 * SECOND,
  DEFAULT_SEARCH_ENGINE: 'Google',
  TX_CHECK_BACKGROUND_FREQUENCY: 30 * SECOND,
  ...
  SWAPS: {
    ...
    ONLY_MAINNET: true,
    CLIENT_ID: 'mobile',
    LIVENESS_POLLING_FREQUENCY: 5 * MINUTE,
    POLL_COUNT_LIMIT: 4,
    DEFAULT_SLIPPAGE: 2,
    DEFAULT_SLIPPAGE_STABLECOINS: 0.5,
    CACHE_AGGREGATOR_METADATA_THRESHOLD: 5 * MINUTE,
    CACHE_TOKENS_THRESHOLD: 5 * MINUTE,
    CACHE_TOP_ASSETS_THRESHOLD: 5 * MINUTE,
  },
  ...
  FEATURE_FLAGS_API: {
    ...
    VERSION: 'v1',
    DEFAULT_FETCH_INTERVAL: 15 * MINUTE,
  },
} as const;
