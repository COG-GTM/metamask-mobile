 ...
 */
export let CipherAlgorithmQuickCrypto = /*#__PURE__*/function (CipherAlgorithmQuickCrypto) {CipherAlgorithmQuickCrypto["Cbc"] = "AES-CBC";return CipherAlgorithmQuickCrypto;}({});
 ...
 */
export let HashAlgorithmQuickCrypto = /*#__PURE__*/function (HashAlgorithmQuickCrypto) {HashAlgorithmQuickCrypto["Sha512"] = "SHA-512";return HashAlgorithmQuickCrypto;}({});
 ...
 */
class QuickCryptoEncryptionLibrary {
  /**
   ...
   */
  exportKey = async (importFormat, key) => {
    // @ts-expect-error - This should be as CryptoKey but the type is not exported
