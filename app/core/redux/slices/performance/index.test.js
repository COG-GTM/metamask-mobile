...
const mockSelectPerformanceData = (state) => state.performance;
const mockSelectPerformanceMetrics = (state) =>
state.performance.metrics;
const mockSelectPerformanceSession = (state) => ({
