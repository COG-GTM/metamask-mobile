...
import {
  ...
  formatBlockExplorerTransactionUrl } from
'./networks';
 ...
 */
export function isEthAccount(account) {
 ...
 */
export function isSolanaAccount(account) {
 ...
 */
export function isNonEvmAddress(address) {
 ...
 */
export function nonEvmNetworkChainIdByAccountAddress(address) {
...
export function lastSelectedAccountAddressInEvmNetwork() {
  const { AccountsController } = Engine.context;
  // TODO: Add teh logic if there is none last selected account what to do
 ...
 */
export function isNonEvmChainId(chainId) {
 ...
 */
export function isBtcAccount(account) {
 ...
 */
export function shortenTransactionId(txId) {
