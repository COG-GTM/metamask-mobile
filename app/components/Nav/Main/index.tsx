...
const MainNavigatorWithNavigation =
  MainNavigator as unknown as React.ComponentType<NavigationOnlyProps>;

const NotificationWithNavigation =
  Notification as unknown as React.ComponentType<NavigationOnlyProps>;
...
const Main = (props: MainProps) => {
  ...
  const renderDeprecatedNetworkAlert = (
    currentChainId: Hex,
    isBackUpSeedphraseVisible: boolean,
  ) => {
      ...
      if (NETWORKS_CHAIN_ID.MUMBAI === currentChainId) {
        return (
          <WarningAlert
            ...
            precedentAlert={isBackUpSeedphraseVisible}
          />
        );
      }
      return (
