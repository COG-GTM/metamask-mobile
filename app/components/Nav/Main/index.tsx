...
interface OwnProps {
  navigation: Record<string, (...args: unknown[]) => unknown> & { navigate: (route: string, params?: Record<string, unknown>) => void };
...
Main.router = (MainNavigator as Record<string, unknown>).router;

const mapStateToProps = (state: Record<string, Record<string, unknown>>): StateProps => ({
  showIncomingTransactionsNetworks:
