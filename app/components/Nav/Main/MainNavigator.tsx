...
interface ScreenWithNavigationOptions {
  navigationOptions?: ScreenOptions;
}

const navigationOptionsOf = (component: unknown): ScreenOptions =>
  (component as ScreenWithNavigationOptions).navigationOptions;
...
const modalScreenProps = { mode: 'modal' };

const setPasswordFlowHeaderProps = {
  headerTitle: () => (
    <Image
