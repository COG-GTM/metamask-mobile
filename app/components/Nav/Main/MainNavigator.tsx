...
/**
 * Options a screen may declare through a `navigationOptions` static.
 */
...
/**
 * Most screens still declare their header configuration as a `navigationOptions`
 * static, which is not part of any React Navigation component type. Reading it
 * through this helper keeps the navigator call sites typed.
 */
const getNavigationOptions = (
  screen: unknown,
): ScreenNavigationOptions | undefined => {
  if (typeof screen !== 'function' && typeof screen !== 'object') {
    return undefined;
  }
  return (screen as { navigationOptions?: ScreenNavigationOptions })
    .navigationOptions;
};

interface AssetRouteProps {
  route: RouteProp<{ Asset: { address?: string } | undefined }, 'Asset'>;
}

interface CollectibleRouteProps {
  route: RouteProp<
    { NftDetails: { collectible?: unknown } | undefined },
    'NftDetails'
  >;
}

/**
 * Imperative handle exposed by the `Drawer` component.
 */
interface DrawerRef {
  dismissDrawer: () => void;
  showDrawer: () => void;
...
/**
 * Tab options, including the extra options read by the custom `TabBar`.
 */
type TabScreenOptions = BottomTabNavigationOptions & {
...
const AssetStackFlow = (props: AssetRouteProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name={'Asset'}
      component={Asset}
...
const AssetModalFlow = (props: AssetRouteProps) => (
  <Stack.Navigator
    mode={'modal'}
...
const WalletTabStackFlow = () => (
  <Stack.Navigator initialRouteName={'WalletView'}>
    ...
    <Stack.Screen
      name="AddAsset"
      component={AddAsset}
      options={getNavigationOptions(AddAsset)}
    />
    <Stack.Screen
      name="Collectible"
      component={Collectible}
      options={getNavigationOptions(Collectible)}
    />
    <Stack.Screen
      name="ConfirmAddAsset"
      component={ConfirmAddAsset}
      options={getNavigationOptions(ConfirmAddAsset)}
    />
    <Stack.Screen
...
const BrowserFlow = (props: AssetRouteProps) => (
  <Stack.Navigator
  ...
  >
    ...
    <Stack.Screen
      ...
      options={getNavigationOptions(SwapsAmountView)}
    />
    <Stack.Screen
      name="SwapsQuotesView"
      component={SwapsQuotesView}
      options={getNavigationOptions(SwapsQuotesView)}
    />
  </Stack.Navigator>
);
...
const SnapsSettingsStack = () => (
  <Stack.Navigator>
    <Stack.Screen
      ...
      options={getNavigationOptions(SnapsSettingsList)}
    />
    <Stack.Screen
      name={Routes.SNAPS.SNAP_SETTINGS}
      component={SnapSettings}
      options={getNavigationOptions(SnapSettings)}
    />
  </Stack.Navigator>
);
///: END:ONLY_INCLUDE_IF
...
const NotificationsOptInStack = () => (
  <Stack.Navigator initialRouteName={Routes.NOTIFICATIONS.OPT_IN}>
    ...
    <Stack.Screen
      ...
      options={getNavigationOptions(NotificationsSettings)}
    />
  </Stack.Navigator>
);
...
const SettingsFlow = () => (
  <Stack.Navigator initialRouteName={'Settings'}>
    <Stack.Screen
      name="Settings"
      component={Settings}
      options={getNavigationOptions(Settings)}
    />
    <Stack.Screen
      name="GeneralSettings"
      component={GeneralSettings}
      options={getNavigationOptions(GeneralSettings)}
    />
    <Stack.Screen
      name="AdvancedSettings"
      component={AdvancedSettings}
      options={getNavigationOptions(AdvancedSettings)}
    />
    ...
    <Stack.Screen
      ...
      options={getNavigationOptions(SecuritySettings)}
    />
    ...
    />
    {
      ...
      isTest && (
        <Stack.Screen
          ...
          options={getNavigationOptions(AesCryptoTestForm)}
        />
      )
    }
    <Stack.Screen
      ...
      options={getNavigationOptions(ExperimentalSettings)}
    />
    <Stack.Screen
      name="NetworksSettings"
      component={NetworksSettings}
      options={getNavigationOptions(NetworksSettings)}
    />
    <Stack.Screen
      name="CompanySettings"
      component={AppInformation}
      options={getNavigationOptions(AppInformation)}
    />
    {process.env.MM_ENABLE_SETTINGS_PAGE_DEV_OPTIONS === 'true' && (
      <Stack.Screen
        name={Routes.SETTINGS.DEVELOPER_OPTIONS}
        component={DeveloperOptions}
        options={getNavigationOptions(DeveloperOptions)}
      />
    )}
    ...
    <Stack.Screen
      ...
      component={Contacts}
      options={getNavigationOptions(Contacts)}
    />
    <Stack.Screen
      name="ContactForm"
      component={ContactForm}
      options={getNavigationOptions(ContactForm)}
    />
    <Stack.Screen
    ...
    <Stack.Screen
      ...
      options={getNavigationOptions(WalletConnectSessions)}
    />
    <Stack.Screen
      name="ResetPassword"
      component={ResetPassword}
      options={getNavigationOptions(ResetPassword)}
    />
    <Stack.Screen
      name="AccountBackupStep1B"
      component={AccountBackupStep1B}
      options={getNavigationOptions(AccountBackupStep1B)}
    />
    <Stack.Screen
      name="ManualBackupStep1"
      component={ManualBackupStep1}
      options={getNavigationOptions(ManualBackupStep1)}
    />
    <Stack.Screen
      name="ManualBackupStep2"
      component={ManualBackupStep2}
      options={getNavigationOptions(ManualBackupStep2)}
    />
    <Stack.Screen
      name="ManualBackupStep3"
      component={ManualBackupStep3}
      options={getNavigationOptions(ManualBackupStep3)}
    />
    <Stack.Screen
      name="EnterPasswordSimple"
      component={EnterPasswordSimple}
      options={getNavigationOptions(EnterPasswordSimple)}
    />
    <Stack.Screen
      name={Routes.SETTINGS.NOTIFICATIONS}
      component={NotificationsSettings}
    ...
    <Stack.Screen
      ...
      options={getNavigationOptions(BackupAndSyncSettings)}
    />
    {
      ///: BEGIN:ONLY_INCLUDE_IF(external-snaps)
    }
...
const HomeTabs = () => {
  ...
  const options: Record<
    'home' | 'actions' | 'browser' | 'activity' | 'settings',
    TabScreenOptions
  > = {
    home: {
  ...
  const renderTabBar = ({
    ...
    if (isKeyboardHidden) {
      return (
        <TabBar
          state={state}
          // Every tab screen declares the extra options TabBar reads.
          descriptors={descriptors as TabBarProps['descriptors']}
...
const Webview = () => (
  <Stack.Navigator>
    <Stack.Screen
      ...
      options={getNavigationOptions(SimpleWebview)}
    />
  </Stack.Navigator>
);
...
const SendView = () => (
  <Stack.Navigator>
    <Stack.Screen
      name="Send"
      component={Send}
      options={getNavigationOptions(Send)}
    />
  </Stack.Navigator>
);

const NftDetailsModeView = (props: CollectibleRouteProps) => (
  <Stack.Navigator>
    <Stack.Screen
...
const NftDetailsFullImageModeView = (props: CollectibleRouteProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name=" " // No name here because this title will be displayed in the header of the page
...
const SendFlowView = () => (
  <Stack.Navigator>
    <Stack.Screen
      name="SendTo"
      component={SendTo}
      options={getNavigationOptions(SendTo)}
    />
    <Stack.Screen
      name="Amount"
      component={Amount}
      options={getNavigationOptions(Amount)}
    />
    <Stack.Screen
      name={Routes.SEND_FLOW.CONFIRM}
      component={Confirm}
      options={getNavigationOptions(Confirm)}
    />
    <Stack.Screen
...
const AddBookmarkView = () => (
  <Stack.Navigator>
    <Stack.Screen
      ...
      options={getNavigationOptions(AddBookmark)}
    />
  </Stack.Navigator>
);
...
const OfflineModeView = () => (
  <Stack.Navigator>
    <Stack.Screen
      ...
      options={getNavigationOptions(OfflineMode)}
    />
  </Stack.Navigator>
);
...
const PaymentRequestView = () => (
  <Stack.Navigator>
    <Stack.Screen
      ...
      options={getNavigationOptions(PaymentRequest)}
    />
    <Stack.Screen
      name="PaymentRequestSuccess"
      component={PaymentRequestSuccess}
      options={getNavigationOptions(PaymentRequestSuccess)}
    />
  </Stack.Navigator>
);
...
const NotificationsModeView = () => (
  <Stack.Navigator>
    <Stack.Screen
      ...
      options={getNavigationOptions(NotificationsView)}
    />
    <Stack.Screen
      name={Routes.SETTINGS.NOTIFICATIONS}
      component={NotificationsSettings}
    ...
    <Stack.Screen
      name={Routes.NOTIFICATIONS.OPT_IN}
      component={OptIn}
      options={getNavigationOptions(OptIn)}
    />
    <Stack.Screen
      name={Routes.NOTIFICATIONS.DETAILS}
      component={NotificationsDetails}
      options={getNavigationOptions(NotificationsDetails)}
    />
    <Stack.Screen
      name="ContactForm"
      component={ContactForm}
...
const SetPasswordFlow = () => (
  <Stack.Navigator>
    <Stack.Screen
      ...
      options={getNavigationOptions(ChoosePassword)}
    />
    <Stack.Screen
      name="AccountBackupStep1"
      component={AccountBackupStep1}
      options={getNavigationOptions(AccountBackupStep1)}
    />
    <Stack.Screen
      name="AccountBackupStep1B"
      component={AccountBackupStep1B}
    ...
    <Stack.Screen
      ...
      options={getNavigationOptions(OptinMetrics)}
    />
  </Stack.Navigator>
);
