...
const getNavigationOptions = (
  ...
  (component as { navigationOptions?: StackNavigationOptions }).navigationOptions;
...
const AssetStackFlow = (props: NavigatorProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name={'Asset'}
      component={Asset}
...
const AssetModalFlow = (props: NavigatorProps) => (
  <Stack.Navigator
    mode={'modal'}
...
/* eslint-disable react/prop-types */
const BrowserFlow = (props: NavigatorProps) => (
  <Stack.Navigator
...
export const DrawerContext = React.createContext<{
  ...
  drawerRef: null as unknown as React.MutableRefObject<null>,
});
...
const NotificationsOptInStack = () => (
  <Stack.Navigator initialRouteName={Routes.NOTIFICATIONS.OPT_IN}>
    <Stack.Screen
      // @ts-expect-error Legacy stack screen option retained for runtime compatibility.
      mode={'modal'}
      ...
      <Drawer ref={drawerRef}>
        ...
        >
          <Tab.Screen
            ...
            options={options.home as never}
            component={WalletTabModalFlow}
          />
          <Tab.Screen
            name={Routes.TRANSACTIONS_VIEW}
            options={options.activity as never}
            component={TransactionsHome}
          />
          <Tab.Screen
            name={Routes.MODAL.WALLET_ACTIONS}
            options={options.actions as never}
            component={WalletTabModalFlow}
          />
          <Tab.Screen
            name={Routes.BROWSER.HOME}
            options={options.browser as never}
            component={BrowserFlow}
          />

          <Tab.Screen
            name={Routes.SETTINGS_VIEW}
            options={options.settings as never}
...
/* eslint-disable react/prop-types */
const NftDetailsModeView = (props: NavigatorProps) => (
  <Stack.Navigator>
    <Stack.Screen
...
/* eslint-disable react/prop-types */
const NftDetailsFullImageModeView = (props: NavigatorProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name=" " // No name here because this title will be displayed in the header of the page
...
/* eslint-disable react/prop-types */
const NotificationsModeView = (_props: NavigatorProps) => (
  <Stack.Navigator>
    <Stack.Screen
...
const MainNavigator = (_props?: NavigatorProps) => (
  <Stack.Navigator
    screenOptions={{
      headerShown: false,
    }}
