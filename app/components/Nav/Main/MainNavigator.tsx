...
// Reads react-navigation options attached as a static property on legacy
// components that have not yet been migrated to typed screens.
  ...
  (
    component as {
      navigationOptions?:
        ...
        | ((props: any) => StackNavigationOptions);
    }
  ).navigationOptions;
...
const AssetStackFlow = (props: NavigatorFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name={'Asset'}
      component={Asset}
...
const AssetModalFlow = (props: NavigatorFlowProps) => (
  <Stack.Navigator
    mode={'modal'}
...
/* eslint-disable react/prop-types */
const BrowserFlow = (props: NavigatorFlowProps) => (
  <Stack.Navigator
...
/* eslint-disable react/prop-types */
const NftDetailsModeView = (props: NavigatorFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
...
/* eslint-disable react/prop-types */
const NftDetailsFullImageModeView = (props: NavigatorFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name=" " // No name here because this title will be displayed in the header of the page
