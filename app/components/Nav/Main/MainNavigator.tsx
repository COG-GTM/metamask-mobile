...
/**
 * Reads the (optionally defined) static `navigationOptions` from a screen
 * component. Screen components across the app expose this static without
 * declaring it in their types, so it is accessed through a narrow cast.
 */
...
interface AssetStackFlowProps {
  route: RouteProp<{ params: { address?: string } }, 'params'>;
}
...
interface CollectibleFlowProps {
  route: RouteProp<{ params: { collectible?: unknown } }, 'params'>;
}
...
export const DrawerContext = React.createContext<{
  drawerRef: React.RefObject<React.ElementRef<typeof Drawer>> | null;
}>({ drawerRef: null });
...
const NftDetailsModeView = (props: CollectibleFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
...
const NftDetailsFullImageModeView = (props: CollectibleFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name=" " // No name here because this title will be displayed in the header of the page
