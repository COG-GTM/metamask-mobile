...
// Reads the static navigationOptions from legacy screen components.
// TODO: Replace "any" with type
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const getNavigationOptions = (component: any) => component.navigationOptions;

// Legacy screen props preserved from the JS implementation; ignored by React Navigation v6.
// TODO: Replace "any" with type
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const legacyModalScreenProps: any = { mode: 'modal' };
...
const AssetStackFlow = (props: StackFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name={'Asset'}
      component={Asset}
...
const AssetModalFlow = (props: StackFlowProps) => (
  <Stack.Navigator
    mode={'modal'}
...
/* eslint-disable react/prop-types */
const BrowserFlow = (props: StackFlowProps) => (
  <Stack.Navigator
      ...
      <Drawer ref={drawerRef}>
        ...
        >
          <Tab.Screen
            ...
            options={options.home as unknown as BottomTabNavigationOptions}
            component={WalletTabModalFlow}
          />
          <Tab.Screen
            name={Routes.TRANSACTIONS_VIEW}
            options={options.activity as unknown as BottomTabNavigationOptions}
            component={TransactionsHome}
          />
          <Tab.Screen
            name={Routes.MODAL.WALLET_ACTIONS}
            options={options.actions as unknown as BottomTabNavigationOptions}
            component={WalletTabModalFlow}
          />
          <Tab.Screen
            name={Routes.BROWSER.HOME}
            options={options.browser as unknown as BottomTabNavigationOptions}
            component={BrowserFlow}
          />

          <Tab.Screen
            name={Routes.SETTINGS_VIEW}
            options={options.settings as unknown as BottomTabNavigationOptions}
...
/* eslint-disable react/prop-types */
const NftDetailsModeView = (props: StackFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
...
/* eslint-disable react/prop-types */
const NftDetailsFullImageModeView = (props: StackFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name=" " // No name here because this title will be displayed in the header of the page
...
/* eslint-disable react/prop-types */
const NotificationsModeView = (_props: StackFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
...
// Legacy header props preserved from the JS implementation.
// TODO: Replace "any" with type
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const setPasswordFlowScreenProps: any = {
  headerTitle: () => (
    <Image
...
const MainNavigator = (_props: MainNavigatorProps) => (
  <Stack.Navigator
    screenOptions={{
      headerShown: false,
    }}
