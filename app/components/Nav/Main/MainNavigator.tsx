...
const AssetStackFlow = ({ route }: ScreenProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name={'Asset'}
      component={Asset}
    ...
    <Stack.Screen
      ...
      initialParams={{
        address: (route.params as { address?: string } | undefined)?.address,
      }}
    />
  </Stack.Navigator>
);

const AssetModalFlow = ({ route }: ScreenProps) => (
  <Stack.Navigator
    mode={'modal'}
...
const BrowserFlow = ({ route }: ScreenProps) => (
  <Stack.Navigator
...
const NftDetailsModeView = ({ route }: ScreenProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name=" " // No name here because this title will be displayed in the header of the page
      component={NftDetails}
      initialParams={{
        collectible: (route.params as { collectible?: unknown } | undefined)
          ?.collectible,
      }}
    />
  </Stack.Navigator>
...
const NftDetailsFullImageModeView = ({ route }: ScreenProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name=" " // No name here because this title will be displayed in the header of the page
