...
interface NestedFlowParams extends Partial<NftDetailsParams> {
  address?: string;
}

interface NestedFlowProps {
  route: RouteProp<Record<string, NestedFlowParams | undefined>, string>;
}
...
// Legacy screens expose their header config as a static `navigationOptions` field
const getNavigationOptions = (screen: object): StackScreenOptions =>
...
const AssetStackFlow = (props: NestedFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name={'Asset'}
      component={Asset}
...
const AssetModalFlow = (props: NestedFlowProps) => (
  <Stack.Navigator
    mode={'modal'}
...
const BrowserFlow = (props: NestedFlowProps) => (
  <Stack.Navigator
...
const HomeTabs = () => {
  ...
  const options: Record<string, HomeTabOptions> = {
    home: {
...
const NftDetailsModeView = (props: NestedFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
...
const NftDetailsFullImageModeView = (props: NestedFlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name=" " // No name here because this title will be displayed in the header of the page
