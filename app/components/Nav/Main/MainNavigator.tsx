...
interface ComponentWithNavigationOptions {
...
const getNavigationOptions = (
  ...
  (component as ComponentWithNavigationOptions).navigationOptions;
...
const AssetStackFlow = (props: FlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name={'Asset'}
      component={Asset}
...
const AssetModalFlow = (props: FlowProps) => (
  <Stack.Navigator
    mode={'modal'}
...
/* eslint-disable react/prop-types */
const BrowserFlow = (props: FlowProps) => (
  <Stack.Navigator
...
const HomeTabs = () => {
  ...
  const options: Record<string, TabScreenOptions> = {
    home: {
  ...
  const renderTabBar = (props: BottomTabBarProps) => {
    if (isKeyboardHidden) {
      return <TabBar {...(props as unknown as TabBarProps)} />;
    }
    return null;
  };
...
/* eslint-disable react/prop-types */
const NftDetailsModeView = (props: FlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
...
/* eslint-disable react/prop-types */
const NftDetailsFullImageModeView = (props: FlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
      name=" " // No name here because this title will be displayed in the header of the page
...
/* eslint-disable react/prop-types */
const NotificationsModeView = (_props: FlowProps) => (
  <Stack.Navigator>
    <Stack.Screen
