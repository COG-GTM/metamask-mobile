...
const mockUpdatePermittedChains = updatePermittedChains;
const mockAddPermittedAccounts = addPermittedAccounts;
const mockRemovePermittedAccounts = removePermittedAccounts;
