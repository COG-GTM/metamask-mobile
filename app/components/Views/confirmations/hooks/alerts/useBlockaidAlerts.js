...
const getConfirmModalDescription = (reason) => {
  let copy;
  switch (reason) {
...
export default function useBlockaidAlerts() {
  ...
  const alerts = useMemo(() => {
    ...
    return [
    {
      ...
      message: getConfirmModalDescription(reason),
      title: getTitle(reason),
      severity: getBlockaidAlertSeverity(result_type)
    }];
