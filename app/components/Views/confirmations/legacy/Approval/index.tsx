...
interface ApprovalProps extends IWithMetricsAwarenessProps {
   ...
   */
  securityAlertResponse?: Parameters<typeof getBlockaidMetricsParams>[0];
  /**
  ...
  getAnalyticsParams = ({
    ...
    try {
      ...
      return {
        ...
        is_smart_transaction: shouldUseSmartTransaction,
        // The promise is not awaited, so no properties are spread here. Kept as
        // is to preserve the existing behaviour.
        ...(smartTransactionMetricsProperties as unknown as Record<
          string,
          never
        >),
      };
