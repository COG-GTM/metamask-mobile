...
interface SendProps extends OwnProps, StateProps, DispatchProps {}
...
class Send extends PureComponent<SendProps, SendState> {
  ...
  async componentDidMount() {
    ...
    dappTransactionModalVisible && this.props.toggleDappTransactionModal();
    this.mounted = true;
    await this.reset();
