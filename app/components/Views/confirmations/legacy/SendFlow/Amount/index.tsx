...
// The legacy transaction/asset objects handled by this view are not typed yet.
...
import CollectibleMediaUntyped from '../../../../../UI/CollectibleMedia';
import collectiblesTransferInformationJson from '../../../../../../util/collectibles-transfer.json';
import { strings } from '../../../../../../../locales/i18n';
import Device from '../../../../../../util/device';
import { MetaMetricsEvents } from '../../../../../../core/Analytics';
// @ts-expect-error - untyped React Native internal module
...
// The collectible media component does not type the legacy style props used here.
const CollectibleMedia = CollectibleMediaUntyped as unknown as ComponentType<any>;

const collectiblesTransferInformation =
  collectiblesTransferInformationJson as unknown as Record<
    string,
...
class Amount extends PureComponent<AmountProps, AmountState> {
    ...
    if (isNativeToken(selectedAsset)) {
      ...
      if (internalPrimaryCurrencyIsCrypto) {
        ...
        inputValueConversion = `${renderFromWei(
          fiatNumberToWei(processedInputValue as any, conversionRate) as any,
        )}`;
  ...
  renderToken = (token: any, index: number) => {
    const {
      accounts,
      selectedAddress,
      conversionRate,
          ...
          <View style={styles.actionsWrapper}>
            <View style={styles.action}>
              ...
              >
                ...
                <View {...({ styles: styles.switchWrapper } as any)}>
            ...
            <View style={styles.actionsWrapper}>
              ...
              <View style={styles.action}>
                ...
                >
                  ...
                  <View {...({ styles: (styles as any).arrow } as any)}>
                    <Ionicons
                      name="arrow-down"
                      size={16}
                      color={colors.primary.inverse}
