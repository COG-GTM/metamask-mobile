...
interface TransactionReviewEIP1559UpdateProps {
  ...
  legacy?: boolean;
  gasSelected?: string;
  gasObject?: Record<string, unknown>;
  gasObjectLegacy?: Record<string, unknown>;
  onlyGas?: boolean;
...
const TransactionReviewEIP1559Update = ({
  ...
  useEffect(() => {
    if (gasEstimationReady) {
      updateTransactionState?.(gasTransaction as Record<string, unknown>);
    }
          ...
          <View style={styles.gasRowContainer}>
            ...
            >
              ...
              <TouchableOpacity
                ...
                hitSlop={styles.hitSlop as Insets}
              >
