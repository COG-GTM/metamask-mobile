...
interface TransactionReviewInformationProps {
  ...
  EIP1559GasData?: EIP1559GasDataInfo;
  origin?: string | null;
  /**
   * Asset amount rendered by the parent review screen
   */
  assetAmount?: string;
  /**
   * Fiat value rendered by the parent review screen
   */
  fiatValue?: string;
  /**
...
> {
  ...
  renderTransactionReviewEIP1559 = () => {
    ...
    this.getRenderTotalsEIP1559(EIP1559GasData as EIP1559GasDataInfo)();
    return (
