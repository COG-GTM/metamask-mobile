...
export default class TransactionReviewDetailsCard extends Component<any, any> {
...
interface TransactionReviewDetailsCardProps {
  address?: string;
  copyContractAddress?: (...args: any[]) => any;
  data?: string;
  ...
  toggleViewData?: (...args: any[]) => any;
  toggleViewDetails?: (...args: any[]) => any;
  tokenName?: string;
...
type Props = TransactionReviewDetailsCardProps & any;
