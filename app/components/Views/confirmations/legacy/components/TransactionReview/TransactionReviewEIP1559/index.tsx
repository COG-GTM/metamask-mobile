...
interface TransactionReviewEIP1559Props {
  ...
  /**
   * Total value in native currency (passed by consumers)
   */
  totalNative?: string;
  /**
   * Total value converted to chosen currency (passed by consumers)
   */
  totalConversion?: string;
  /**
   * Maximum total value in native currency (passed by consumers)
   */
  totalMaxNative?: string;
  /**
   * True if transaction is over the available funds (passed by consumers)
   */
  over?: boolean;
}
