...
describe('PersonalSign', () => {
  ...
  describe('onConfirm', () => {
    it('signs message', async () => {
      ...
      await wrapper.find(SignatureRequest).props().onConfirm();
    ...
    ['SDK remote', AppConstants.MM_SDK.SDK_REMOTE_ORIGIN]]
      ...
      // TODO: Replace "any" with type
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      NotificationManager.showSimpleNotification.mockReset();
  ...
  describe('onReject', () => {
    it('rejects message', async () => {
      ...
      // TODO: Replace "any" with type
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      await wrapper.find(SignatureRequest).props().onReject();
    ...
    ['SDK remote', AppConstants.MM_SDK.SDK_REMOTE_ORIGIN]]
      ...
      // TODO: Replace "any" with type
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      Engine.context.SignatureController.hub.on.mockReset();
  ...
  describe.skip('trackEvent', () => {
    it('tracks event for rejected requests', async () => {
      ...
      const rejectedMocks = mockTrackEvent.mock.calls.filter(
    ...
    it('tracks event for approved requests', async () => {
      ...
      const signedMocks = mockTrackEvent.mock.calls.filter(
