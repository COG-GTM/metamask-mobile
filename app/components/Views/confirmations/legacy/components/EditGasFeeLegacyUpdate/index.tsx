...
interface EditGasFeeLegacyProps {
   ...
   */
  onSave: (
    gasTransaction: ReturnType<typeof useGasTransaction>,
  ...
  /**
   * Called when the animation that updates values starts
   */
  onUpdatingValuesStart?: () => void;
  /**
   * Called when the animation that updates values ends
   */
  ...
  view?: string;
  /**
   * If the gas estimation should only show the gas fee
   */
  onlyGas?: boolean;
  /**
   * Selected gas object
  ...
  /**
   * If the transaction has a dapp suggested gas
   */
...
const EditGasFeeLegacy = ({
  ...
  const changeGas = useCallback((gas: { suggestedGasLimit?: string; suggestedGasPrice?: string }) => {
