...
interface WatchAssetRequestAsset {
  address: string;
  symbol: string;
  decimals: number;
  standard?: string;
...
const WatchAssetRequest = ({
  ...
  const balanceWithSymbol = error
    ...
    : `${renderFromTokenMinimalUnit(
        balance as NonNullable<typeof balance>,
        asset.decimals,
      )} ${asset.symbol}`;
  ...
  return (
    <View style={styles.root} testID={AssetWatcherSelectorsIDs.CONTAINER}>
      ...
      {/* @ts-expect-error `titleWrapper` is not defined in the style sheet */}
      <View style={styles.titleWrapper}>
        {/* eslint-disable-next-line @typescript-eslint/ban-ts-comment */}
        {/* @ts-expect-error `this` is undefined in a function component */}
