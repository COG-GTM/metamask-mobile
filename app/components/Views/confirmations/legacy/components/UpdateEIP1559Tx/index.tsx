...
interface UpdateEIP1559TxProps {
  /**
   * Gas value of the existing transaction (hex wei)
   */
  gas: string;
  /**
  ...
  gasFeeEstimates: any;
  /**
   * Type of the gas fee estimate returned by the GasFeeController
   */
  ...
  /**
   * Whether the transaction update is a cancel or a speed up
   */
  isCancel?: boolean;
  /**
   ...
   */
  onSave: (gasTxn: GasTransaction) => void;
}
...
const UpdateEIP1559Tx = ({
  ...
  const pollToken = useRef<string | undefined>(undefined);
