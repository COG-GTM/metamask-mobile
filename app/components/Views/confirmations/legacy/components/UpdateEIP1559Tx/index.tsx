...
const UpdateEIP1559Tx = ({
  ...
  const onSaveTxnWithError = (gasTxn: UpdateTx) => {
  ...
  return (
    <EditGasFee1559Update
      ...
      updateOption={
        updateTx1559Options.current as unknown as React.ComponentProps<
          typeof EditGasFee1559Update
        >['updateOption']
      }
      analyticsParams={
