...
type GasOptions = Record<string, GasOptionEstimate | undefined>;
...
interface EditGasFee1559UpdateProps {
  ...
  onSave?: (
    ...
    newGasPriceObject: GasPriceObject,
  ) => void;
  ...
  isAnimating?: boolean;
  analyticsParams?: { view?: string; [key: string]: unknown };
...
const EditGasFee1559Update = ({
  ...
  const changeGas = useCallback(
    (gas: GasOptionEstimate, option: string | null) => {
      setSelectedOption(option);
      updateGasObject({
        ...gasObject,
        suggestedMaxFeePerGas: gas.suggestedMaxFeePerGas as string,
        suggestedMaxPriorityFeePerGas: gas.suggestedMaxPriorityFeePerGas as string,
