...
import useQRHardwareAwareness from '../../../../../UI/QRHardware/useQRHardwareAwareness';
...
const SignatureRequest = ({
  ...
  const securityAlertResponse = useSelector(
    (state: RootState) => state.signatureRequest?.securityAlertResponse,
  );
  ...
  }, [currentPageInformation, fromAddress, type, trackEvent, createEventBuilder]);
