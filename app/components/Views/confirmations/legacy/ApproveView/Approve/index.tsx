 ...
 */
interface ApproveViewStateProps {
...
interface ApproveViewDispatchProps {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
type ApproveViewProps = ApproveViewStateProps & ApproveViewDispatchProps & ApproveViewOwnProps;

interface ApproveViewComponentState {
  approved: boolean;
...
class Approve extends PureComponent<ApproveViewProps, ApproveViewComponentState> {
  appStateListener;
  ...
  state: ApproveViewComponentState = {
    approved: false,
    gasError: undefined,
    ready: false,
    mode: REVIEW,
...
const mapStateToProps = (state: RootState): ApproveViewStateProps => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const mapDispatchToProps = (dispatch: (action: any) => void): ApproveViewDispatchProps => ({
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
