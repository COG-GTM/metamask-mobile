...
import {
  ...
  stakingDepositConfirmationState } from
'../../../../../util/test/confirm-data-helpers';
...
useConfirmationAlertMetrics.mockReturnValue({
...
describe('Footer', () => {
  beforeEach(() => {
    ...
    useAlertsConfirmed.mockReturnValue({
  ...
  describe('Confirm Alert Modal', () => {
    ...
    beforeEach(() => {
      useAlerts.mockReturnValue(baseMockUseAlerts);
      jest.clearAllMocks();
    });
