...
const SnapPermissions = ({
    ...
    key) =>
    {
      ...
      if (rpcPermissionsCaveats) {
        for (const caveat of rpcPermissionsCaveats) {
          const rpcPermissions = caveat.value;
  ...
  const isSnapsDerivationPath = (object) =>
