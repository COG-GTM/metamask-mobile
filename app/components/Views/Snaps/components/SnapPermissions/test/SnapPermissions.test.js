...
import {
  ...
  SNAP_PERMISSION_CELL } from
'../../SnapPermissionCell/SnapPermissionCell.constants';
...
describe('SnapPermissions', () => {
  ...
  const snapGetBip32EntropyTitle = (protocol) =>
  `Control your ${protocol} accounts and assets`;
  const snapGetBip32PublicKeyTitle = (protocol) =>
  `View your public key for ${protocol}`;
  const snapGetBip44EntropyTitle = (protocol) =>
  `Control your ${protocol} accounts and assets`;
