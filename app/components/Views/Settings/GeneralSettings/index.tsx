...
type UserTraitsMetrics = Pick<IUseMetricsHook, 'addTraitsToUser' | 'trackEvent'>;
...
interface SettingsProps extends IWithMetricsAwarenessProps {
  /**
...
class Settings extends PureComponent<SettingsProps, SettingsState> {
  ...
  componentDidMount = () => {
    this.updateNavBar();
    const languages: Record<string, string> = getLanguages();
  ...
  render() {
    ...
    const themeTokens = (this.context as Theme) || mockTheme;
...
export default connect(
  ...
  withMetricsAwareness(
    Settings as unknown as React.ComponentType<IWithMetricsAwarenessProps>,
  ),
);
