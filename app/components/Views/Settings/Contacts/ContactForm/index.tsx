...
interface ContactFormProps {
  navigation: StackNavigationProp<Record<string, Record<string, string | (() => void)> | undefined>>;
  internalAccounts: InternalAccount[];
  addressBook: Record<string, Record<string, { address: string; name: string; memo?: string }>>;
  route: RouteProp<Record<string, Record<string, string | (() => void)> | undefined>, string>;
  chainId: string;
}
