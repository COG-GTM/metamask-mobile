...
interface ContactFormProps extends ContactFormOwnProps, ContactFormStateProps {}
...
class ContactForm extends PureComponent<ContactFormProps, ContactFormState> {
  ...
  actionSheet: typeof ActionSheet = React.createRef();
