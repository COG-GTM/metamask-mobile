...
import { ScanSuccess } from '../../../QRTabSwitcher/QRTabSwitcher';
...
// `transparent` is not part of the theme palette; kept optional to preserve the original lookup
...
interface ContactFormProps {
   ...
   */
  route: RouteProp<Record<string, ContactFormRouteParams>, string>;
  /**
   * Network chainId
   */
  chainId: Hex;
