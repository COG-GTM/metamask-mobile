 ...
 */
const TypedAddressList = AddressList as ComponentType<
...
class Contacts extends PureComponent<ContactsProps, ContactsState> {
  ...
  deleteContact = () => {
    ...
    const { chainId } = this.props;
    if (this.contactAddressToRemove !== undefined) {
...
const mapStateToProps = (state: RootState) => ({
  ...
  // AddressBookController is EVM-only; on non-EVM networks the selected
  // chain id is a CAIP id and address book lookups yield no entries.
