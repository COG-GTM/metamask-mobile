...
import {
  ...
  KeyboardAwareScrollView as KeyboardAwareScrollViewType,
...
type ScrollViewRefType = KeyboardAwareScrollViewType & {
  scrollToEnd: (options?: ScrollToEndOptions) => void;
};

type LinkTextProps = React.ComponentProps<typeof Text> & { link?: boolean };

const LinkText = Text as React.ComponentType<LinkTextProps>;
...
> {
  scrollView = React.createRef<ScrollViewRefType>();
          ...
          >
            ...
            >
              <View style={styles.modalView}>
                ...
                <Text style={(styles as Record<string, TextStyle>).modalText}>
