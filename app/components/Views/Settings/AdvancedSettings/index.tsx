...
import { withMetricsAwareness , IUseMetricsHook } from '../../../../components/hooks/useMetrics';
...
interface AdvancedSettingsProps {
   ...
   */
  route?: RouteProp<{ params: AdvancedSettingsRouteParams }, 'params'>;
  /**
...
> {
  ...
  componentDidMount = async () => {
    ...
    this.props.route?.params?.scrollToBottom &&
      (
        this.scrollView?.current as unknown as ScrollView | null
  ...
  downloadStateLogs = async () => {
    ...
    downloadStateLogs(fullState as RootState);
  };
