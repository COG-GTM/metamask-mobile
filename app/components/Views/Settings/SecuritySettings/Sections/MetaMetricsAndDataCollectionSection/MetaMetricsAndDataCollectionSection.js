...
import {
  ...
  META_METRICS_SECTION } from
'../../SecuritySettings.constants';
import Text, {
  TextColor,
  TextVariant } from
...
import generateDeviceAnalyticsMetaData, {
  UserSettingsAnalyticsMetaData as generateUserSettingsAnalyticsMetaData } from
'../../../../../../util/metrics';
...
const MetaMetricsAndDataCollectionSection = () => {
  ...
  const toggleMetricsOptIn = async (metricsEnabled) => {
    if (metricsEnabled) {
  ...
  const addMarketingConsentToTraits = (marketingOptIn) => {
    InteractionManager.runAfterInteractions(async () => {
  ...
  const toggleDataCollectionForMarketing = async (value) => {
    if (value) {
      if (!analyticsEnabled) {
