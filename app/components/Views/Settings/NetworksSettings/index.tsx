...
> {
          ...
          isDefaultMainnet(networkTypeOrRpcUrl) ? (
            ...
            >
              <View style={styles.network}>
                {isCustomRPC ? (
                  <AvatarNetwork
                    {...({ variant: AvatarVariant.Network } as object)}
                    name={name}
                    imageSource={image}
  ...
  handleSearchTextChange = (text: string) => {
    ...
    const defaultNetwork = getAllNetworks().map((networkType: string) => {
    ...
    this.setState({ filteredNetworks: searchResult as FilteredNetwork[] });
  };
