...
interface NetworksSettingsStateProps {
  /**
...
interface NetworksSettingsProps
  extends NetworksSettingsOwnProps,
    NetworksSettingsStateProps {}
...
> {
              ...
              <View style={styles.network}>
                {isCustomRPC ? (
                  <AvatarNetwork
                    ...
                    } as unknown as AvatarNetworkProps)}
                    name={name}
  ...
  handleSearchTextChange = (text: string) => {
    ...
    const customRPC = Object.values(this.props.networkConfigurations).map(
      (networkConfiguration, i): FilteredNetwork => {
