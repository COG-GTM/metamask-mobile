...
// The undecorated class requires fully-typed props at the type level; tests
// intentionally render it with partial/no props, so use a loosely-typed alias.
const NetworkSettingsComponent =
  NetworkSettings as unknown as React.ComponentType<Record<string, unknown>>;
...
describe('NetworkSettings', () => {
    ...
    wrapper = shallow(
      <Provider store={store}>
        <ThemeContext.Provider value={mockTheme}>
          <NetworkSettingsComponent {...SAMPLE_NETWORKSETTINGS_PROPS} />
  ...
  it('should update state and call getCurrentState on RPC URL change', async () => {
    ...
    const wrapper2: any = shallow(
      <Provider store={store}>
        <NetworkSettingsComponent {...SAMPLE_NETWORKSETTINGS_PROPS_2} />
      </Provider>,
    )
      .find(NetworkSettings)
      .dive();
  ...
  it('should update state and call getCurrentState on block explorer URL change', async () => {
    ...
    wrapper = shallow(
      <Provider store={store}>
        <NetworkSettingsComponent {...newProps} />
      </Provider>,
    )
      .find(NetworkSettings)
      .dive();
  ...
  describe('NetworkSettings componentDidMount', () => {
    ...
    it('should set addMode to true if no networkTypeOrRpcUrl is provided', () => {
      ...
      const wrapper3 = shallow(
        <Provider store={store}>
          <NetworkSettingsComponent {...SAMPLE_NETWORKSETTINGS_PROPS_3} />
        </Provider>,
      )
        .find(NetworkSettings)
        .dive();
    ...
    it('should handle cases where the network is custom', () => {
      ...
      const wrapper4 = shallow(
        <Provider store={store}>
          <NetworkSettingsComponent {...SAMPLE_NETWORKSETTINGS_PROPS_4} />
        </Provider>,
      )
        .find(NetworkSettings)
        .dive();
  ...
  describe('NetworkSettings - handleNetworkUpdate', () => {
    ...
    const wrapper4: any = shallow(
      <Provider store={store}>
        <NetworkSettingsComponent {...SAMPLE_PROPS} />
      </Provider>,
    )
      .find(NetworkSettings)
      .dive();
