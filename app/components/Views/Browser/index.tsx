...
export const Browser = (props: BrowserProps) => {
  ...
  const accountAvatarType = useSelector((state: { settings: { useBlockieIcon: boolean } }) =>
...
const mapStateToProps = (state: { browser: { tabs: BrowserTab[]; activeTab: number } }): StateProps => ({
...
export default connect(mapStateToProps, mapDispatchToProps)(Browser) as React.ComponentType<OwnProps>;
