...
type BrowserTabElementProps = Pick<
  BrowserTabProps,
  'id' | 'initialUrl' | 'linkType' | 'newTab'
> & {
...
const BrowserTabElement =
  BrowserTab as unknown as ComponentType<BrowserTabElementProps>;
...
export const Browser = (props: Props) => {
  ...
  useFocusEffect(
    useCallback(() => {
      if (isSolanaAccount(currentSelectedAccount as InternalAccount)) {
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  updateTab: (id: number, url: TabUpdateInfo) =>
