...
/**
 * Represents a browser tab object from the Redux store.
 */
...
/**
 * Route params that can be passed to the Browser screen.
 */
...
/**
 * Navigation object used by the Browser component.
 */
...
/**
 * Route object passed as a prop to the Browser component.
 */
...
/**
 * Props for the Browser component (own + mapped from Redux).
 */
...
export const Browser: React.FC<BrowserProps> = (props) => {
  ...
  const closeTabHandler = (tab: BrowserTabInfo) => {
