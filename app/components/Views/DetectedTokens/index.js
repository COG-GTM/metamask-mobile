...
import {
  ...
  selectAllDetectedTokensFlat } from
...
const DetectedTokens = () => {
  ...
  const getTokenId = (item) => item.address;
  ...
  const trackCancelWithoutAction = (hasPendingAction) => {
    if (hasPendingAction) {
      return;
    }
    trackEvent(
