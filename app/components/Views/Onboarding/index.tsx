...
type BaseNotificationViewProps = Partial<
  React.ComponentProps<typeof BaseNotification>
> & {
  closeButtonDisabled?: boolean;
};

const BaseNotificationView =
  BaseNotification as unknown as ComponentType<BaseNotificationViewProps>;
