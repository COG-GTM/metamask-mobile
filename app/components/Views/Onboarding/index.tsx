...
const BaseNotificationTyped = BaseNotification as unknown as ComponentType<{
...
export default connect(
  ...
  withMetricsAwareness(
    Onboarding as unknown as ComponentType<{ metrics: IUseMetricsHook }>,
  ),
);
