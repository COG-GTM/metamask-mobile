...
import { withMetricsAwareness , IUseMetricsHook } from '../../hooks/useMetrics';
...
interface OnboardingNavigation extends NavigationProp<ParamListBase> {
      ...
      >
        <ElevatedView style={styles.modalTypeView} elevation={100}>
          <BaseNotification
            ...
            } as unknown as React.ComponentProps<typeof BaseNotification>)}
          />
        </ElevatedView>
      </Animated.View>
    );
