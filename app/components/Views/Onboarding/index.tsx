...
// `BaseNotification` is still JS, so its inferred prop types do not allow the
// title/description strings passed here.
const TypedBaseNotification = BaseNotification as unknown as React.ComponentType<{
...
interface OnboardingProps {
   ...
   */
  route: RouteProp<{ params?: { delete?: boolean } }, 'params'>;
  /**
