...
jest.mock('../../../util/navigation/navUtils', () => ({
  createNavigationDetails: jest.fn(
    (screenName: string, _nestedScreen?: string) =>
      (params?: Record<string, unknown>) =>
        [screenName, params],
  ),
  useParams: jest.fn(() => ({ previousScreen: 'Login' })),
}));
...
describe('RestoreWallet', () => {
  ...
  it('has EngineService available for vault recovery', () => {
    expect(EngineService.initializeVaultFromBackup).toBeDefined();
  });
});
