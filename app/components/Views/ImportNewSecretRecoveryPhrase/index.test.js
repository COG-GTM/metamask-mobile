...
import {
  MOCK_HD_ACCOUNTS,
  MOCK_HD_KEYRING_METADATA } from
'../../../selectors/keyringController/testUtils';
...
jest.mock('../../../actions/multiSrp', () => ({
  ...
  importNewSecretRecoveryPhrase: (srp) =>
...
const renderSRPImportComponentAndPasteSRP = async (srp) => {
