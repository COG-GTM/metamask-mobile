...
const RevealPrivateCredential = ({
  ...
  const renderTabView = (privCredentialName) =>
  <ScrollableTabView
  ...
  const renderModal = (isPrivateKeyReveal) =>
  <InfoModal
  ...
  const renderWarning = (privCredentialName) =>
