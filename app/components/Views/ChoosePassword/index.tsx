...
interface ChoosePasswordNavigation extends NavigationProp<ParamListBase> {
  replace: (name: string, params?: object) => void;
  push: (name: string, params?: object) => void;
}

interface ChoosePasswordRouteParams {
...
interface ChoosePasswordProps {
  ...
  passwordSet: () => void;
  /**
   * The action to update the password set flag in the redux store to false
   */
  passwordUnset: () => void;
  /**
   ...
   */
  route: RouteProp<{ params: ChoosePasswordRouteParams }, 'params'>;
}
    ...
    try {
      ...
      if (previous_screen === ONBOARDING) {
        try {
          ...
          // @ts-expect-error Device.isIos is referenced without invocation; preexisting behavior preserved
          if (Device.isIos)
