...
interface ChoosePasswordProps {
   ...
   */
  route: RouteProp<{ params: ChoosePasswordParams }, 'params'>;
}
...
> {
  ...
  onPressCreate = async () => {
    ...
    try {
      ...
      const authType: AuthData =
        await Authentication.componentAuthenticationType(
  ...
  recreateVault = async (password: string, authType?: AuthData) => {
    ...
    await Authentication.newWalletAndRestore(
      password,
      // recreateVault('') is called without auth data; keep passing it through
      authType as AuthData,
      // exportSeedPhrase returns a Uint8Array; newWalletAndRestore is typed as string
