...
class ChoosePassword extends PureComponent<ChoosePasswordProps, ChoosePasswordState> {
  ...
  track = (event: ReturnType<typeof MetaMetricsEvents[keyof typeof MetaMetricsEvents]>, properties?: Record<string, unknown>) => {
...
const mapDispatchToProps = (dispatch: (action: ReturnType<typeof passwordSet | typeof passwordUnset | typeof setLockTime | typeof seedphraseNotBackedUp>) => void) => ({
