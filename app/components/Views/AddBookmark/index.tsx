...
> {
  ...
  render = () => {
    ...
    const themeAppearance =
      (this.context as Theme)?.themeAppearance || AppThemeKey.light;
          ...
          <View>
            ...
            <View style={styles.rowWrapper}>
              ...
              <TextInput
                ...
                ref={this.urlInput}
                // @ts-expect-error - `addToken` is not defined on this class, so this handler has always been `undefined`
