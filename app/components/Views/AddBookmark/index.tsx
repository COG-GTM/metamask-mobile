...
import { SafeAreaView, Text, TextInput, View, StyleSheet, ColorValue } from 'react-native';
...
interface Colors {
  ...
  border: { default: ColorValue };
  text: { default: ColorValue; muted: ColorValue };
  error: { default: ColorValue };
}
