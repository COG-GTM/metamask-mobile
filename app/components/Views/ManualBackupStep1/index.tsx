...
const ManualBackupStep1 = ({
  ...
  const styles = createStyles(colors) as ReturnType<typeof createStyles> & {
    viewButtonWrapper?: StyleProp<ViewStyle>;
  ...
  const tryExportSeedPhrase = async (currentPassword: string) => {
  ...
  const getBlurType = () => {
    ...
    switch (appTheme) {
      ...
      case 'dark':
        ...
        break;
      case 'os':
        blurType = Appearance.getColorScheme() as BlurViewProps['blurType'];
        break;
      default:
        blurType = 'light';
    }
