...
class Asset extends PureComponent<AssetProps, AssetState> {
  ...
  ethFilter = (tx: AssetTransaction): boolean | undefined => {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withMetricsAwareness(Asset as unknown as ComponentType<IWithMetricsAwarenessProps>));
