...
type AssetTransaction = Record<string, any>;
...
interface AssetProps extends IWithMetricsAwarenessProps {
  ...
  swapsTransactions: Record<string, AssetTransaction>;
...
class Asset extends PureComponent<AssetProps, AssetState> {
  ...
  updateNavBar = (contentOffset = 0) => {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const asset = (navigation && params) as any;
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
(Asset as any).contextType = ThemeContext;
