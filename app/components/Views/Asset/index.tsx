...
interface AssetInternalAccount {
  address: string;
  metadata: {
    importTime: number;
  };
...
interface AssetProps {
  ...
  selectedInternalAccount: AssetInternalAccount;
  ...
  swapsTransactions: Record<string, { destinationToken: { address: string }; sourceToken: { address: string } }>;
...
const mapStateToProps = (state: Record<string, unknown>, { route }: AssetOwnProps) => ({
