...
type AssetProps = React.ComponentProps<typeof Asset>;

// Fixture uses loosely typed controller state
...
describe('Asset', () => {
  it('should render correctly', () => {
    const { toJSON } = renderWithProvider(
      <Asset
        navigation={
          { setOptions: jest.fn() } as unknown as AssetProps['navigation']
        }
        route={
          {
            params: {
  ...
  it('should call navigation.setOptions on mount', () => {
    ...
    renderWithProvider(
      <Asset
        navigation={
          { setOptions: mockSetOptions } as unknown as AssetProps['navigation']
        }
        route={
          {
            params: {
