...
type WordsDictionary = Record<string, { currentPosition: number | undefined }>;
  ...
  const goNext = () => {
    if (validateWords()) {
      ...
      InteractionManager.runAfterInteractions(async () => {
        const backedUpWords = route.params?.words;
    ...
    (key: string, i: number) => {
      ...
      return (
        <TouchableOpacity
          ...
          style={[boxStyles.selectableWord, selected && boxStyles.selectedWord]}
          key={`selectableWord_${i}`}
        >
          <Text
            style={[
              boxStyles.selectableWordText,
              selected && boxStyles.selectedWordText,
            ]}
          >
            {word}
          </Text>
