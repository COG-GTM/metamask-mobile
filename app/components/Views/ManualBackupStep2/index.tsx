...
type WordsDict = Record<string, WordDictEntry>;
...
const ManualBackupStep2 = ({
  ...
  const renderWordSelectableBox = useCallback(
    (key: string, i: number) => {
      ...
      const componentStyles = createStyles(colors);
      ...
      return (
        <TouchableOpacity
          ...
          style={[
            componentStyles.selectableWord,
            selected && componentStyles.selectedWord,
          ]}
          key={`selectableWord_${i}`}
        >
          <Text
            style={[
              componentStyles.selectableWordText,
              selected && componentStyles.selectedWordText,
            ]}
          >
            {word}
          </Text>
