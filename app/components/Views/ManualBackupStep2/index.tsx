...
interface OwnProps {
   ...
   */
  route: RouteProp<{ ManualBackupStep2: RouteParams }, 'ManualBackupStep2'>;
}
...
interface WordsDict {
  [key: string]: { currentPosition?: number };
}
...
const ManualBackupStep2 = ({
  ...
  const selectWord = useCallback(
    (word: string, i: number) => {
      ...
      const { currentPosition } = wordsDict[`${word},${i}`];
    ...
    (key: string, i: number) => {
      ...
      return (
        <TouchableOpacity
          ...
          style={[
            wordStyles.selectableWord,
            selected && wordStyles.selectedWord,
          ]}
          key={`selectableWord_${i}`}
        >
          <Text
            style={[
              wordStyles.selectableWordText,
              selected && wordStyles.selectedWordText,
            ]}
          >
            {word}
          </Text>
