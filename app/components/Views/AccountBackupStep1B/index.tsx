 ...
 */
const AccountBackupStep1B = (screenProps: AccountBackupStep1BProps) => {
  // Always rendered as a stack screen, so navigation and route are injected.
  const props = screenProps as Required<AccountBackupStep1BProps>;
      ...
      >
        <View style={styles.secureModalContainer}>
          ...
          <View style={styles.explainBackupContainer}>
            ...
            <TouchableOpacity
              style={(styles as Record<string, ViewStyle>).remindLaterButton}
              onPress={learnMore}
              hitSlop={{ top: 10, left: 10, bottom: 10, right: 10 }}
            >
