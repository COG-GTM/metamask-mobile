...
interface VideoPlayerProps {
  ...
  source?: ReactVideoSource | number;
...
export default function VideoPlayer({
  ...
  const updateSeekerPosition = useCallback(
    (position: number) => {
      if (!position) return;
      const constrainedPosition = constrainToSeekerMinMax(position);
      setSeekerFillWidth(constrainedPosition);
      setSeekerPosition(constrainedPosition);
      setSeekerOffset(constrainedPosition);
    },
