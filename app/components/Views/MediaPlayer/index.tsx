...
// react-native-gesture-handler types the handler without children
const TapGesture = TapGestureHandler as React.ComponentType<
...
function MediaPlayer({
  ...
  ) as unknown as ReactVideoSource;
    ...
    <View style={style}>
      ...
      {Device.isAndroid() ? (
        ...
        <>
           ...
           */}
          <TapGesture onEnded={onPressVideoControls}>
