...
const MediaPlayer: React.FC<MediaPlayerProps> = ({
  ...
  const source = (
    Number.isInteger(uri) ? (uri as number) : { uri: uri as string }
  ) as ReactVideoSource;
    ...
    <View style={style}>
      ...
      {Device.isAndroid() ? (
        ...
        <>
           ...
           */}
          <TapGestureHandlerCompat onEnded={onPressVideoControls}>
