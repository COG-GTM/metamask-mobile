...
const TapGestureHandlerView = TapGestureHandler as React.ComponentType<
...
function MediaPlayer({
  ...
  const source = (Number.isInteger(uri) ? uri : { uri }) as ReactVideoSource;
    ...
    <View style={style}>
      ...
      {Device.isAndroid() ? (
        ...
        <>
           ...
           */}
          <TapGestureHandlerView onEnded={onPressVideoControls}>
