...
// The installed gesture-handler types omit `children` from the handler props,
// so widen the component type to accept children without altering behavior.
const TapGestureHandlerComponent =
  TapGestureHandler as unknown as React.ComponentType<
    React.ComponentProps<typeof TapGestureHandler> & {
...
interface MediaPlayerProps {
   ...
   */
  textTracks?: VideoProps['textTracks'];
  /**
   * The selected text track to display by id, language, title, index
   */
  selectedTextTrack?: VideoProps['selectedTextTrack'];
}
    ...
    <View style={style}>
      ...
      {Device.isAndroid() ? (
        ...
        <>
           ...
           */}
          <TapGestureHandlerComponent onEnded={onPressVideoControls}>
