...
// `onEnded` is passed through to the underlying native handler and is not part
// of the published TapGestureHandler prop types.
const LegacyTapGestureHandler = TapGestureHandler as React.ComponentType<
    ...
    <View style={style}>
      ...
      {Device.isAndroid() ? (
        ...
        <>
           ...
           */}
          <LegacyTapGestureHandler onEnded={onPressVideoControls}>
