...
import SmartTransactionStatus, {
  ...
  showRemainingTimeInMinAndSec } from
    ...
    describe('success', () => {
      it('should render success when STX has success status', () => {
        const { getByText } = renderWithProvider(
          ...
          // TODO: Replace "any" with type
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          requestState={PENDING_APPROVALS.Send.success.requestState}
      ...
      describe('dapp tx', () => {
        it('should navigate to Activity page on press of primary button', () => {
          const { getByText } = renderWithProvider(
            ...
            // TODO: Replace "any" with type
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            requestState={PENDING_APPROVALS.Dapp.success.requestState}
      ...
      describe('MM Swaps flow tx', () => {
        it('should navigate to Swaps page on press of primary button', () => {
          const { getByText } = renderWithProvider(
            ...
            // TODO: Replace "any" with type
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            requestState={PENDING_APPROVALS.Swap.success.requestState}
    ...
    describe('cancelled', () => {
      it('should render cancelled when STX has cancelled status', () => {
        const { getByText } = renderWithProvider(
          ...
          // TODO: Replace "any" with type
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          requestState={PENDING_APPROVALS.Send.cancelled.requestState}
        ...
        it('should close the Status page on press of secondary button', () => {
          ...
          const { getByText } = renderWithProvider(
            <SmartTransactionStatus
              ...
              // TODO: Replace "any" with type
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              PENDING_APPROVALS.Dapp.cancelled.requestState
              }
        ...
        it('should navigate to Send page on press of primary button', () => {
          const { getByText } = renderWithProvider(
            <SmartTransactionStatus
              ...
              // TODO: Replace "any" with type
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              PENDING_APPROVALS.Send.cancelled.requestState
              }
              origin={PENDING_APPROVALS.Send.cancelled.origin}
              onConfirm={jest.fn()} />,
    ...
    describe('failed', () => {
      it('should render failed when STX has unknown status', () => {
        const { getByText } = renderWithProvider(
          ...
          // TODO: Replace "any" with type
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          requestState={PENDING_APPROVALS.Send.unknown.requestState}
      ...
      describe('dapp tx', () => {
        it('should close the Status page on press of secondary button', () => {
          ...
          const { getByText } = renderWithProvider(
            ...
            // TODO: Replace "any" with type
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            requestState={PENDING_APPROVALS.Dapp.unknown.requestState}
      ...
      describe('MM Swaps flow tx', () => {
        it('should close the Status page on press of primary button', () => {
          ...
          const { getByText } = renderWithProvider(
            ...
            // TODO: Replace "any" with type
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            requestState={PENDING_APPROVALS.Swap.unknown.requestState}
