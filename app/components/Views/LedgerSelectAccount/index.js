...
import {
  ...
  setHDPath,
  unlockLedgerWalletAccount } from
'../../../core/Ledger/Ledger';
...
const LedgerSelectAccount = () => {
  ...
  const ledgerPathOptions = useMemo(
    () => [
    {
  ...
  const keyringController = useMemo(() => {
    const { KeyringController: controller } = Engine.context;
  ...
  const accountsController = useMemo(() => {
    const { AccountsController: controller } = Engine.context;
  ...
  useEffect(() => {
    keyringController.getAccounts().then((value) => {
