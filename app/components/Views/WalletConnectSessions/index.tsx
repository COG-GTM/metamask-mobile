...
> {
  ...
  sessionToRemove: WCV1Session | SessionTypes.Struct | null = null;
  ...
  onLongPress = (session: WCV1Session | SessionTypes.Struct) => {
  ...
  killSession = async () => {
    const isV2 = (this.sessionToRemove as WCV1Session)?.peerId === undefined;
    try {
      if (isV2 && isWC2Enabled) {
        ...
        await WalletConnect.killSession(
          (this.sessionToRemove as WCV1Session).peerId,
        );
      }
