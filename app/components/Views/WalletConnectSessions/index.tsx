...
type WalletConnectSessionItem = WalletConnectV1Session | WalletConnectV2Session;
...
const isV1Session = (
  session: WalletConnectSessionItem,
...
> {
  ...
  sessionToRemove: WalletConnectSessionItem | null = null;
  ...
  renderDesc = (meta: WalletConnectPeerMeta) => {
  ...
  onLongPress = (session: WalletConnectSessionItem) => {
  ...
  killSession = async () => {
    ...
    const isV2 = !isV1Session(sessionToRemove);
    try {
