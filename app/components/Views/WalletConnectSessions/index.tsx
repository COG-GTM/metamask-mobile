...
interface WalletConnectV1SessionMeta {
  url: string;
  name: string;
  description?: string;
}
...
interface WalletConnectV1Session {
  peerId: string;
  peerMeta: WalletConnectV1SessionMeta;
}

interface WalletConnectV2Session extends SessionTypes.Struct {
  id?: string;
}
...
> {
  ...
  killSession = async () => {
    ...
    try {
      ...
      } else if ('peerId' in sessionToRemove) {
