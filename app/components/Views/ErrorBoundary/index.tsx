...
type PressableIconProps = React.ComponentProps<typeof CLIcon> & {
  onPress?: () => void;
};

const PressableCLIcon = CLIcon as React.ComponentType<PressableIconProps>;

type RevealPrivateCredentialViewProps = Omit<
  React.ComponentProps<typeof RevealPrivateCredential>,
  'route'
>;

const RevealPrivateCredentialView =
  RevealPrivateCredential as React.ComponentType<RevealPrivateCredentialViewProps>;
...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    this.generateErrorReport(error, errorInfo?.componentStack as string);
