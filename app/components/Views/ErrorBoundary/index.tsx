...
type RevealPrivateCredentialRoute = React.ComponentProps<
    ...
    return this.state.backupSeedphrase
      ? this.renderWithSafeArea(
          <RevealPrivateCredential
            ...
            // RevealPrivateCredential guards every `route` access with `?.`
            route={undefined as unknown as RevealPrivateCredentialRoute}
          />,
        )
      : this.state.error
      ? this.renderWithSafeArea(
