...
// `onPress` is forwarded to the underlying icon and is not part of the
// published Icon prop types.
const PressableIcon = CLIcon as React.ComponentType<
  React.ComponentProps<typeof CLIcon> & { onPress?: () => void }
>;
...
interface ErrorAnalyticsParams {
  error?: string;
  boundary: string;
  stack?: string;
}
...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  generateErrorReport = (error: Error, errorInfo = '') => {
    ...
    const analyticsParams: ErrorAnalyticsParams = {
