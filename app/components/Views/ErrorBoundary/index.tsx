...
// The existing JS usage passes `onPress` to the icon, which is forwarded to the
// underlying pressable but absent from `IconProps`.
const PressableIcon = CLIcon as React.ComponentType<
...
// `RevealPrivateCredential` declares `route` as required, but this screen is
// rendered outside the navigator and never provided one.
const RevealPrivateCredentialCompat =
  RevealPrivateCredential as unknown as React.ComponentType<{
...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  generateErrorReport = (error: Error, errorInfo: string = '') => {
    ...
    const analyticsParams: { error?: string; boundary: string; stack?: string } =
