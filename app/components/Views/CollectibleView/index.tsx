...
type CollectibleViewParams = Nft & { contractName?: string };
...
interface CollectibleViewProps {
   ...
   */
  route: RouteProp<{ params: CollectibleViewParams }, 'params'>;
}
...
class CollectibleView extends PureComponent<CollectibleViewProps> {
  ...
  render() {
    ...
    const transferInformation: Record<string, { tradable: boolean }> =
