...
export interface CollectibleViewProps {
  /**
...
const collectiblesTransferInformationMap =
...
class CollectibleView extends PureComponent<CollectibleViewProps> {
  ...
  render() {
    ...
    const tradable =
      lowerAddress in collectiblesTransferInformationMap
        ? collectiblesTransferInformationMap[lowerAddress].tradable
        : true;
