...
const Summary = SummaryBase as unknown as React.FC<{
  ...
  Row: React.FC<{ children?: ReactNode; end?: boolean; last?: boolean }>;
  Col: React.FC<{ children?: ReactNode; end?: boolean }>;
  Separator: React.FC;
};

const TextWithItalic = Text as React.FC<
  ...
  render = () => {
    ...
    return (
      <Summary>
        ...
        <Summary.Row>
          <Summary.Col>
            <TextWithItalic small primary italic>
              {!fee
