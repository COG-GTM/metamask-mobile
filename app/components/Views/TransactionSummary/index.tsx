...
> & {
  ...
  >;
  Col: React.FC<
    React.PropsWithChildren<{ end?: boolean; style?: StyleProp<ViewStyle> }>
  >;
  Separator: React.FC<{ style?: StyleProp<ViewStyle> }>;
};

const Summary = BaseSummary as unknown as SummaryComponent;
...
export default class TransactionSummary extends PureComponent<TransactionSummaryProps> {
  ...
  render = () => {
    ...
    const isTestNetResult = isTestNet(chainId as Hex);
