...
const GasEducationCarousel = ({
  ...
  const dynamicStyles = styles as Record<string, ViewStyle & ImageStyle>;
        ...
        >
          <View style={styles.wrapper}>
            <ScrollableTabView
              ...
              style={dynamicStyles.scrollTabs as any}
                  ...
                  <View key={key} style={baseStyles.flexGrow}>
                    <View style={styles.carouselImageWrapper}>
                      <Image
                        ...
                        style={[styles.carouselImage, dynamicStyles[imgStyleKey]]}
                        resizeMethod={'auto'}
                      />
                    </View>
                    <View style={baseStyles.flexGrow}>
...
export default connect(mapStateToProps)(
  GasEducationCarousel as unknown as React.ComponentType,
);
