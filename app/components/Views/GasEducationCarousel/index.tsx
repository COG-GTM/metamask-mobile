...
interface ScrollableTabViewComponentProps {
  ...
  onChangeTab?: (obj: OnChangeTabEvent) => void;
  children?: ReactNode;
}

const ScrollableTabViewComponent =
  ScrollableTabView as unknown as ComponentType<ScrollableTabViewComponentProps>;
...
const GasEducationCarousel = ({
  ...
  const onChangeTab = (obj: OnChangeTabEvent) => {
        ...
        >
          <View style={styles.wrapper}>
            <ScrollableTabViewComponent
              style={
                (styles as Record<string, StyleProp<ViewStyle>>).scrollTabs
              }
