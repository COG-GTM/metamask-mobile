...
> {
  ...
  tryUnlock = () => {
    ...
    this.tryUnlockWithPassword(password as string);
  };
  ...
  renderLoader = () => {
    ...
    const dynamicStyles = styles as unknown as Record<string, ViewStyle>;
            ...
            >
              <View testID={ChoosePasswordSelectorsIDs.CONTAINER_ID}>
                ...
                <View style={styles.field}>
                  ...
                  <TextInput
                    style={[styles.input, inputWidth as ViewStyle]}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(ResetPassword as unknown as React.ComponentType);
