...
> {
  ...
  tryExportSeedPhrase = async (password: any) => {
    const { KeyringController } = Engine.context;
    await KeyringController.exportSeedPhrase(password);
  };

  tryUnlockWithPassword = async (password: any) => {
  ...
  toggleShowHide = () => {
    this.setState((state: any) => ({ secureTextEntry: !state.secureTextEntry }));
  };
  ...
  setConfirmPassword = (val: any) => this.setState({ confirmPassword: val });
...
const mapDispatchToProps = (dispatch: any) => ({
  ...
  setLockTime: (time: any) => dispatch(setLockTime(time)),
