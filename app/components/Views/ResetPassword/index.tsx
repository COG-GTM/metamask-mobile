...
> {
  ...
  tryUnlockWithPassword = async (password: string | null) => {
    ...
    try {
      // Just try
      await this.tryExportSeedPhrase(password as string);
      this.setState({
        password: null,
  ...
  renderLoader = () => {
    ...
    return (
      <View style={(styles as Record<string, ViewStyle>).loader}>
        ...
        <KeyboardAwareScrollView style={baseStyles.flexGrow} enableOnAndroid>
          <View style={styles.confirmPasswordWrapper}>
            ...
            <View style={styles.buttonWrapper}>
              <StyledButton
                containerStyle={(styles as Record<string, ViewStyle>).button}
                type={'confirm'}
