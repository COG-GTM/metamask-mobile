...
interface OwnProps {
   ...
   */
  route: RouteProp<{ params: ResetPasswordParams | undefined }, 'params'>;
}
...
interface State {
  ...
  view: typeof RESET_PASSWORD | typeof CONFIRM_PASSWORD;
  originalPassword: string | null;
  ready: boolean;
  passwordStrength: number;
  warningIncorrectPassword: string | null;
}
...
class ResetPassword extends PureComponent<Props, State> {
  ...
  async componentDidMount() {
    ...
    const state: Pick<State, 'view'> = { view: CONFIRM_PASSWORD };
