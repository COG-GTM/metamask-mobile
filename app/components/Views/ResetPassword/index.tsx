...
interface ResetPasswordNavigation extends NavigationProp<ParamListBase> {
...
interface ResetPasswordProps {
  ...
  passwordSet: () => void;
  /**
   * The action to update the lock time in the redux store
   */
   ...
   */
  route: RouteProp<{ params: ResetPasswordRouteParams }, 'params'>;
  /**
...
interface ResetPasswordState {
  ...
  biometryType: BIOMETRY_TYPE | string | null;
...
> {
  ...
  onPressCreate = async () => {
    ...
    try {
      ...
      if (err.toString() === PASSCODE_NOT_SET_ERROR) {
        Alert.alert(
  ...
  tryExportSeedPhrase = async (password: string | null) => {
    const { KeyringController } = Engine.context;
    await KeyringController.exportSeedPhrase(password as string);
  };

  tryUnlockWithPassword = async (password: string | null) => {
  ...
  renderLoader = () => {
    ...
    return (
      <View style={styles['loader' as keyof typeof styles] as ViewStyle}>
        ...
        <KeyboardAwareScrollView style={baseStyles.flexGrow} enableOnAndroid>
          <View style={styles.confirmPasswordWrapper}>
            ...
            <View style={styles.buttonWrapper}>
              <StyledButton
                containerStyle={styles['button' as keyof typeof styles]}
                type={'confirm'}
