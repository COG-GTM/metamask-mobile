...
type PasswordStrengthWord = ReturnType<typeof getPasswordStrengthWord>;
...
> {
  ...
  onPressCreate = async () => {
    ...
    try {
      ...
      if (String(error) === PASSCODE_NOT_SET_ERROR) {
        Alert.alert(
  ...
  renderResetPassword() {
    ...
    const passwordStrengthWord: PasswordStrengthWord = getPasswordStrengthWord(
      passwordStrength ?? 0,
    );
