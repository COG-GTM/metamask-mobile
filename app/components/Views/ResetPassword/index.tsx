...
type ResetPasswordStyles = ReturnType<typeof createStyles> & {
...
type LooseTextInputProps = React.ComponentProps<typeof TextInput> & {
  zasdfasfasf?: boolean;
  ref?: React.Ref<TextInput>;
};

const LooseTextInput =
  TextInput as unknown as React.ComponentType<LooseTextInputProps>;
...
> {
  ...
  renderLoader = () => {
    const colors = (this.context as Theme).colors || mockTheme.colors;
    const styles = createStyles(colors) as ResetPasswordStyles;
