...
import { typography, Theme } from '@metamask/design-tokens';
...
const TextWithVariant = Text as React.ComponentType<
  React.ComponentProps<typeof Text> & { variant?: TextVariant }
>;
...
const MultichainTransactionsViewTab =
  MultichainTransactionsView as React.ComponentType<TabLabelProps>;

const RampOrdersListTab =
  RampOrdersList as unknown as React.ComponentType<TabLabelProps>;
