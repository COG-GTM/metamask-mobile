...
const RampOrdersListTab = RampOrdersList as unknown as React.ComponentType<{
  tabLabel?: string;
}>;
...
const ActivityView = () => {
  ...
  const tabViewRef = useRef<React.ElementRef<typeof ScrollableTabView>>(null);
  ...
  return (
    <ErrorBoundary navigation={navigation} view="ActivityView">
      <View style={[styles.header, { marginTop: insets.top }]}>
        <Text
          style={styles.title}
          {...({ variant: DEFAULT_HEADERBASE_TITLE_TEXTVARIANT } as object)}
        >
