...
interface DrawerViewProps extends IWithMetricsAwarenessProps {
  ...
  */
   ...
   */
  selectedInternalAccount: NonNullable<
    ReturnType<typeof selectSelectedInternalAccount>
  >;
  /**
  /* Selected currency
  */
...
class DrawerView extends PureComponent<DrawerViewProps, DrawerViewState> {
  ...
  async componentDidUpdate() {
    ...
    if (!this.props.passwordSet || !this.props.seedphraseBackedUp) {
      ...
      if (
        ...
        tokenFound ||
        (this.props.collectibles as unknown[]).length > 0
      ) {
        // eslint-disable-next-line react/no-did-update-set-state
  ...
  onPressLock = async () => {
    ...
    if (!passwordSet) {
      ...
      ).replace(Routes.ONBOARDING.LOGIN, { locked: true });
    }
  };
  ...
  render() {
    ...
    const account: {
      ...
      name: nameFromState,
      ens: ensFromState,
      ...(selectedInternalAccount as unknown as Record<string, unknown>),
        ...
        <ScrollView>
          ...
          <View style={styles.account}>
            <View style={styles.accountBgOverlay}>
              ...
              <TouchableOpacity
                style={
                  (styles as unknown as Record<string, ViewStyle>).accountInfo
                }
                onPress={this.openAccountSelector}
                        ...
                        <TouchableOpacity
                          ...
                          ref={
                            (item.name === strings('drawer.browser') &&
                              this.browserSectionRef) as unknown as React.Ref<
...
const mapStateToProps = (state: RootState) => ({
  ...
  selectedInternalAccount: selectSelectedInternalAccount(state) as NonNullable<
    ReturnType<typeof selectSelectedInternalAccount>
  >,
