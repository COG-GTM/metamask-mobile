...
interface Props {
  ...
  newAssetTransaction: (asset: Asset) => void;
...
class DrawerView extends PureComponent<Props, State> {
  ...
  previousBalance: string | null = null;
