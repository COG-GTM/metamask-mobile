...
type PermissionsSummaryPageInformation =
...
interface SwitchCustomNetworkProps {
   ...
   */
  currentPageInformation: Partial<PermissionsSummaryPageInformation> &
    Pick<PermissionsSummaryPageInformation, 'url'>;
  /**
...
const SwitchCustomNetwork = ({
  ...
  return (
    <PermissionSummary
      ...
      currentPageInformation={
        currentPageInformation as PermissionsSummaryPageInformation
      }
      onCancel={onCancel}
      onConfirm={onConfirm}
