...
type CurrentPageInformation = PermissionsSummaryProps['currentPageInformation'];

interface Props {
  /**
   * Object containing current page title, url, and icon href
   */
  currentPageInformation: Pick<CurrentPageInformation, 'url'> &
    Partial<CurrentPageInformation>;
  /**
...
const SwitchCustomNetwork = ({
  ...
  return (
    <PermissionSummary
      ...
      currentPageInformation={currentPageInformation as CurrentPageInformation}
      onCancel={onCancel}
      onConfirm={onConfirm}
