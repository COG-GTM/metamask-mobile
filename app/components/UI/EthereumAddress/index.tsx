...
import { formatAddress, FormatAddressType } from '../../../util/address';
import generateTestId from '../../../../wdio/utils/generateTestId';
// @ts-expect-error WALLET_ACCOUNT_ADDRESS_LABEL is not exported by this module; the import resolves to undefined at runtime and is kept as-is to preserve behavior.
...
> {
  ...
  constructor(props: EthereumAddressProps) {
    ...
    this.state = {
      ensName: null,
      address: formatAddress(address as string, type as FormatAddressType),
    };
  }
