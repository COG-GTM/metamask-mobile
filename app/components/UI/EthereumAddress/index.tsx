...
// Previously imported from WalletView.testIds but the export never existed there.
// Defined inline to preserve the original runtime value (undefined) while satisfying strict TS.
...
> {
  static defaultProps: Partial<EthereumAddressProps> = {
    style: undefined,
    type: 'full',
  };
