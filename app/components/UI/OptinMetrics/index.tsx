...
type OnboardingTrackEventArgs = Parameters<IUseMetricsHook['trackEvent']>;
...
interface OptinMetricsProps extends IWithMetricsAwarenessProps {
  ...
  */
   ...
   */
  events: OnboardingTrackEventArgs[];
  /**
   ...
   */
  route: RouteProp<{ params: { onContinue?: () => void } }, 'params'>;
}
...
class OptinMetrics extends PureComponent<OptinMetricsProps, OptinMetricsState> {
  ...
  actionsList: OptinMetricsAction[] = isPastPrivacyPolicyDate
    ? [1, 2, 3].map((value) => ({
        action: value,
  ...
  componentDidMount() {
    ...
    BackHandler.addEventListener(
      'hardwareBackPress',
      this.handleBackPress as () => boolean | null | undefined,
    );
  }
