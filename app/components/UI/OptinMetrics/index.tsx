...
interface OptinMetricsProps {
  ...
  setDataCollectionForMarketing: (...args: unknown[]) => void;
  /**
   ...
   */
  setOnboardingWizardStep: (...args: unknown[]) => void;
  /**
   ...
   */
  clearOnboardingEvents: (...args: unknown[]) => void;
  /**
   * Object that represents the current route info like params passed to it
   */
  route: {
    params?: { onContinue?: () => void; [key: string]: unknown };
  };
  /**
...
> {
  ...
  componentDidUpdate(_: unknown, prevState: OptinMetricsState) {
    // Update the navbar
    this.updateNavBar();
    ...
    if (
      ...
      if ((scrollViewHeight ?? 0) >= scrollViewContentHeight) {
  ...
  renderAction = (
    { description, prefix }: OptinMetricsAction,
    i: number,
  ) => {
    const styles = this.getStyles();
   ...
   * @param {number} height
   */
  onContentSizeChange = (_: unknown, height: number) =>
