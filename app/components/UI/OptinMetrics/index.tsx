...
class OptinMetrics extends PureComponent<OptinMetricsProps, OptinMetricsState> {
   ...
   *
   * @param actionItem - Object containing action and description to be rendered
   * @param i - Index key
   */
  renderLegacyAction = (
   ...
   *
   * @param linkParams
   * @param linkParams.url
   * @param linkParams.title
   */
        ...
        >
          <View style={styles.wrapper}>
            ...
            {isPastPrivacyPolicyDate ? (
              ...
              >
                <Checkbox
                  isChecked={isDataCollectionForMarketingEnabled ?? undefined}
...
export default connect(
  ...
  // `withMetricsAwareness` is typed as only providing the `metrics` prop; the
  // remaining props are supplied by `connect` and the navigator.
  withMetricsAwareness(
