...
const createStyles = (colors: Theme['colors']) =>
  StyleSheet.create({
    ...
    warningContainer: {
      // 'left' is not a valid React Native flex alignment, but it is kept
      // as-is so the rendered style is unchanged by the TypeScript migration
...
interface PhishingModalProps {
  ...
  /**
   * Called when the user decides to go to etherscamdb
   */
  goToEtherscam?: () => void;
}
