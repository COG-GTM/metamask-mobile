...
interface OwnProps {
  ...
  // TODO: Replace "any" with type
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  onRefSet?: (ref: React.RefObject<any>) => void;
  /**
...
class Transactions extends PureComponent<Props, TransactionsState> {
  ...
  toggleDetailsView = (id: string, index?: number) => {
    ...
    if (this.selectedTx && oldId !== id && oldIndex !== index) {
      ...
      this.setState((state) => {
        ...
        this.selectedTx = show ? { id, index: index as number } : null;
        return { selectedTx };
      });
    }
  };
  ...
  // TODO: Replace "any" with type
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  onSpeedUpAction = (speedUpAction: boolean, existingGas?: any, tx?: Tx) => {
  ...
  // TODO: Replace "any" with type
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  onCancelAction = (cancelAction: boolean, existingGas?: any, tx?: Tx) => {
    this.existingGas = existingGas;
  ...
  handleSpeedUpTransactionFailure = (e: Error) => {
  ...
  handleCancelTransactionFailure = (e: Error) => {
  ...
  speedUpTransaction = async (transactionObject?: any) => {
    try {
      ...
      this.handleSpeedUpTransactionFailure(e as Error);
    }
  };
  ...
  cancelTransaction = async (transactionObject?: any) => {
    try {
      ...
      this.handleCancelTransactionFailure(e as Error);
    }
  };
