  ...
  describe('fetchTokenExchangeRates', () => {
    ...
    describe('Solana chain', () => {
      ...
      it('should fetch exchange rates for Solana tokens', async () => {
        ...
        handleFetch.mockResolvedValue(mockResponse);
    ...
    describe('EVM chain', () => {
      ...
      it('should fetch exchange rates for EVM tokens', async () => {
        ...
        fetchTokenContractExchangeRates.mockResolvedValue(mockResponse);
      ...
      it('should handle empty response for EVM tokens', async () => {
        fetchTokenContractExchangeRates.mockResolvedValue({});
    ...
    describe('Error handling', () => {
      it('should handle fetch errors gracefully', async () => {
        fetchTokenContractExchangeRates.mockRejectedValue(new Error('API error'));
