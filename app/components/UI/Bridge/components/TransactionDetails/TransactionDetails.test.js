...
describe('BridgeTransactionDetails', () => {
  ...
  const token3Address = '0x0000000000000000000000000000000000000003';
      ...
      backgroundState: {
        ...
        TokenBalancesController: {
          tokenBalances: {
            [mockAddress]: {
              [mockChainId]: {
                [token1Address]: '0x0de0b6b3a7640000', // 1 TOKEN1
                [token2Address]: '0x1bc16d674ec80000' // 2 TOKEN2
              },
              [optimismChainId]: {
                [token3Address]: '0x29a2241af62c0000' // 3 TOKEN3
              }
            }
          }
        },
        ...
        AccountTrackerController: {
          accounts: {
            [mockAddress]: {
              balance: '0x29a2241af62c0000' // 3 ETH
            }
          },
          accountsByChainId: {
            [mockChainId]: {
            ...
            [optimismChainId]: {
              [mockAddress]: {
                balance: '0x1158e460913d00000' // 20 ETH on Optimism
              }
            }
          }
        },
