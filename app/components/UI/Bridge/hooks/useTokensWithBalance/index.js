...
({ chainIds }) => {
  ...
  const evmAccountTokensAcrossChains = useSelector((state) =>
  ...
  const nonEvmTokens = useSelector((state) =>
  ...
  const sortedTokens = useMemo(() => {
    ...
    Object.values(evmAccountTokensAcrossChains).flat().
    ...
    const balances = calculateBalances({
      ...
      multiChainCurrencyRates,
      currentCurrency,
      selectedAddress: lastSelectedEvmAccount?.address
    });
