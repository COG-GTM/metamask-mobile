...
export let SwapBridgeNavigationLocation = /*#__PURE__*/function (SwapBridgeNavigationLocation) {SwapBridgeNavigationLocation["TabBar"] = "TabBar";SwapBridgeNavigationLocation["TokenDetails"] = "TokenDetails";return SwapBridgeNavigationLocation;}({});
...
export const useSwapBridgeNavigation = ({
  ...
  const isBridgeEnabledSource = useSelector((state) =>
  ...
  const goToNativeBridge = useCallback(
    (bridgeViewMode) => {
      ...
      const bridgeNativeSourceTokenFormatted =
