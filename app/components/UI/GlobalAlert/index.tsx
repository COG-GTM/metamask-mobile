...
class GlobalAlert extends PureComponent<Props> {
  ...
  renderClipboardAlert = () => {
    ...
    return (
      <ElevatedView
        style={[styles.copyAlert, { width: (this.props.data && this.props.data.width) || 180 }]}
        elevation={5}
      >
...
const mapDispatchToProps = (dispatch: (action: ReturnType<typeof dismissAlert>) => void): DispatchProps => ({
