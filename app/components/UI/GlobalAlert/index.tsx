...
const createStyles = (colors: Colors) => ({
  ...
  copyAlert: (width?: number | null): ViewStyle => ({
    width: width || 180,
...
type GlobalAlertProps = StateProps & DispatchProps;
...
class GlobalAlert extends PureComponent<GlobalAlertProps> {
  ...
  getComponent(content?: string | null): ReactNode {
    switch (content) {
...
const mapStateToProps = (state: RootState): StateProps => ({
  ...
  data: state.alert.data as AlertData | null | undefined,
});
