...
interface Styles {
  ...
  cancel: ViewStyle;
  confirm: ViewStyle;
  confirmButtonError: ViewStyle;
  confirmButtonWarning: ViewStyle;
}

const getStyles = (colors: Theme['colors']): Styles =>
  StyleSheet.create({
    actionContainer: {
      flex: 0,
      flexDirection: 'row',
...
interface ActionViewProps {
  ...
  style?: ViewStyle;
  confirmButtonState?: typeof ConfirmButtonState[keyof typeof ConfirmButtonState];
