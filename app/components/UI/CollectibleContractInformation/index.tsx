 ...
 */
const CollectibleContractInformation = ({
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      ...
      <ScrollView style={styles.informationWrapper}>
        ...
        {is_main_net && (
          <View style={styles.creditsView}>
            <TouchableOpacity style={styles.credits} onPress={goToOpenSea}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton} onPress={closeModal}>
