// The platform specific implementations (`index.ios.tsx` / `index.android.tsx`)
// are resolved by Metro, so this module specifier is only resolvable at runtime.
// eslint-disable-next-line import/no-unresolved
// @ts-expect-error - Resolved by the bundler at build time
