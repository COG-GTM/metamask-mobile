...
function SliderButton({
  ...
  // `Animated.ValueXY` is constructed here with positional numbers, a call
  // signature that is not described by the React Native types.
  const pan = useRef(
  ...
  return (
    <View
      ...
      testID={
        (SwapsViewSelectors as Record<string, string>).SWIPE_TO_SWAP_BUTTON
      }
    >
