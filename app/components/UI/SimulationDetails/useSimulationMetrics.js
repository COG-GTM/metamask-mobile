...
import {
  ...
  useDisplayNames } from
'../../hooks/DisplayName/useDisplayName';
...
export let SimulationResponseType = /*#__PURE__*/function (SimulationResponseType) {SimulationResponseType["Failed"] = "failed";SimulationResponseType["Reverted"] = "transaction_revert";SimulationResponseType["NoChanges"] = "no_balance_change";SimulationResponseType["Changes"] = "balance_change";SimulationResponseType["InProgress"] = "simulation_in_progress";return SimulationResponseType;}({});
...
export let FiatType = /*#__PURE__*/function (FiatType) {FiatType["Available"] = "available";FiatType["NotAvailable"] = "not_available";return FiatType;}({});
...
export function useSimulationMetrics({
  ...
  const displayNameRequests = balanceChanges.map(
    ({ asset }) => ({
      value: asset.address ?? '',
  ...
  includes(simulationData?.error?.code);
...
function getProperties(changes, prefix) {
...
function getSensitiveProperties(changes, prefix) {
...
function getPrefixProperties(properties, prefix) {
