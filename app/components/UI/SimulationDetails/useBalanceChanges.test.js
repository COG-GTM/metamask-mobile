...
const mockSelectConversionRate = selectConversionRateByChainId;
...
const ERC20_TOKEN_ADDRESS_1_MOCK = '0x0erc20_1';
const ERC20_TOKEN_ADDRESS_2_MOCK = '0x0erc20_2';
const ERC20_TOKEN_ADDRESS_3_MOCK = '0x0erc20_3';
...
const NFT_TOKEN_ADDRESS_MOCK = '0x0nft';

const TOKEN_ID_1_MOCK = '0x123';

const DIFFERENCE_1_MOCK = '0x11';
const DIFFERENCE_2_MOCK = '0x2';
const DIFFERENCE_ETH_MOCK = '0x1234567890123456789';

const CHAIN_ID_MOCK = '0x123';

const dummyBalanceChange = {
  previousBalance: '0xIGNORE',
  newBalance: '0xIGNORE'
};
...
describe('useBalanceChanges', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    mockGetTokenDetails.mockImplementation((address) => {
      const decimalMap = {
