...
import {
  default as SimulationDetails } from
...
const DUMMY_BALANCE_CHANGE = {
  previousBalance: '0xIGNORED',
  newBalance: '0xIGNORED'
};
...
export const LongValuesAndNames = {
  args: buildArgs({
    simulationData: {
      nativeBalanceChange: {
        ...DUMMY_BALANCE_CHANGE,
...
export const PolygonNativeAsset = {
  args: buildArgs({
    simulationData: {
      nativeBalanceChange: {
        ...DUMMY_BALANCE_CHANGE,
...
export const ArbitrumNativeAsset = {
  args: buildArgs({
    simulationData: {
      nativeBalanceChange: {
        ...DUMMY_BALANCE_CHANGE,
...
export const TransactionReverted = {
  args: buildArgs({
    simulationData: {
