...
type HandleSelectAsset = (asset: Asset) => void;
...
interface AssetListProps {
   ...
   */
  handleSelectAsset: HandleSelectAsset | null;
  /**
...
export default class AssetList extends PureComponent<AssetListProps> {
  onToggleAsset = (key: number) => {
    ...
    (handleSelectAsset as HandleSelectAsset)((searchResults as Asset[])[key]);
  };
        ...
        {searchResults.slice(0, 6).map((_, i) => {
          ...
          return (
            <StyledButton
              ...
              onPress={() =>
                (handleSelectAsset as HandleSelectAsset)(searchResults[i])
              } // eslint-disable-line
              key={i}
            >
