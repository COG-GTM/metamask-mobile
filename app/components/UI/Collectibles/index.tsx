...
> {
  ...
  refreshMetadata = () => {
    ...
    const longPressed = this.longPressedCollectible as unknown as {
      current: Collectible;
    };
    NftController.addNft(
      longPressed.current.address,
      longPressed.current.tokenId,
    );
  };
    ...
    return (
      ...
      >
        <View style={styles.itemWrapper}>
          <CollectibleMedia
            small
            collectible={item as CollectibleMediaProps['collectible']}
          />
