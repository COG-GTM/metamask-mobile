...
const EditGasFeeLegacy = ({
  ...
  const toggleAdvancedOptions = () => {
    ...
    setShowAdvancedOptions((isShown) => !isShown);
  };
  ...
  const selectOption = (option: string) => {
    ...
    changeGas(
      { ...gasFee, suggestedGasPrice: gasOptions?.[option] as string },
      option,
    );
  };
    ...
    if (typeof warning === 'string')
      return (
        <Alert
          ...
          // TODO: `createStyles` defines no `warningContainer`
      ...
      <ScrollView style={styles.wrapper}>
        <TouchableWithoutFeedback>
          <View>
            ...
            {/* `renderWarning` and `renderError` are passed as functions rather than called */}
              ...
              {!onlyAdvanced && (
                <View>
                  <HorizontalSelector
                    ...
                    // TODO: `options` expects an array, but the function itself has always
                    // been passed here. Also `disabled` is a required prop that is not set.
                    // @ts-expect-error preserving existing behaviour
