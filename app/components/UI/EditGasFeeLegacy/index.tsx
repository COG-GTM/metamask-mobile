...
interface EditGasFeeLegacyProps {
  ...
  /**
   * (For analytics purposes) View where this component is being used
   */
  view: string;
}
    ...
    if (typeof warning === 'string')
      return (
        <Alert
          ...
          style={(styles as { warningContainer?: object }).warningContainer}
        >
          {() => (
              ...
              {!onlyAdvanced && (
                <View>
                  <HorizontalSelector
                    ...
                    disabled={false}
                    options={renderOptions as unknown as never[]}
                  />
                </View>
              )}
