...
// the legacy markup omits `disabled` and passes `options` as a function
const LegacyHorizontalSelector = HorizontalSelector as unknown as ComponentType<
  Omit<Partial<React.ComponentProps<typeof HorizontalSelector>>, 'options'> & {
    options?: unknown;
  }
>;
...
const EditGasFeeLegacy = ({
  ...
  const changeGas = (gas: LegacyGasFee, newSelectedOption: string | null) => {
