...
export const NetworkBadgeSource = (chainId) => {
...
const Balance = ({ asset, mainBalance, secondaryBalance }) => {
  const { styles } = useStyles(styleSheet, {});
  const navigation = useNavigation();
  const networkConfigurationByChainId = useSelector((state) =>
  selectNetworkConfigurationByChainId(state, asset.chainId)
  );
      ...
      <AssetElement
        ...
        <BadgeWrapper
          ...
          <Badge
            ...
            imageSource={NetworkBadgeSource(tokenChainId)}
