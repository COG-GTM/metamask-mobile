...
// Transaction, swaps and bridge shapes are highly dynamic across controllers,
// so they are represented as loose records here.
...
interface TransactionElementProps {
  ...
  */
  selectedInternalAccount?: AnyRecord;
  /**
  ...
  signQRTransaction?: (tx: AnyRecord) => void;
  cancelUnsignedQRTransaction?: (tx: AnyRecord) => void;
  isQRHardwareAccount?: boolean;
  isLedgerAccount?: boolean;
  signLedgerTransaction?: (tx: AnyRecord) => void;
  bridgeTxHistoryData?: AnyRecord;
   ...
   */
  networkConfigurationsByChainId?: AnyRecord;
  /**
   * Navigation object for routing
   */
  navigation?: {
    navigate: (route: string, params?: AnyRecord) => void;
  };
}
...
> {
        ...
        <>
          ...
          >
            <Text style={styles.importText}>
              ...
              <FAIcon
                name="info-circle"
                style={(styles as AnyRecord).infoIcon}
              />
            </Text>
  ...
  renderTxElementIcon = (
    ...
    return (
      ...
      >
        <Image source={icon as AnyRecord} style={styles.icon} resizeMode="stretch" />
      </BadgeWrapper>
    );
  };
   ...
   */
  renderTxElement = (transactionElement: AnyRecord) => {
    const {
