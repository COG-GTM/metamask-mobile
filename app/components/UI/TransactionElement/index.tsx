...
export type TransactionElementTx = TransactionMeta & {
...
interface TransactionElementState {
  ...
  transactionGas: {
    gasBN: BN | undefined;
    gasPriceBN: BN | undefined;
    gasTotal: BN | undefined;
  };
  transactionElement: TransactionElementType | undefined;
  transactionDetails: TransactionDetailsType | undefined;
}
        ...
        <>
          ...
          >
            <Text style={styles.importText}>
              ...
              <FAIcon
                name="info-circle"
                style={(styles as { infoIcon?: StyleProp<TextStyle> }).infoIcon}
              />
            </Text>
