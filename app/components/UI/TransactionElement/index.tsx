...
interface SelectedInternalAccountLike {
  address?: string;
  metadata: {
    importTime?: number;
    [key: string]: unknown;
...
interface TransactionElementProps {
  assetSymbol?: string;
  tx: TxObject;
  selectedInternalAccount?: SelectedInternalAccountLike;
  i?: number;
  ...
  swapsTokens?: unknown[];
  signQRTransaction?: (tx: TxObject) => void;
  cancelUnsignedQRTransaction?: (tx: TxObject) => void;
  isQRHardwareAccount?: boolean;
  isLedgerAccount?: boolean;
  signLedgerTransaction?: (tx: TxObject) => void;
...
const ConnectedTransactionElement = connector(
  TransactionElementWithBridge as unknown as Parameters<typeof connector>[0],
);

export default ConnectedTransactionElement as unknown as React.ComponentType<
  Partial<Omit<TransactionElementProps, 'bridgeTxHistoryData'>>
>;
