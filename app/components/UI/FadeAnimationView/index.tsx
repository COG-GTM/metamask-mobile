...
const FadeAnimationView = ({
  ...
  // `null` (rather than `undefined`) is intentionally passed through so the
  // rendered output (and existing snapshots) remain unchanged.
  const pointerEvents = (
    isAnimating ? 'none' : null
  ) as ViewProps['pointerEvents'];
