...
// `pointerEvents` is set to `null` rather than `undefined` to keep the rendered
// output identical to the JavaScript implementation
type PointerEvents = React.ComponentProps<
...
const FadeAnimationView = ({
  ...
  return (
    <Animated.View // Special animatable View
      ...
      pointerEvents={isAnimating ? 'none' : (null as unknown as PointerEvents)}
    >
