...
// `../GenericButton` resolves to platform-specific `index.ios.tsx`/`index.android.tsx`
// at runtime via Metro. TypeScript cannot resolve that; use `require` to avoid
// breaking type-checking while preserving runtime behavior.
// eslint-disable-next-line @typescript-eslint/no-var-requires, import/no-unresolved
const GenericButton: React.ComponentType<{
  onPress?: () => void;
  style?: StyleProp<ViewStyle>;
  children?: ReactNode;
}> = require('../GenericButton').default;
