...
describe('aggregatorOrderToFiatOrder', () => {
  ...
  it('should return a fiat order', () => {
    ...
    expect(aggregatorOrderToFiatOrder(mockOrder)).toEqual({
      id: 'test-id',
      provider: 'AGGREGATOR',
      createdAt: 1673886669608,
      amount: 123,
    ...
    expect(aggregatorOrderToFiatOrder(failedOrder)).toEqual({
      id: 'test-id',
      provider: 'AGGREGATOR',
      createdAt: 1673886669608,
      amount: 123,
    ...
    expect(aggregatorOrderToFiatOrder(cancelledOrder)).toEqual({
      id: 'test-id',
      provider: 'AGGREGATOR',
      createdAt: 1673886669608,
      amount: 123,
    ...
    expect(aggregatorOrderToFiatOrder(pendingOrder)).toEqual({
      id: 'test-id',
      provider: 'AGGREGATOR',
      createdAt: 1673886669608,
      amount: 123,
    ...
    expect(aggregatorOrderToFiatOrder(createdOrder)).toEqual({
      id: 'test-id',
      provider: 'AGGREGATOR',
      createdAt: 1673886669608,
      amount: 123,
    ...
    expect(aggregatorOrderToFiatOrder(unknownStateOrder)).toEqual({
      id: 'test-id',
      provider: 'AGGREGATOR',
      createdAt: 1673886669608,
      amount: 123,
  ...
  it('should return a fiat order with default values', () => {
    ...
    expect(aggregatorOrderToFiatOrder(mockOrder1)).toEqual({
      id: 'test-id',
      provider: 'AGGREGATOR',
      createdAt: 1673886669608,
      amount: 123,
    ...
    expect(aggregatorOrderToFiatOrder(mockOrder2)).toEqual({
      id: 'test-id',
      provider: 'AGGREGATOR',
      createdAt: 1673886669608,
      amount: 123,
