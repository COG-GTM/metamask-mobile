...
import {
  ...
  ProviderBuyFeatureBrowserEnum } from
...
import {
  ...
  fireEvent,
  screen,
  render as renderComponent } from
...
const mockUseRampSDKInitialValues = {
  ...
  selectedRegion: { id: 'mock-region-id' },
  selectedAsset: { id: 'mock-asset-id' },
...
const mockUseParamsInitialValues = {
  amount: 50,
  asset: {
    symbol: 'ETH'
  },
...
const mockUseQuotesAndCustomActionsInitialValues =

{
  quotes: mockQuotesData,
  quotesWithoutError: mockQuotesData,
  quotesWithError: [],
  quotesByPriceWithoutError: mockQuotesData,
  quotesByReliabilityWithoutError: mockQuotesData,
  recommendedCustomAction: undefined,
  recommendedQuote: mockQuotesData[1],
  sorted: [],
  isFetching: false,
  error: null,
...
let mockUseQuotesAndCustomActionsValues =
