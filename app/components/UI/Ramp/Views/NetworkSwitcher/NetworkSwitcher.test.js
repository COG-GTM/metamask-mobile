...
const mockedRampNetworksValues = [
{
  active: true,
  chainId: '1',
...
function render(Component, chainId) {
  return renderScreen(
    Component,
    {
...
const mockUseFetchRampNetworksInitialValues =
...
const mockUseRampNetworksDetailInitialValues =
...
describe('NetworkSwitcher View', () => {
  afterEach(() => {
    ...
    mockUseRampNetworksDetailInitialValues.getNetworksDetail.
    mockClear();
