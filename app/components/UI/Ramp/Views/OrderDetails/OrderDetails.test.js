...
function mockGetUpdatedOrder(order) {
  return {
    ...order,
...
function render(Component, orders = [mockOrder]) {
  return renderScreen(
    Component,
    {
...
describe('OrderDetails', () => {
  ...
  it('polls for a created order on load and dispatches an action to update', async () => {
    ...
    const updatedOrder = mockGetUpdatedOrder(createdOrder);
  ...
  it('renders an error screen if a CREATED order cannot be polled on load', async () => {
    ...
    processFiatOrder.mockImplementationOnce(() => {
