...
import {
  ...
  mockPaymentMethods,
  mockRegionsData } from
'./BuildQuote.constants';
...
const mockUseRegionsInitialValues = {
...
const mockUseCryptoCurrenciesInitialValues =
...
let mockUseCryptoCurrenciesValues =
...
const mockUseFiatCurrenciesInitialValues =
...
let mockUseFiatCurrenciesValues =
{
...
const mockUsePaymentMethodsInitialValues =

{
  ...
  currentPaymentMethod: mockPaymentMethods[0]
};
...
const MIN_LIMIT = 2;
const mockUseLimitsInitialValues = {
  limits: {
    minAmount: MIN_LIMIT,
    maxAmount: MAX_LIMIT,
    feeDynamicRate: 1,
...
const mockUseAddressBalanceInitialValue =
{
...
const mockUseBalanceInitialValue = {
  balanceFiat: '$27.02',
  balanceBN: toTokenMinimalUnit('5.36385', 18)
};

let mockUseBalanceValues = {
...
const mockUseGasPriceEstimationInitialValue =
...
let mockUseGasPriceEstimationValue =
...
describe('BuildQuote View', () => {
  afterEach(() => {
    ...
    mockUseRampSDKInitialValues.setSelectedRegion.mockClear();
    jest.clearAllMocks();
  });
