...
const mockGetGasLimit = getGasLimit;
const mockGenerateTransferData = generateTransferData;
...
describe('useERC20GasLimitEstimation', () => {
  ...
  it('handles concurrent estimation requests', async () => {
    ...
    const firstEstimation = new Promise(
      (resolve) => {
        resolveFirst = resolve;
      }
    );

    const secondEstimation = new Promise(
      (resolve) => {
