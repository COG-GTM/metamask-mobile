...
const MAX_REGION_RESULTS = 20;var

RegionViewType = /*#__PURE__*/function (RegionViewType) {RegionViewType["COUNTRY"] = "COUNTRY";RegionViewType["STATE"] = "STATE";return RegionViewType;}(RegionViewType || {});
...
const RegionModal = ({
  ...
  const fuseData = useMemo(() => {
    const flatRegions = currentData.reduce(
      (acc, region) => [
      ...acc,
      region,
      ...(region.states || [])],
