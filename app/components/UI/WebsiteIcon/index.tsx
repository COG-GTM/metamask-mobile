...
import { StyleSheet, View, Text, Image, ImageStyle, StyleProp, ViewStyle, TextStyle } from 'react-native';
    ...
    return (
      <View style={viewStyle}>
        {imageSVG ? (
          <SvgUri
            uri={imageSVG}
            width={(style as ImageStyle)?.width as number | string | undefined}
            height={(style as ImageStyle)?.height as number | string | undefined}
            style={style}
...
export default withFaviconAwareness(WebsiteIcon as any);
