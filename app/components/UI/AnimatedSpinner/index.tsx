...
const measures: Record<SpinnerSizeType, MeasureConfig> = {
  [SpinnerSize.SM]: {
    Android: {
      height: 30.5,
      width: 30.5,
...
const createStyles = (colors: Theme['colors'], measureConfig: MeasureConfig) =>
  StyleSheet.create({
    view: {
      position: 'relative',
      ...
      width: Device.isAndroid()
        ? measureConfig.Android.width
        : measureConfig.iOS.width,
