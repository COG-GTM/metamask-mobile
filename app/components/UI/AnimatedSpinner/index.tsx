...
interface MeasuresType {
  [SpinnerSize.SM]: MeasureConfig;
  [SpinnerSize.MD]: MeasureConfig;
}
...
const createStyles = (colors: Colors, measureConfig: MeasureConfig): StylesType =>
  StyleSheet.create({
    view: {
      position: 'relative',
      height: Device.isAndroid()
        ? measureConfig.Android.height
        : measureConfig.iOS.height,
      width: Device.isAndroid() ? measureConfig.Android.width : measureConfig.iOS.width,
    ...
    static: {
      ...
      borderRadius: measureConfig.static.borderRadius,
      width: measureConfig.static.width,
      height: measureConfig.static.height,
    },
  });
