...
function useBalance(accounts: any, balances: any, selectedAddress: any, sourceToken: any, { asUnits = false }: any = {}, ) {
  ...
  const balance = useMemo(() => {
    ...
    const tokenAddress: any = safeToChecksumAddress(sourceToken.address);
