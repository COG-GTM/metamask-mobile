...
describe('useFiatConversionRates', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    safeToChecksumAddress.mockReturnValue(mockChecksumAddress);
  ...
  it('should return undefined when checksumAddress is null', async () => {
    safeToChecksumAddress.mockReturnValue(null);
  ...
  it('should handle errors from fetchTokenContractExchangeRates', async () => {
    ...
    fetchTokenContractExchangeRates.mockRejectedValue(mockError);
