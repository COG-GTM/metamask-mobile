...
function useBlockExplorer(
  networkConfigurations: Parameters<typeof findBlockExplorerForRpc>[1],
  providerConfigTokenExplorer?: ReturnType<typeof selectProviderConfig>,
) {
