...
interface ValidTokenMetadataState {
  valid: true;
  error: false;
  metadata: TokenMetadata;
}

interface InvalidTokenMetadataState {
  valid: false | null;
  error: boolean;
  metadata: null;
}
...
export type TokenMetadataState =
  | ValidTokenMetadataState
  | InvalidTokenMetadataState;

const defaultTokenMetadata: InvalidTokenMetadataState = {
  valid: null,
  error: false,
  metadata: null,
};
