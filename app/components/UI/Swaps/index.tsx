...
type SwapsAmountRoute = RouteProp<
  { SwapsAmountView: SwapsAmountRouteParams | undefined },
  'SwapsAmountView'
>;

type ShakeableView = ElementRef<typeof AnimatableView> & {
  shake?: () => void;
};
...
function SwapsAmountView({
  ...
  const keypadViewRef = useRef<ShakeableView>(null);
  ...
  useEffect(() => {
    (async () => {
      if (
        ...
        setContractBalanceAsUnits(safeNumberToBN(0) as BN);
