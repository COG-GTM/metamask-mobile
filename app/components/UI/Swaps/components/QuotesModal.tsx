...
export interface QuotesModalQuote {
  aggregator: string;
  aggType: string;
  sourceAmount: string;
  /**
...
function QuotesModal({
  ...
  if (multiLayerL1ApprovalFeeTotal) {
    selectedDetailsQuoteValuesEthFee = multiLayerEthFee(
      multiLayerL1ApprovalFeeTotal,
      selectedDetailsQuoteValuesEthFee,
    );
  }
