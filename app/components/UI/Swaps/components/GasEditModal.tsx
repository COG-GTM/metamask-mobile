...
function GasEditModal({
  ...
  const [EIP1559TransactionDataTemp, setEIP1559TransactionDataTemp] = useState<Record<string, unknown>>(
    {},
  );
  const [LegacyTransactionDataTemp, setLegacyTransactionDataTemp] = useState<Record<string, unknown>>(
    {},
  );
  const [
