...
type GasFeeEstimates = Record<string, GasFeeEstimateLevel>;
...
interface OwnProps {
  ...
  isVisible?: boolean;
  onGasUpdate: (gas: Record<string, unknown>, gasLimit: unknown) => void;
