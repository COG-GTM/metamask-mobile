...
interface ParsedGasTransaction {
  error?: string;
...
interface CalculateGasFeeOption {
  suggestedMaxFeePerGas?: string;
  suggestedMaxPriorityFeePerGas?: string;
  suggestedGasLimit?: string;
  estimatedBaseFee?: string;
...
interface CalculateGasFeeLegacyOption {
  suggestedGasLimit?: string;
  suggestedGasPrice?: string;
}
...
interface OwnProps {
  ...
  isVisible?: boolean;
  onGasUpdate: (gas: object, gasLimit?: string) => void;
...
function GasEditModal({
  ...
  const calculateTempGasFeeLegacy = useCallback(
    (
      { suggestedGasLimit, suggestedGasPrice }: CalculateGasFeeLegacyOption,
      selected: string | undefined,
    ) => {
                  ...
                  <TouchableOpacity onPress={showGasFeeRecommendation}>
                    <Text noMargin link bold small centered>
                      ...
                      <MaterialCommunityIcon
                        ...
                        size={14}
                        style={
                          (styles as { labelInfo?: StyleProp<TextStyle> })
                            .labelInfo
                        }
                      />
                    </Text>
