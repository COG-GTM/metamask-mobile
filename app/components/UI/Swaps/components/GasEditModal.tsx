...
// TODO: Replace "any" with type
// eslint-disable-next-line @typescript-eslint/no-explicit-any
type TransactionDataTemp = Record<string, any>;
...
interface OwnProps {
   ...
   */
  checkEnoughEthBalance: (balanceHex?: string) => boolean;
  /**
...
function GasEditModal({
  ...
  const calculateTempGasFeeLegacy = useCallback(
    (
      { suggestedGasLimit, suggestedGasPrice }: TransactionDataTemp,
      selected: string | null,
    ) => {
                  ...
                  <TouchableOpacity onPress={showGasFeeRecommendation}>
                    <Text noMargin link bold small centered>
                      ...
                      <MaterialCommunityIcon
                        ...
                        size={14}
                        style={
                          (styles as unknown as Record<string, undefined>)
                            .labelInfo
                        }
                      />
                    </Text>
