...
interface LoadingAnimationProps {
   ...
   */
  aggregatorMetadata?: Record<string, Omit<AggregatorMetadata, 'key'>>;
  /**
      ...
      headPan
        ? [
            ...
            Animated.parallel([
              ...
              ...(() => {
                const lastKey = [...metadata].pop()?.key;
                return lastKey
                  ? [
                      Animated.timing(opacities[lastKey], {
                        toValue: 0,
                        duration: PAN_DURATION,
                        useNativeDriver: true,
                      }),
  ...
  useEffect(() => {
    (async () => {
      ...
      if (!aggregatorMetadata) {
        ...
        const metadata: AggregatorMetadata[] = Object.entries(aggregatorMetadata).map(
          ([key, value]) => ({
            key,
            ...value,
          }),
