...
type AggregatorMetadataWithKey = AggregatorMetadata & { key: string };
...
function LoadingAnimation({
   ...
   */
  const positions: Record<string, number[]> = useMemo(
    () =>
      headPan
  ...
  const opacities: Record<string, Animated.Value> = useMemo(
    () =>
      headPan
        ? metadata.reduce(
    ...
    () =>
      headPan
        ? [
            ...
            ...metadata.reduce(
              (
                acc: (Animated.CompositeAnimation | false)[],
                cur,
                index,
                array,
              ) => [
              ...
              [] as (Animated.CompositeAnimation | false)[],
            ),
