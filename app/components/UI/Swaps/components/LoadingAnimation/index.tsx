...
const createStyles = (colors: Colors, shadows: any) =>
  StyleSheet.create({
    screen: {
      flex: 1,
...
function LoadingAnimation({
        ...
        ? [
            ...
            ...metadata.reduce(
              (acc, cur, index, array) => [
                ...
                Animated.parallel([
                  // If is not the first aggregator, reduce previous aggregator opacity to 0
                  ...(index > 0 ? [Animated.timing(opacities[array[index - 1].key], {
                      toValue: 0,
                  ...
                  ...(!Device.isAndroid() ? [Animated.timing(foxHeadPan, {
                      toValue: {
  ...
  const endAnimation = useCallback((): void => {
