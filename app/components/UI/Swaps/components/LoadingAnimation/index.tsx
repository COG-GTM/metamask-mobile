...
interface AggregatorMetadataItem extends AggregatorMetadataValue {
  key: string;
}
...
interface LoadingAnimationProps {
  finish?: boolean;
  onAnimationEnd?: () => void;
  aggregatorMetadata?: Record<string, AggregatorMetadataValue>;
  headPan?: boolean;
}
  ...
  useEffect(() => {
    (async () => {
      ...
      if (!aggregatorMetadata) {
        ...
        const mappedMetadata = Object.entries(aggregatorMetadata).map(
          ([key, value]) => ({
            key,
            ...value,
          }),
