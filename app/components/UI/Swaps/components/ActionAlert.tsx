...
const getButtonStyle = (type: string | undefined, styles: Styles) => {
  switch (type) {
...
const getInfoIconStyle = (type: string | undefined, styles: Styles) => {
  switch (type) {
    case AlertType.Error: {
...
interface ActionAlertProps {
  ...
  onInfoPress?: () => void;
  action?: string;
  children?: ((textStyle: TextStyle) => ReactNode) | ReactNode;
}
      ...
      {(textStyle: TextStyle) => (
        <>
          <View style={styles.wrapper}>
            <View style={[styles.content]}>{typeof children === 'function' ? children(textStyle) : children}</View>
            {Boolean(action) && (
