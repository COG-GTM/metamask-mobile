...
interface OwnProps {
  ...
  onItemPress: (token: TokenType) => void;
...
function TokenSelectModal({
  ...
  const sortedInitialTokensWithFiatValue = useMemo(
    () =>
      ...
      } as unknown as Parameters<typeof getSortedTokensByFiatValue>[0]),
    [
      initialTokens,
      accounts,
      selectedAddress,
  ...
  const tokenMetadataData = tokenMetadata.metadata as TokenType;
            ...
            {loadingTokenMetadata ? (
              ...
              <View style={styles.resultRow}>
                <ListItem>
                  <ListItem.Content>
                    <ListItem.Icon>
                      <TokenIcon
                        medium
                        icon={tokenMetadataData.iconUrl}
                        symbol={tokenMetadataData.symbol}
                      />
                    </ListItem.Icon>
                    <ListItem.Body>
                      <ListItem.Title>
                        {tokenMetadataData.symbol}
                      </ListItem.Title>
                      {tokenMetadataData.name && (
                        <Text>{tokenMetadataData.name}</Text>
                      )}
                    </ListItem.Body>
                    <ListItem.Amounts>
                      <TouchableOpacity
                ...
                <TokenImportModal
                  ...
                  token={tokenMetadataData}
                  onPressImport={() => handlePressImportToken(tokenMetadataData)}
                />
              </View>
            ) : (
              <View style={styles.emptyList}>
