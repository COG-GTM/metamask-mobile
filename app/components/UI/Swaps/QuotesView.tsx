...
async function addTokenToAssetsController(newToken: Partial<Token>, chainId: string, networkClientId: string) {
...
interface SwapsQuotesViewProps {
  ...
  topAggId: string;
  aggregatorMetadata: Record<string, Record<string, string>>;
