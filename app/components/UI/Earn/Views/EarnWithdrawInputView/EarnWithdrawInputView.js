...
import {
  EVENT_LOCATIONS,
  EVENT_PROVIDERS } from
'../../../Stake/constants/events';
...
const EarnWithdrawInputView = () => {
  ...
  selectContractExchangeRatesByChainId(state, token.chainId)
  );
  const exchangeRate = contractExchangeRates?.[token.address]?.price;
