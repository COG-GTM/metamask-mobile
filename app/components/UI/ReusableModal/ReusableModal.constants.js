/**
 * This indicates that 60% of the modal needs to be offscreen to meet the distance threshold.
 */
...
/**
 * The animation duration of the modal after tapping on an action.
 */
export const TAP_TRIGGERED_ANIMATION_DURATION = 300;
/**
 * The animation duration of the modal after letting go of a swipe.
 */
