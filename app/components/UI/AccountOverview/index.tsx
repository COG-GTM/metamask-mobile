...
interface AccountOverviewNavigation {
  navigate: (...args: [string, (object | undefined)?]) => void;
}
...
interface AccountOverviewStateProps {
...
interface AccountOverviewDispatchProps {
...
type AccountOverviewProps = AccountOverviewStateProps &
  AccountOverviewDispatchProps &
  AccountOverviewOwnProps;
  ...
  setAccountLabel = () => {
    ...
    Engine.setAccountLabel(
      ...
      this.isAccountLabelDefined(accountLabel)
        ? accountLabel
        : (accountWithMatchingToAddress as InternalAccount).metadata.name,
    );
