...
interface AccountOverviewNavigationParamList {
...
interface OwnProps extends IWithMetricsAwarenessProps {
  ...
  */
  navigation: StackNavigationProp<AccountOverviewNavigationParamList>;
}
...
type AccountOverviewProps = OwnProps & StateProps & DispatchProps;
...
export default connect(
  ...
  // The HOC only declares the props it injects, so the wrapped component's own
  // props have to be erased for the cast.
