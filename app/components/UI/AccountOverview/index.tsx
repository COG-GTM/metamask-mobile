...
interface AccountOverviewAlertConfig {
  isVisible: boolean;
  autodismiss: number;
  content: string;
...
interface AccountOverviewProps
  extends AccountOverviewOwnProps,
   ...
   */
  showAlert: (config: AccountOverviewAlertConfig) => void;
  /**
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  showAlert: (config: AccountOverviewAlertConfig) =>
...
) as unknown as ComponentType<Partial<AccountOverviewOwnProps>>;
