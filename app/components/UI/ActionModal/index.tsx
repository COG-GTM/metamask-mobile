...
interface ActionModalProps {
   ...
   */
  onCancelPress?: (...args: unknown[]) => void;
  /**
   * Called when the confirm button is clicked
   */
  onConfirmPress?: (...args: unknown[]) => void;
  /**
   ...
   * View wrapper style
   */
  viewWrapperStyle?: Record<string, unknown>;
  /**
   * View container style
   */
  viewContainerStyle?: Record<string, unknown>;
  /**
   ...
   */
  childrenContainerStyle?: Record<string, unknown>;
  /**
  ...
  return (
    ...
    >
      <ActionContent
        ...
        onCancelPress={onCancelPress as () => void}
        onConfirmPress={onConfirmPress as () => void}
