...
const createStyles = (colors: Colors) =>
  StyleSheet.create({
    ...
    stepCounter: {
      ...(typography as Record<string, TextStyle>).BodyMD,
...
> {
   ...
   */
  getIndicatorStyle = (
    topIndicatorPosition: Exclude<TopIndicatorPosition, false>,
  ) => {
    const styles = this.getStyles();

    const positions: Record<
      Exclude<TopIndicatorPosition, false>,
      ViewStyle
    > = {
  ...
  getBotttomIndicatorStyle = (
    bottomIndicatorPosition: Exclude<BottomIndicatorPosition, false>,
  ) => {
    const styles = this.getStyles();

    const positions: Record<
      Exclude<BottomIndicatorPosition, false>,
      ViewStyle
    > = {
