...
> {
  ...
  getIndicatorStyle = (topIndicatorPosition: TopIndicatorPosition) => {
    ...
    return (
      (topIndicatorPosition && positions[topIndicatorPosition]) ||
      styles.topCenter
    );
  };
  ...
  getBotttomIndicatorStyle = (
    ...
    return (
      (bottomIndicatorPosition && positions[bottomIndicatorPosition]) ||
      styles.bottomCenter
    );
  };
...
(Coachmark as unknown as { contextType: typeof ThemeContext }).contextType = ThemeContext;
