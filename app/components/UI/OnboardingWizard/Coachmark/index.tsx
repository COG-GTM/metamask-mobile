...
const createStyles = (colors: Theme['colors']) =>
  StyleSheet.create({
    ...
    stepCounter: {
      ...(typography as unknown as Record<string, object>).BodyMD,
...
> {
  ...
  getIndicatorStyle = (topIndicatorPosition: TopIndicatorPosition) => {
    ...
    const positions: Record<TopIndicatorPosition, StyleProp<ViewStyle>> = {
  ...
  getBotttomIndicatorStyle = (
    ...
    const positions: Record<BottomIndicatorPosition, StyleProp<ViewStyle>> = {
