...
export type CoachmarkTopIndicatorPosition =
  | false
  | 'topCenter'
  | 'topLeft'
  | 'topLeftCorner'
...
export type CoachmarkBottomIndicatorPosition =
  | false
  | 'bottomCenter'
  | 'bottomLeft'
  | 'bottomLeftCorner'
...
export interface CoachmarkProps {
   ...
   */
  topIndicatorPosition?: CoachmarkTopIndicatorPosition;
  /**
   * Bottom indicator position
   */
  bottomIndicatorPosition?: CoachmarkBottomIndicatorPosition;
  /**
...
> {
   ...
   */
  getIndicatorStyle = (
    topIndicatorPosition: Exclude<CoachmarkTopIndicatorPosition, false>,
  ) => {
  ...
  getBotttomIndicatorStyle = (
    bottomIndicatorPosition: Exclude<CoachmarkBottomIndicatorPosition, false>,
  ) => {
    const styles = this.getStyles();
        ...
        <View style={[styles.coachmark, coachmarkStyle]}>
          <View style={styles.titleContainer}>
            ...
            <ButtonIcon
              ...
              size={ButtonIconSizes.Sm}
              onPress={onClose as ButtonIconProps['onPress']}
              iconColor={IconColor.Inverse}
            />
          </View>
          {content}
