...
import {
  ...
  isTestNet,
  getDefaultNetworkByChainId } from
'../../../../../util/networks';
...
import {
  ...
  getNonEvmNetworkImageSourceByChainId } from
...
import {
  ...
  selectMultichainAssetsRates } from
'../../../../../selectors/multichain/multichain';
///: END:ONLY_INCLUDE_IF(keyring-snaps)
import useEarnTokens from '../../../Earn/hooks/useEarnTokens';
import {
  selectPooledStakingEnabledFlag,
  selectStablecoinLendingEnabledFlag } from
'../../../Earn/selectors/featureFlags';
...
export const TokenListItem = React.memo(
  ({
    ...
    const evmAsset = useSelector((state) =>
    ...
    const nonEvmAsset = useSelector((state) =>
    ...
    const primaryCurrency = useSelector(
      (state) => state.settings.primaryCurrency
    );
    ...
    const exchangeRates = multiChainMarketData?.[chainId];
    const tokenBalances =
    ...
    const getPricePercentChange1d = () => {
      ...
      multiChainMarketData?.[chainId]?.[asset.address]?.
      ...
      ///: BEGIN:ONLY_INCLUDE_IF(keyring-snaps)
      return allMultichainAssetsRates[asset?.address]?.
    ...
    const networkBadgeSource = useCallback(
      (currentChainId) => {
        ...
        const defaultNetwork = getDefaultNetworkByChainId(currentChainId);
