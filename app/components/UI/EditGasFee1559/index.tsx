...
interface Props {
  selected?: string;
  gasFee: GasFee1559;
  gasOptions?: Record<string, GasFee1559>;
  onChange?: (gas: GasFee1559, selectedOption: string | null) => void;
  onCancel?: () => void;
...
const EditGasFee1559 = ({
  ...
  const changeGas = (gas: GasFee1559, option: string | null) => {
