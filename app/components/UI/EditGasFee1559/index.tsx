...
interface EditGasFee1559Props {
   ...
   */
  gasOptions?: Record<string, GasOptionValue>;
  /**
   * Function called when user selected or changed the gas
   */
  onChange?: (gas: GasFeeState, selectedOption: string | null) => void;
  /**
...
const EditGasFee1559 = ({
  ...
  const changeGas = (gas: GasFeeState, option: string | null) => {
    ...
    <View>
      ...
      >
        ...
        <View style={styles.advancedOptionsContainer}>
          <TouchableOpacity
            {...({ disable: updateOption?.showAdvanced } as object)}
    ...
    if (typeof warning === 'string')
      return (
        <Alert
          ...
          style={styles.warningContainer as StyleProp<ViewStyle>}
        >
          {() => (
