...
type GasOptionsMap = Record<string, GasFeeValues | undefined>;
...
const EditGasFee1559 = ({
  ...
  const toggleLearnMoreModal = () => {
    setShowLearnMoreModal((value) => !value);
  };
  ...
  const changeGas = (gas: GasFeeValues, option: string | null) => {
