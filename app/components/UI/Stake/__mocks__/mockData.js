...
export const MOCK_GET_POOLED_STAKES_API_RESPONSE = {
  accounts: [
  {
...
export const MOCK_GET_POOLED_STAKES_API_RESPONSE_HIGH_ASSETS_AMOUNT =
{
  accounts: [
  {
...
export const MOCK_GET_VAULT_RESPONSE = {
...
export const MOCK_POOL_STAKING_SDK = {
