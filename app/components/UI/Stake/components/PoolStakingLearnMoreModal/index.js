...
import {
  ...
  ButtonSize,
  ButtonVariants } from
'../../../../../component-library/components/Buttons/Button/Button.types';
...
import {
  formatChartDate,
  getGraphInsetsByDataPointLength } from
'./InteractiveTimespanChart/InteractiveTimespanChart.utils';
...
const PoolStakingLearnMoreModal = () => {
  ...
  const handleTimespanPressed = (numDataPointsToDisplay) => {
