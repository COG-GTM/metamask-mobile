...
interface NetworkInfo { color?: string; shortName?: string }
const networksByType = networkList as unknown as Record<string, NetworkInfo>;
...
const TransactionHeader = (props: TransactionHeaderProps) => {
  ...
  const renderNetworkStatusIndicator = () => {
    ...
    const networkStatusIndicatorColor =
      (networkType && networksByType[networkType]?.color) ||
  ...
  const renderNetworkContainer = () => (
    <View style={styles.networkContainer}>
      ...
      <Text style={styles.network}>
        {props.nickname ||
          (props.networkType && networksByType[props.networkType]?.shortName)}
      </Text>
    </View>
  );
