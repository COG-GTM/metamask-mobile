...
const mapStateToProps = (state: RootState) => ({
  ...
  collectibleContracts: multichainCollectibleContractsSelector(state) as Record<
    string,
    NftContract[]
  >,
  ...
  removeFavoriteCollectible: (
    ...
    dispatch(
      removeFavoriteCollectible(
        ...
        chainId,
        collectible as unknown as FavoriteCollectible,
      ),
    ),
});
  ...
  const renderEmpty = useCallback(
    () => (
      <View style={styles.emptyContainer}>
        ...
        <Text
          {...{ center: true, big: true, link: true }}
