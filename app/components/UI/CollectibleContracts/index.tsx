...
interface CollectibleContractType {
  address: string;
  name?: string;
  chainId?: string;
  [key: string]: unknown;
...
interface Props {
  ...
  collectibleContracts: Record<string, CollectibleContractType[]>;
  /** Array of collectibles objects */
  collectibles: Record<string, CollectibleType[]>;
  ...
  favoriteCollectibles?: CollectibleType[];
