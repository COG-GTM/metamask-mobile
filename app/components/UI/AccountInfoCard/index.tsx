...
const AccountInfoCard = ({
  ...
  const fromAddress = safeToChecksumAddress(rawFromAddress) as Hex;
  ...
  const actualOriginUrl =
    isOriginUrl && origin ? origin : originatorInfo?.url ?? strings('sdk.unknown');

  return operation === 'signing' && transaction !== undefined ? (
    // @ts-expect-error - ApproveTransactionHeader requires `asset`, which this legacy call site has never passed
