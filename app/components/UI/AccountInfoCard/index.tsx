...
interface AccountInfoCardStateProps {
  /**
...
type AccountInfoCardProps = AccountInfoCardStateProps &
  AccountInfoCardOwnProps;
  ...
  render() {
    ...
    return operation === 'signing' && transaction !== undefined ? (
      <ApproveTransactionHeader
        ...
        asset={undefined as unknown as ApproveTransactionHeaderI['asset']}
      />
    ) : (
