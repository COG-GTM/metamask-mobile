    ...
    () =>
      PanResponder.create({
        ...
        onPanResponderMove: (ev, gestureState) => {
          ...
          const interpolated = pan.interpolate({
            inputRange: [0, trackWidth],
            outputRange: [0, trackWidth],
            extrapolate: 'clamp',
          });
          const relativeValue = (
            interpolated as unknown as { __getValue: () => number }
          ).__getValue();
        ...
        onPanResponderRelease: () => {
          pan.flattenOffset();
          const panValue = (pan as unknown as { _value: number })._value;
          const relativeValue = Math.min(Math.max(0, panValue), trackWidth);
