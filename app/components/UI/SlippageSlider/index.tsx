...
/**
 * `Animated.Value` and interpolations expose their current value only through
 * private members.
 */
type AnimatedValueWithCurrent = Animated.Value & { _value: number };
interface AnimatedInterpolationWithCurrent {
  __getValue(): number;
}
    ...
    () =>
      PanResponder.create({
        ...
        onPanResponderGrant: () => {
          ...
          pan.setOffset((pan as AnimatedValueWithCurrent)._value);
        },
        /**
        ...
        onPanResponderMove: (_ev, gestureState) => {
          ...
          const relativeValue = (
            pan.interpolate({
              ...
              extrapolate: 'clamp',
            }) as unknown as AnimatedInterpolationWithCurrent
          ).__getValue();
        ...
        onPanResponderRelease: () => {
          ...
          const relativeValue = Math.min(
            Math.max(0, (pan as AnimatedValueWithCurrent)._value),
            trackWidth,
          );
