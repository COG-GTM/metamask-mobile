...
/* `_value` and `__getValue` are internal Animated APIs without public types */
...
const readInterpolatedValue = (
  interpolation: Animated.AnimatedInterpolation<number | string>,
  ...
  useEffect(() => {
    if (!isResponderGranted) {
      const relativePercent =
        (((value as number) - r0) / fullRange) * trackWidth;
    ...
    >
      ...
      >
        ...
        <Text style={styles.tooltipText}>
          {formatTooltipText(displayValue as number)}
        </Text>
      </Animated.View>
      <Animated.View
