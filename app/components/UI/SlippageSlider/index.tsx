...
/**
 * `_value` is an internal property of Animated.Value that is read to get the
 * current value synchronously, as done in the original implementation.
 */
const getAnimatedRawValue = (animatedValue: Animated.Value) =>
    ...
    () =>
      PanResponder.create({
        ...
        onPanResponderGrant: () => {
          ...
          pan.setOffset(getAnimatedRawValue(pan));
        },
        /**
        ...
        onPanResponderRelease: () => {
          ...
          const relativeValue = Math.min(
            Math.max(0, getAnimatedRawValue(pan)),
            trackWidth,
          );
    ...
    >
      ...
      >
        <View style={styles.trackBack}>
          {new Array(ticksLength + 1).fill(null).map((_, i: number) => (
