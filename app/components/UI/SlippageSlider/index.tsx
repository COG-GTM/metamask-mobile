...
const getAnimatedInterpolationValue = (animatedValue: unknown): number =>
  (animatedValue as { __getValue: () => number }).__getValue();
    ...
    () =>
      PanResponder.create({
        ...
        onPanResponderMove: (
          ...
          const relativeValue = getAnimatedInterpolationValue(
            pan.interpolate({
              inputRange: [0, trackWidth],
