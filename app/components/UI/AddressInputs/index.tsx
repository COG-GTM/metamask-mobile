...
/** Legacy call sites pass colour flags that the design-system Text ignores. */
const Text = BaseText as unknown as React.FC<
  React.ComponentProps<typeof BaseText> & { red?: boolean; black?: boolean }
>;

/** The wrapper is typed for a single child, but these screens nest several. */
const AddressBookWrapper = AddToAddressBookWrapper as unknown as React.FC<
  Omit<React.ComponentProps<typeof AddToAddressBookWrapper>, 'children'> & {
  ...
  if (isConfirmScreen) {
    ...
    return (
      <View style={wrapperStyles}>
        ...
        >
          <AddressBookWrapper address={toSelectedAddress as string}>
                ...
                <View style={[styles.address, styles.checkAddress]}>
                  ...
                  <View style={styles.addressWrapper}>
                    <Text
                      ...
                      numberOfLines={1}
                    >
                      {renderShortAddress(toSelectedAddress as string)}
                    </Text>
                    <View
                      style={
        ...
        >
          <View style={styles.input}>
            <TextInput
              ...
              style={[
                styles.textInput,
                inputWidth as unknown as StyleProp<TextStyle>,
              ]}
              numberOfLines={1}
              ...
              onBlur={onInputBlur}
              onSubmitEditing={
                    onSubmit as unknown as TextInputProps['onSubmitEditing']
                  }
    ...
    <View style={styles.wrapper}>
      ...
      >
        <View style={styles.identiconWrapper}>
          <Identicon
            address={fromAccountAddress ?? undefined}
            diameter={30}
          />
        </View>
