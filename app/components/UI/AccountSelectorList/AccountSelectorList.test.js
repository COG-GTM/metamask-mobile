...
const setAccountsMock = (mockAccounts, mockEnsByAccountAddress = {}) => {
  const mockAccountData = {
    accounts: mockAccounts,
    evmAccounts: [],
    ensByAccountAddress: mockEnsByAccountAddress
  };
  useAccounts.mockImplementation(() => mockAccountData);
...
describe('AccountSelectorList', () => {
  beforeEach(() => {
    ...
    Engine.context.KeyringController.removeAccount.mockClear();
  });
  ...
  it('renders in select-without-menu mode', async () => {
    const AccountSelectorListSelectWithoutMenuTest = () => {
      const { accounts, ensByAccountAddress } = useAccounts();
      return (
        <AccountSelectorList
          onSelectAccount={onSelectAccount}
  ...
  it('disables account selection when isSelectionDisabled is true', async () => {
    ...
    const AccountSelectorListDisabledSelectionTest = () => {
      const { accounts, ensByAccountAddress } = useAccounts();
      return (
        <AccountSelectorList
          onSelectAccount={onSelectAccount}
  ...
  it('should not allow account removal when long-pressed for HD Key Tree account type', async () => {
    ...
    useAccounts.mockImplementationOnce(() => ({
      accounts: [
      {
        name: 'Account 1',
        address: BUSINESS_ACCOUNT,
  ...
  it('should not allow account removal when isRemoveAccountEnabled is false', async () => {
    ...
    const AccountSelectorListNoRemoveTest = () => {
      const { accounts, ensByAccountAddress } = useAccounts();
      return (
        <AccountSelectorList
          onSelectAccount={onSelectAccount}
  ...
  it('should not auto-scroll when isAutoScrollEnabled is false', async () => {
    ...
    const AccountSelectorListNoAutoScrollTest = () => {
      const { accounts, ensByAccountAddress } = useAccounts();
      return (
        <AccountSelectorList
          onSelectAccount={onSelectAccount}
