...
import { Colors, Shadows, Theme } from '../../../util/theme/models';
import TabThumbnail from './TabThumbnail';
import { TabThumbnailProps } from './TabThumbnail/TabThumbnail.types';

type TabData = TabThumbnailProps['tab'];
...
const ThumbnailComponent = TabThumbnail as ComponentType<
  TabThumbnailProps & { ref?: React.Ref<unknown> }
>;
...
class Tabs extends PureComponent<TabsProps, TabsState> {
  ...
  renderTabs(tabs: TabData[], activeTab: number) {
    const styles = this.getStyles();
