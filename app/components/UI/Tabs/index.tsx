...
const createStyles = (colors: Colors, shadows: Record<string, any>) =>
  StyleSheet.create({
    noTabs: {
      flex: 1,
      alignItems: 'center',
...
interface Props {
  ...
  closeAllTabs: () => void;
  closeTabsView: () => void;
  switchToTab: (tab: TabItem) => void;
  animateCurrentTab?: (tab: TabItem) => void;
  metrics: {
...
export default withMetricsAwareness(Tabs as any) as any;
