 ...
 */
interface AddCustomTokenOwnProps {
  /**
  ...
  /**
   * Label used by the parent scrollable tab view
   */
  tabLabel?: string;
}

type AddCustomTokenProps = AddCustomTokenOwnProps & IWithMetricsAwarenessProps;
...
> {
  ...
  render = () => {
    ...
    const { title, url } = getBlockExplorerAddressUrl(
      this.props.type as Parameters<typeof getBlockExplorerAddressUrl>[0],
      this.state.address,
    );
            ...
            >
              ...
              <View style={styles.overlappingAvatarsContainer}>
                ...
                <ButtonIcon
                  ...
                  style={
                    (styles as { buttonIcon?: StyleProp<ViewStyle> }).buttonIcon
                  }
                />
              </View>
            </TouchableOpacity>
...
) as unknown as ComponentType<Partial<AddCustomTokenOwnProps>>;
