...
> {
  ...
  assetSymbolInput: RefObject<TextInput> = React.createRef();
  assetPrecisionInput: RefObject<TextInput> = React.createRef();
            ...
            >
              ...
              <View style={styles.overlappingAvatarsContainer}>
                ...
                <ButtonIcon
                  ...
                  style={
                    (styles as unknown as Record<string, undefined>).buttonIcon
                  }
                />
              </View>
            </TouchableOpacity>
