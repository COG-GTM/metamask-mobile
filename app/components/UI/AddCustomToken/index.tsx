...
interface Props {
  ...
  ticker: string;
  type: string;
  navigation: { navigate: (...args: unknown[]) => void; setOptions: (options: Record<string, any>) => void; goBack: () => void; push: (...args: unknown[]) => void };
...
class AddCustomToken extends PureComponent<any, any> {
  state: State = {
    address: '',
    symbol: '',
    decimals: '',
