...
> {
  ...
  addToken = async () => {
    ...
    await TokensController.addToken({
      address,
      symbol,
      // TODO: `decimals` is held as a string in state but the controller expects a number
      decimals: decimals as unknown as number,
      name,
      // TODO: `addToken` takes no `chainId`; it is derived from `networkClientId`
            ...
            >
              ...
              <View style={styles.overlappingAvatarsContainer}>
                ...
                <ButtonIcon
                  ...
                  // TODO: `createStyles` defines no `buttonIcon`
                  // @ts-expect-error preserving existing behaviour
              ...
              {this.state.warningDecimals ? (
                ...
                >
                  ...
                  >
                    {title}{' '}
                    <Icon
                      // TODO: `Icon` takes a ViewStyle; `link` is a text colour
                      // @ts-expect-error preserving existing behaviour
                      style={styles.link}
                      size={IconSize.Xss}
