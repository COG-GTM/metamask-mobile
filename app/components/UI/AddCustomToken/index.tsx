...
interface AddCustomTokenProps {
   ...
   */
  setOpenNetworkSelector: (...args: unknown[]) => void;
  /**
...
class AddCustomToken extends PureComponent<AddCustomTokenProps> {
  state = {
    address: '',
    symbol: '',
    decimals: '',
            ...
            >
              ...
              <View style={styles.overlappingAvatarsContainer}>
                ...
                <ButtonIcon
                  ...
                  style={
                    (styles as unknown as Record<string, ViewStyle>).buttonIcon
                  }
                />
              </View>
            </TouchableOpacity>
