  ...
  getTokenAddedAnalyticsParams = () => {
    try {
      ...
      return {
        ...
        token_symbol: symbol,
        chain_id: getDecimalChainId(chainId as Hex),
        source: 'Custom token',
      };
    } catch (error) {
      Logger.error(
            ...
            >
              ...
              <View style={styles.overlappingAvatarsContainer}>
                ...
                <ButtonIcon
                  ...
                  style={(styles as Record<string, ViewStyle>).buttonIcon}
                />
              </View>
            </TouchableOpacity>
              ...
              {this.state.warningDecimals ? (
                ...
                >
                  ...
                  >
                    {title}{' '}
                    <Icon
                      style={styles.link as unknown as ViewStyle}
                      size={IconSize.Xss}
