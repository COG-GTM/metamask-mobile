...
interface AddCustomTokenProps {
  ...
  ticker: string;
  type: string;
  navigation: { navigate: (route: string, params?: Record<string, unknown>) => void; goBack: () => void; push: (route: string, params?: Record<string, unknown>) => void; setOptions: (options: Record<string, unknown>) => void };
