    ...
    trackEvent(
      MetricsEventBuilder.createEventBuilder(MetaMetricsEvents.SEND_FLOW_CANCEL)
        .addProperties({
          ...
          ...(additionalTransactionMetricsParams as JsonMap),
        })
        .build(),
    );
    resetTransaction();
...
export function getWalletNavbarOptions(
  ...
  selectedInternalAccount: Parameters<
    ...
    headerTitle: () => (
      <View style={innerStyles.headerTitle}>
        <PickerAccount
          ...
          showAddress
          cellAccountContainerStyle={undefined}
                ...
                style={[
                  styles.notificationsBadge,
                  {
                    backgroundColor: unreadNotificationCount
                      ...
                      : (themeColors.background as Record<string, ColorValue>)
                          .transparent,
                  },
                ]}
              />
...
export function getImportTokenNavbarOptions(
  ...
  const innerStyles = StyleSheet.create({
    ...
    headerShadow: {
      elevation: 2,
      shadowColor: (themeColors.background as Record<string, ColorValue>)
        .primary,
...
export function getWebviewNavbar(
  ...
  const innerStyles = StyleSheet.create({
    ...
    headerIcon: {
      color: (themeColors as unknown as Record<string, ColorValue>).default,
    },
  });
    ...
    headerLeft: () => {
      ...
      return Device.isAndroid() ? (
        <TouchableOpacity
          ...
          accessible
        >
          <IonicIcon name={'arrow-back'} size={24} style={undefined} />
        </TouchableOpacity>
      ) : (
        <TouchableOpacity
          onPress={leftAction}
