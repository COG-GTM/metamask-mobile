...
import {
  ...
  TouchableOpacity,
  View,
 ImageSourcePropType, ViewStyle } from 'react-native';
...
/** Minimal navigation surface used by the navbar option factories. */
...
/** Trade information passed through swaps navigation params. */
interface RequestedTrade {
  token_from?: string;
  token_to?: string;
  request_type?: string;
...
interface NavbarMetricsEvent {
  event: IMetaMetricsEvent;
  properties?: Record<string, unknown>;
}

interface NavbarMetricsOptions {
  backButtonEvent?: NavbarMetricsEvent;
  cancelButtonEvent?: NavbarMetricsEvent;
  iconButtonEvent?: NavbarMetricsEvent;
}
...
/** Route params consumed by the navbar option factories. */
 ...
 */
export function getEditableOptions(title: string, navigation: NavbarNavigation, route: NavbarRoute, themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerTitleStyle: {
      fontSize: 20,
 ...
 */
export function getPaymentRequestSuccessOptionsTitle(navigation: NavbarNavigation, themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerStyle: {
      backgroundColor: themeColors.background.default,
      shadowColor: importedColors.transparent,
 ...
 * @returns {Object} - Corresponding navbar options containing headerTitle
 */
export function getTransparentOnboardingNavbarOptions(themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerStyle: {
      backgroundColor: themeColors.background.default,
      shadowColor: importedColors.transparent,
 ...
 */
export function getTransparentBackOnboardingNavbarOptions(themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerStyle: {
      backgroundColor: themeColors.background.default,
      shadowColor: importedColors.transparent,
 ...
 */
export function getOptinMetricsNavbarOptions(themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerStyle: {
      backgroundColor: themeColors.background.default,
      shadowColor: importedColors.transparent,
...
export function getWalletNavbarOptions(
  accountActionsRef: React.RefObject<{ current?: { onOpenBottomSheet?: () => void } }>,
  ...
  const onScanSuccess = (data: { private_key?: string; seed?: string }, content: string) => {
    if (data.private_key) {
      Alert.alert(
  ...
  return {
    headerTitle: () => (
      <View style={innerStyles.headerTitle}>
        <PickerAccount
          ref={accountActionsRef as unknown as React.Ref<never>}
          ...
          cellAccountContainerStyle={
            (styles as Record<string, ViewStyle>).account
          }
        ...
        {isNotificationsFeatureEnabled() && (
          <View>
            ...
            <ButtonIcon
              ...
              style={(styles as Record<string, ViewStyle>).notificationButton}
            />
                ...
                style={[
                  styles.notificationsBadge,
                  {
                    backgroundColor: unreadNotificationCount
                      ...
                      : (themeColors.background as unknown as Record<
                          string,
                          string
                        >).transparent,
                  },
...
export function getImportTokenNavbarOptions(
  ...
  const innerStyles = StyleSheet.create({
    ...
    headerShadow: {
      elevation: 2,
      shadowColor: (
        themeColors.background as unknown as Record<string, string>
      ).primary,
    ...
    headerLeft: () => (
      ...
      >
        <Icon
          ...
          size={IconSize.Lg}
          style={innerStyles.headerBackIcon as unknown as ViewStyle}
        />
      </TouchableOpacity>
    ),
 ...
 * @returns {Object} - Corresponding navbar options containing headerTitle and headerTitle
 */
export function getWebviewNavbar(navigation: NavbarNavigation, route: NavbarRoute, themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerTitleStyle: {
      fontSize: 20,
      color: themeColors.text.default,
    ...
    headerIcon: {
      color: (themeColors as unknown as Record<string, string>).default,
    },
  });
...
export function getPaymentSelectorMethodNavbar(navigation: NavbarNavigation, onPop: () => void, themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerButtonText: {
      color: themeColors.primary.default,
    },
...
export function getTransakWebviewNavbar(navigation: NavbarNavigation, route: NavbarRoute, onPop: () => void, themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerTitleStyle: {
      fontSize: 20,
      color: themeColors.text.default,
...
export function getSwapsAmountNavbar(navigation: NavbarNavigation, route: NavbarRoute, themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerButtonText: {
      color: themeColors.primary.default,
      fontSize: 14,
...
export function getSwapsQuotesNavbar(navigation: NavbarNavigation, route: NavbarRoute, themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerButtonText: {
      color: themeColors.primary.default,
      fontSize: 14,
      ...
      trackEvent(
        MetricsEventBuilder.createEventBuilder(
          ...
          .addProperties({
            ...
            responseTime: new Date().getTime() - (quoteBegin as number),
          })
...
export function getBridgeNavbar(navigation: NavbarNavigation, route: NavbarRoute, themeColors: ThemeColors) {
  const innerStyles = StyleSheet.create({
    headerButtonText: {
      color: themeColors.primary.default,
      fontSize: 14,
...
export function getBridgeTransactionDetailsNavbar(navigation: NavbarNavigation) {
  const leftAction = () => navigation.pop?.();
      ...
      return Device.isAndroid() ? (
        ...
        >
          <IonicIcon
            ...
            size={24}
            style={
              (innerStyles as Record<string, ViewStyle>).headerIcon
            }
          />
        </TouchableOpacity>
      ) : (
...
export const getEditAccountNameNavBarOptions = (goBack: () => void, themeColors: ThemeColors) => {
  const innerStyles = StyleSheet.create({
    headerStyle: {
      backgroundColor: themeColors.background.default,
      shadowColor: importedColors.transparent,
...
export const getSettingsNavigationOptions = (title: string, themeColors: ThemeColors) => {
  const innerStyles = StyleSheet.create({
    headerStyle: {
      backgroundColor: themeColors.background.default,
      shadowColor: importedColors.transparent,
...
export function getStakingNavbar(
  ...
  metricsOptions?: NavbarMetricsOptions,
) {
  const {
    hasBackButton = true,
  ...
  function handleBackPress() {
    if (metricsOptions?.backButtonEvent) {
      withMetaMetrics(navigationPop, {
        ...
        properties: metricsOptions.backButtonEvent.properties as JsonMap,
      })();
    } else {
      navigationPop();
    }
  ...
  function handleCancelPress() {
    if (metricsOptions?.cancelButtonEvent) {
      withMetaMetrics(navigationPop, {
        ...
        properties: metricsOptions.cancelButtonEvent.properties as JsonMap,
      })();
    } else {
      navigationPop();
    }
  ...
  function handleIconPressWrapper() {
    ...
    if (metricsOptions?.iconButtonEvent) {
      withMetaMetrics(handleIconPress, {
        ...
        properties: metricsOptions.iconButtonEvent.properties as JsonMap,
      })();
    } else {
      handleIconPress();
    }
