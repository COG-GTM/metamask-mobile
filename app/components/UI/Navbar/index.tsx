...
// Route params differ for every screen consuming these navbar helpers
...
export function getOnboardingNavbarOptions(
  ...
  { headerLeft }: { headerLeft?: ReactNode } = {},
  themeColors: ThemeColors,
) {
...
export function getWalletNavbarOptions(
  ...
  const onScanSuccess = (data: NavigationParams, content?: string) => {
    if (data.private_key) {
      Alert.alert(
      ...
      <View style={innerStyles.headerTitle}>
        <PickerAccount
          ...
          cellAccountContainerStyle={
            (styles as { account?: ViewStyle }).account
          }
        ...
        {isNotificationsFeatureEnabled() && (
          <View>
            ...
            <ButtonIcon
              ...
              style={
                (styles as { notificationButton?: StyleProp<ViewStyle> })
                  .notificationButton
              }
            />
      ...
      return Device.isAndroid() ? (
        ...
        >
          <IonicIcon
            ...
            size={24}
            style={
              (innerStyles as { headerIcon?: StyleProp<TextStyle> }).headerIcon
            }
          />
        </TouchableOpacity>
      ) : (
