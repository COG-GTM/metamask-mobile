...
function CollectibleContractElement({
  ...
  const actionSheetRef = useRef<ActionSheetInstance>();
    ...
    (collectible: Collectible, index: number) => {
      ...
      return (
        <View
          ...
          {...({ styles: styles.collectibleBox } as object)}
    ...
    <View style={styles.itemWrapper}>
      ...
      >
        ...
        <View style={styles.collectibleContractIconContainer}>
          {!asset.favorites ? (
            <CollectibleMedia
              {...({ iconStyle: styles.collectibleContractIcon } as object)}
              collectible={
                {
                  name: strings('collectible.untitled_collection'),
                  ...asset,
                  image: asset.logo,
                } as React.ComponentProps<typeof CollectibleMedia>['collectible']
              }
              tiny
            />
          ) : (
      ...
      {collectiblesVisible && (
        <View style={(styles as { grid?: ViewStyle }).grid}>
