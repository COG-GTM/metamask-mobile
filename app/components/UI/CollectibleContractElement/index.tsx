...
import CollectibleMediaBase from '../CollectibleMedia';
...
type Collectible = Partial<Nft> & { logo?: string };

type CollectibleContract = Partial<NftContract> & {
  favorites?: boolean;
  logo?: string;
};

// `iconStyle` is a legacy prop still honoured by CollectibleMedia at runtime
const CollectibleMedia = CollectibleMediaBase as unknown as ComponentType<
  React.ComponentProps<typeof CollectibleMediaBase> & {
...
interface CollectibleContractElementProps
  extends CollectibleContractElementOwnProps {
  /**
   * Selected address
   */
...
) as unknown as ComponentType<CollectibleContractElementOwnProps>;
