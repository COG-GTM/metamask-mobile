...
class PaymentRequestSuccess extends PureComponent<PaymentRequestSuccessProps> {
  ...
  updateNavBar = () => {
    ...
    const colors =
      (this.context as unknown as AppTheme)?.colors || mockTheme.colors;
    navigation.setOptions(
      getPaymentRequestSuccessOptionsTitle(
        navigation as unknown as Parameters<
          typeof getPaymentRequestSuccessOptionsTitle
        >[0],
        colors,
      ),
    );
  ...
  render() {
    ...
    const theme = (this.context as unknown as AppTheme) || mockTheme;
...
type PaymentRequestSuccessOwnProps = Pick<
...
export default connect(
  ...
  PaymentRequestSuccess as unknown as React.ComponentType,
) as unknown as React.ComponentType<PaymentRequestSuccessOwnProps>;
