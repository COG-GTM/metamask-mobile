...
interface TransactionNotificationColors {
...
const createStyles = (colors: TransactionNotificationColors) =>
  StyleSheet.create({
    absoluteFill: {
...
interface CurrentNotificationInfo {
  status: string;
...
interface TransactionNotificationProps {
  ...
  notificationAnimated: { value: number };
  onClose: () => void;
  animatedTimingStart: (animatedRef: { value: number }, toValue: number) => void;
  currentNotification: CurrentNotificationInfo;
...
function TransactionNotification(props: TransactionNotificationProps) {
  ...
  const [transactionElement, setTransactionElement] = useState<{ notificationKey?: string; actionKey?: string } | undefined>(undefined);
  const [tx, setTx] = useState<TransactionRecord>({} as TransactionRecord);
...
const mapStateToProps = (state: TransactionNotificationState) => {
