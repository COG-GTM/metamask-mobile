...
import TransactionDetails, {
  TransactionDetailsOwnProps,
} from '../../TransactionElement/TransactionDetails';
import { Hex } from '@metamask/utils';
import BaseNotification, { NotificationData } from './../BaseNotification';
import { AnimatedTimingStart, CurrentNotification } from '../index';
...
const validateTransactionActionBalance =
  validateTransactionActionBalanceBase as unknown as (
    transaction: Partial<DecodedTransaction> | undefined,
    rate: number,
...
interface TransactionNotificationProps
  extends Omit<DecodeTransactionArgs, 'tx'> {
...
function TransactionNotification(props: TransactionNotificationProps) {
  ...
  >(undefined);
  const [tx, setTx] = useState<Partial<DecodedTransaction>>({});
        ...
        <View style={styles.modalsContainer}>
          <View style={[styles.modalOverlay]}>
            <View style={styles.modalContainer}>
              ...
              <TransactionDetails
                transactionObject={
                  tx as TransactionDetailsOwnProps['transactionObject']
                }
                transactionDetails={
                  transactionDetails as TransactionDetailsOwnProps['transactionDetails']
                }
    ...
    swapsTransactions:
      (
        TransactionController as typeof TransactionController & {
          swapsTransactions?: TransactionNotificationProps['swapsTransactions'];
        }
      ).swapsTransactions || {},
    swapsTokens:
      SwapsController.tokens as TransactionNotificationProps['swapsTokens'],
    smartTransactions,
  };
};
