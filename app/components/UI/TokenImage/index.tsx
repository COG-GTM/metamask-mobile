...
interface TokenImageStateProps {
  tokenList?: Record<string, TokenListEntry>;
}

type TokenImageProps = TokenImageOwnProps & TokenImageStateProps;
...
const mapStateToProps = (state: Record<string, unknown>): TokenImageStateProps => ({
