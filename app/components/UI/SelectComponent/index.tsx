...
// dismissKeyboard is an internal React Native module without type declarations.
...
interface SelectOption {
  // Options come from a variety of call sites with heterogeneous shapes.
...
> {
  ...
  showPicker = () => {
    ...
    Device.isIos() &&
      ...
      this.props.options.forEach((item: SelectOption, i: number) => {
  ...
  getSelectedValue = () => {
    ...
    const el = options?.filter(
      (o: SelectOption) => o.value === selectedValue,
    );
