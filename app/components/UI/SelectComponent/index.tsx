...
interface SelectComponentProps<TOption extends SelectOption> {
  /**
...
> extends PureComponent<SelectComponentProps<TOption>, SelectComponentState> {
  ...
  onValueChange = (val?: SelectOptionValue) => {
