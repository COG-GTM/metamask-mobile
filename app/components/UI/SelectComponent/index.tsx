...
// @ts-expect-error - dismissKeyboard is a React Native internal module without type declarations
...
const SelectComponent = ({
  ...
  return <View style={baseStyles.flexGrow}>{renderDropdownSelector()}</View>;
};
