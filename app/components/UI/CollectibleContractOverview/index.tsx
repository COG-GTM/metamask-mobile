...
class CollectibleContractOverview extends PureComponent<Props> {
  ...
  onSend = () => {
    ...
    this.props.newAssetTransaction(collectible as Nft);
    ...
    const leftActionButtonText =
      lowerAddress in collectiblesTransferInformation
        ? collectiblesTransferInformation[
            lowerAddress as keyof typeof collectiblesTransferInformation
          ].tradable && strings('asset_overview.send_button')
