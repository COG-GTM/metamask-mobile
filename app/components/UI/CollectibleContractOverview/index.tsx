...
export type CollectibleContractSummary = Omit<NftContract, 'totalSupply'> & {
  totalSupply?: string | number;
};

export type CollectibleContractNavigation = Pick<
  StackNavigationProp<ParamListBase>,
  'navigate' | 'push'
>;

export interface CollectibleContractOverviewProps {
  /**
   ...
   */
  newAssetTransaction: (selectedAsset: Nft | undefined) => void;
}
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  newAssetTransaction: (selectedAsset: Nft | undefined) =>
    dispatch(newAssetTransaction(selectedAsset as SelectedAsset)),
});
