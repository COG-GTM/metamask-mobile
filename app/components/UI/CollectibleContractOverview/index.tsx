 ...
 */
interface CollectibleContractShape {
  name?: string;
  symbol?: string;
  description?: string;
...
interface CollectibleContractOverviewProps {
   ...
   */
  collectibleContract: CollectibleContractShape;
  /**
   * Array of ERC721 assets
   */
  collectibles: CollectibleShape[];
  /**
   ...
   */
  newAssetTransaction: (selectedAsset: CollectibleShape) => void;
}
...
class CollectibleContractOverview extends PureComponent<CollectibleContractOverviewProps> {
  ...
  onSend = () => {
    ...
    this.props.newAssetTransaction(collectible as CollectibleShape);
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  newAssetTransaction: (selectedAsset: CollectibleShape) =>
...
type CollectibleContractOverviewOwnProps = Omit<
  ...
  'collectibles' | 'toggleCollectibleContractModal' | 'newAssetTransaction'
>;
...
export default connect(
  ...
  CollectibleContractOverview as unknown as React.ComponentType,
) as unknown as React.ComponentType<CollectibleContractOverviewOwnProps>;
