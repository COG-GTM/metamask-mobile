...
class CollectibleContractOverview extends PureComponent<CollectibleContractOverviewProps> {
  ...
  onSend = () => {
    ...
    const collectible = collectibles.find((ownedCollectible) =>
      toLowerCaseEquals(ownedCollectible.address, collectibleContract.address),
    );
      ...
      lowerAddress in collectiblesTransferInformation
        ? (
            collectiblesTransferInformation as Record<
              ...
              { tradable: boolean }
            >
          )[lowerAddress].tradable && strings('asset_overview.send_button')
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  newAssetTransaction: (selectedAsset?: Collectible) =>
    dispatch(newAssetTransaction(selectedAsset as Collectible)),
});
