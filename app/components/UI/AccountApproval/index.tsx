...
export interface AccountApprovalPageInformation {
  ...
  otps?: number[];
  channelId?: string;
  analytics?: Record<string, unknown> & { source?: string };
}

export interface AccountApprovalProps extends IWithMetricsAwarenessProps {
  /**
...
> {
  ...
  render = () => {
    ...
    const { colors, typography } =
      (this.context as unknown as Theme | undefined) || mockTheme;
