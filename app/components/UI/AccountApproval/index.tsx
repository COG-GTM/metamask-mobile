...
interface AccountApprovalProps
  extends AccountApprovalOwnProps,
...
> {
  ...
  state: AccountApprovalState = {
    ...
    otpChoice: undefined,
    noPersist: false,
    otps: shuffle(this.props.currentPageInformation.otps || []) as string[],
    otp:
  ...
  onConfirm = () => {
    if (
      ...
      // Legacy positional call signature preserved from the JS implementation
      (
        SDKConnect.getInstance() as unknown as {
    ...
    return (
      ...
      >
        ...
        <View style={styles.actionContainer}>
          ...
          <StyledButton
            disabled={Boolean(this.state.otp) && this.state.confirmDisabled}
            type={'confirm'}
...
) as unknown as ComponentType<Partial<AccountApprovalOwnProps>>;
