...
> {
  ...
  onConfirm = () => {
    if (
      ...
      )(this.props.currentPageInformation.channelId as string, true);
      ...
      >
        ...
        {this.state.otp && (
          <View style={styles.otpContainer}>
            {this.state.otps.map((otpValue: string, index: number) => (
              <TouchableOpacity
                key={`otp${index}`}
                style={[
        ...
        <View style={styles.actionContainer}>
          ...
          <StyledButton
            disabled={(this.state.otp && this.state.confirmDisabled) as boolean}
            type={'confirm'}
