 ...
 */
interface AnimatedTransactionModal {
  context: Theme;
}
...
> {
  ...
  render = () => {
    ...
    let gasTransformStyle: ViewStyle;
    let modalTransformStyle: ViewStyle;
    let gasComponent: React.ReactElement<Record<string, unknown>>;
