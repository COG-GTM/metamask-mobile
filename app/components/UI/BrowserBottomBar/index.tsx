...
interface BrowserBottomBarOwnProps {
  /**
...
type BrowserBottomBarProps = BrowserBottomBarOwnProps &
...
export default withMetricsAwareness(
  BrowserBottomBar as unknown as ComponentType<IWithMetricsAwarenessProps>,
) as unknown as ComponentType<Partial<BrowserBottomBarOwnProps>>;
