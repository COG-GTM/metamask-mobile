...
interface NavbarBrowserTitleOwnProps {
   ...
   */
  route?: RouteProp<{ params?: { showUrlModal?: () => void } }, 'params'>;
}

interface NavbarBrowserTitleProps extends NavbarBrowserTitleOwnProps {
  /**
...
export default connect(mapStateToProps)(
  NavbarBrowserTitle,
) as unknown as ComponentType<NavbarBrowserTitleOwnProps>;
