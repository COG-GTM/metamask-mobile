 ...
 */
interface NavbarBrowserTitleRouteParams extends ParamListBase {
  params: {
    showUrlModal?: () => void;
  };
}
...
interface NavbarBrowserTitleProps {
   ...
   */
  route: RouteProp<NavbarBrowserTitleRouteParams, 'params'>;
}
...
class NavbarBrowserTitle extends PureComponent<NavbarBrowserTitleProps> {
  ...
  getNetworkName(providerConfig: ProviderConfig) {
    ...
    if (providerConfig) {
      if (providerConfig.nickname) {
        ...
        const currentNetwork = TypedNetworks[providerConfig.type];
  ...
  render = () => {
    ...
    const color = TypedNetworks[providerConfig.type]?.color || null;
