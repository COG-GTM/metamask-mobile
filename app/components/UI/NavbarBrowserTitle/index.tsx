...
interface NavbarBrowserTitleRouteParams {
  showUrlModal?: () => void;
}
...
interface NavbarBrowserTitleProps {
   ...
   */
  route?: { params?: NavbarBrowserTitleRouteParams };
}
...
class NavbarBrowserTitle extends PureComponent<NavbarBrowserTitleProps> {
  ...
  getNetworkName(providerConfig: ProviderConfig) {
    ...
    if (providerConfig) {
      if (providerConfig.nickname) {
        ...
        const currentNetwork = getNetworkInfo(providerConfig.type);
  ...
  render = () => {
    ...
    const color = getNetworkInfo(providerConfig.type)?.color || null;
