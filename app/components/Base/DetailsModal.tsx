...
interface DetailsModalSectionProps extends DetailsModalStyleProps {
  borderBottom?: boolean;
}

interface DetailsModalColumnProps extends DetailsModalStyleProps {
  end?: boolean;
}

interface DetailsModalCloseIconProps extends DetailsModalStyleProps {
  onPress?: () => void;
}

type DetailsModalComponent = React.FC<DetailsModalProps> & {
  Header: React.FC<DetailsModalStyleProps>;
  Title: React.FC<DetailsModalStyleProps>;
  CloseIcon: React.FC<DetailsModalCloseIconProps>;
  Body: React.FC<DetailsModalStyleProps>;
  Section: React.FC<DetailsModalSectionProps>;
  SectionTitle: React.FC<DetailsModalStyleProps>;
...
const DetailsModalHeader: React.FC<DetailsModalStyleProps> = ({ style, ...props }) => {
  const { colors } = useTheme();
  const styles = createStyles(colors);
...
const DetailsModalTitle: React.FC<DetailsModalStyleProps> = ({ style, ...props }) => {
  const { colors } = useTheme();
  const styles = createStyles(colors);
...
const DetailsModalBody: React.FC<DetailsModalStyleProps> = ({ style, ...props }) => {
  const { colors } = useTheme();
  const styles = createStyles(colors);
...
const DetailsModalSectionTitle: React.FC<DetailsModalStyleProps> = ({ style, ...props }) => {
  const { colors } = useTheme();
  const styles = createStyles(colors);
