...
const DetailsModalTitle = ({ style, ...props }: DetailsModalTextProps) => {
  const { colors } = useTheme();
  const styles = createStyles(colors);
...
const DetailsModalCompound = DetailsModal as typeof DetailsModal & {
...
DetailsModalCompound.Header = DetailsModalHeader;
DetailsModalCompound.Title = DetailsModalTitle;
DetailsModalCompound.CloseIcon = DetailsModalCloseIcon;
DetailsModalCompound.Body = DetailsModalBody;
DetailsModalCompound.Section = DetailsModalSection;
DetailsModalCompound.SectionTitle = DetailsModalSectionTitle;
DetailsModalCompound.Column = DetailsModalColumn;

export default DetailsModalCompound;
