import createKeypadRule, {
  type CreateKeypadRuleOptions,
  type KeypadRuleHandler,
} from './createKeypadRule';
...
export interface CurrencyData {
  decimalSeparator: CreateKeypadRuleOptions['decimalSeparator'];
