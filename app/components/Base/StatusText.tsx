...
export const ConfirmedText = ({testID, ...props}: StyledTextProps) => (
  <Text
    testID={testID}
    bold
    green
...
export const PendingText = ({testID, ...props}: StyledTextProps) => {
...
export const FailedText = ({testID, ...props}: StyledTextProps) => {
  const { colors } = useTheme();
  return (
    <Text
      testID={testID}
