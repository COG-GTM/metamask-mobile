...
export const ConfirmedText = ({testID, ...props}: StatusComponentProps) => (
  <Text
    testID={testID}
    bold
    green
...
export const PendingText = ({testID, ...props}: StatusComponentProps) => {
...
export const FailedText = ({testID, ...props}: StatusComponentProps) => {
  const { colors } = useTheme();
  return (
    <Text
      testID={testID}
