...
export interface StatusTextVariantProps extends BaseTextProps {
  testID?: string;
}

export interface StatusTextProps extends BaseTextProps {
  status: string;
  context?: string;
  testID?: string;
}
...
export const ConfirmedText: React.FC<StatusTextVariantProps> = ({
  testID,
  ...props
}) => (
  <Text
...
export const PendingText: React.FC<StatusTextVariantProps> = ({
  testID,
  ...props
}) => {
...
export const FailedText: React.FC<StatusTextVariantProps> = ({
  testID,
  ...props
}) => {
  const { colors } = useTheme();
