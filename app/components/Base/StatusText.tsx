...
export const ConfirmedText = ({ testID, ...props }: BaseTextProps) => (
  <Text
    testID={testID}
    bold
    green
...
export const PendingText = ({ testID, ...props }: BaseTextProps) => {
...
export const FailedText = ({ testID, ...props }: BaseTextProps) => {
  const { colors } = useTheme();
  return (
    <Text
      testID={testID}
