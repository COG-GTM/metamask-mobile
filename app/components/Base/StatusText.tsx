...
type TextComponentProps = React.ComponentPropsWithoutRef<typeof Text>;

export const ConfirmedText: React.FC<TextComponentProps> = ({
  testID,
  ...props
}) => (
  <Text
...
export const PendingText: React.FC<TextComponentProps> = ({
  testID,
  ...props
}) => {
...
export const FailedText: React.FC<TextComponentProps> = ({
  testID,
  ...props
}) => {
  const { colors } = useTheme();
...
interface StatusTextProps extends TextComponentProps {
  status: string;
  context?: string;
}
