...
type StatusChildTextProps = React.ComponentProps<typeof Text>;

export const ConfirmedText = ({ testID, ...props }: StatusChildTextProps) => (
  <Text testID={testID} bold green style={styles.status} {...props} />
);

export const PendingText = ({ testID, ...props }: StatusChildTextProps) => {
...
export const FailedText = ({ testID, ...props }: StatusChildTextProps) => {
  const { colors } = useTheme();
  return (
    <Text
      testID={testID}
