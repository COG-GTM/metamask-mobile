...
// @ts-expect-error react-native does not ship type declarations for this internal module
...
interface RemoteImageProps
  extends Omit<ImageProps, 'source' | 'onError' | 'onLoad'> {
  /**
...
const RemoteImage = (props: RemoteImageProps) => {
  ...
  const source: ResolvedSource = resolveAssetSource(
