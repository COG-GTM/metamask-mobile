 ...
 */
export const getPrimaryChildElementIndex = (children) =>
 ...
 */
function getChildrenForHash(component) {
  ...
  if (component.type === 'Field') {
    const fieldChildren = getJsxChildren(component);
    const primaryChildIndex = getPrimaryChildElementIndex(fieldChildren);
    const primaryChild = fieldChildren[primaryChildIndex];
 ...
 */
const generateHash = memoize((component) => {
