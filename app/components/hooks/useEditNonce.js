...
export const useEditNonce = () => {
  ...
  const [proposedNonce, setProposedNonce] = useState(DEFAULT_PLACEHOLDER_NONCE_VALUE);
  const [userSelectedNonce, setUserSelectedNonce] = useState(DEFAULT_PLACEHOLDER_NONCE_VALUE);
