...
describe('useMultichainBalancesForAllAccounts', () => {
  ...
  it('returns default values when no balances are available', () => {
    ...
    Engine.getTotalEvmFiatAccountBalance.mockReturnValue(
      mockBalance
    );
  ...
  it('handles portfolio view mode correctly', () => {
    isPortfolioViewEnabled.mockReturnValue(true);
    ...
    useGetTotalFiatBalanceCrossChains.mockReturnValue(
