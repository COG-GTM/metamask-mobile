 ...
 */
export let DisplayNameVariant = /*#__PURE__*/function (DisplayNameVariant) {
  /**
   ...
   * for the address.
   */DisplayNameVariant["Saved"] = "Saved";
   ...
   */DisplayNameVariant["Recognized"] = "Recognized";


  /**
   * The address is not known to MetaMask and the user has not saved a custom
   * name.
   */DisplayNameVariant["Unknown"] = "Unknown";return DisplayNameVariant;}({});
