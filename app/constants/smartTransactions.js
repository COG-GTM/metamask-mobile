...
const ALLOWED_SMART_TRANSACTIONS_CHAIN_IDS_DEVELOPMENT = [
...
const ALLOWED_SMART_TRANSACTIONS_CHAIN_IDS_PRODUCTION = [
NETWORKS_CHAIN_ID.MAINNET,
...
export const getAllowedSmartTransactionsChainIds = () =>
isProduction() ?
