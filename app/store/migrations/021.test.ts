...
describe('Migration #21', () => {
  it('should not change state if ipfs gateway in use is not outdated', () => {
    ...
    const newState = migrate(currentState) as typeof currentState;
  ...
  it('should return same state if state objects are undefined', () => {
    ...
    const newState = migrate(stateWithoutPreferencesController) as
      typeof stateWithoutPreferencesController;
