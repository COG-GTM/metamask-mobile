...
describe('Migration #23', () => {
  ...
  it('should migrate ambiguous network IDs based on available networks configured locally', () => {
    ...
    expect((newState as unknown as MigratedState).user).toStrictEqual(userInitialState);
    expect((newState as unknown as MigratedState).engine.backgroundState).toStrictEqual(
  ...
  it('should duplicate entries where multiple configured networks match network ID', () => {
    ...
    expect((newState as unknown as MigratedState).user).toStrictEqual(
