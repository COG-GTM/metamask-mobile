...
function isValidScope(scope) {
  return (
    Object.values(EthScope).includes(scope) ||
    Object.values(BtcScope).includes(scope) ||
    Object.values(SolScope).includes(scope));
 ...
 */
export function migration66(state, migrationNumber) {
