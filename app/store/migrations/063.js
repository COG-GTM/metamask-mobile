...
export default function migrate(state) {
  ...
  const smartTransactions = smartTransactionsControllerState?.smartTransactionsState?.smartTransactions;
  ...
  const smartTransactionStatusesForUpdate = [
  ...
  const smartTransactionTxHashesForUpdate = new Set(
    ...
    filter(
      ...
      smartTransactionStatusesForUpdate.includes(smartTransaction.status)
    ).
  ...
  transactionControllerState.transactions.forEach((transaction) => {
