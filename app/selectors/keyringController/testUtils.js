...
export const MOCK_SIMPLE_KEYRING_METADATA = {
  id: '01JNDDBYN8F1350H5GJWYPDYYM',
  name: ''
};
export const MOCK_QR_KEYRING_METADATA = {
  id: '01JNDDC4GZNY0AG25TW3E4ZEDP',
  name: ''
};
export const MOCK_HD_KEYRING_METADATA = {
  id: '01JPM6NFVGW8V8KKN34053JVFT',
  name: ''
};

export const MOCK_KEYRING_METADATA = [
 ...
 * }
 */
export const MOCK_KEYRINGS_WITH_METADATA =
...
export const MOCK_KEYRING_CONTROLLER = {
  isUnlocked: true,
