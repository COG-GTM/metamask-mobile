...
import {
  selectChainId,
  selectEvmChainId,
  selectProviderConfig as selectEvmProviderConfig } from
'../networkController';
import {
  selectInternalAccounts,
  selectSelectedInternalAccount } from
'../accountsController';
 ...
 */
export let MultichainNativeAssets = function (MultichainNativeAssets) {MultichainNativeAssets["Bitcoin"] =
  `${BtcScope.Mainnet}/slip44:0`;MultichainNativeAssets["BitcoinTestnet"] =
  `${BtcScope.Testnet}/slip44:0`;MultichainNativeAssets["Solana"] =
  `${SolScope.Mainnet}/slip44:501`;MultichainNativeAssets["SolanaDevnet"] =
  `${SolScope.Devnet}/slip44:501`;MultichainNativeAssets["SolanaTestnet"] =
  `${SolScope.Testnet}/slip44:501`;return MultichainNativeAssets;}({});
 ...
 */
export const MULTICHAIN_NETWORK_TO_ASSET_TYPES =
 ...
 */
const selectMultichainBalancesControllerState = (state) =>
...
export function selectMultichainCoinRates(state) {
 ...
 */
const selectMultichainTransactionsControllerState = (state) =>
...
export function selectMultichainHistoricalPrices(state) {
  return state.engine.backgroundState.MultichainAssetsRatesController.
  historicalPrices;
}
