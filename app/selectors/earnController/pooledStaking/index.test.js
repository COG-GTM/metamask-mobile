...
import {
  ...
  MOCK_VAULT_DAILY_APYS } from
'../../../components/UI/Stake/components/PoolStakingLearnMoreModal/mockVaultRewards';
import {
  MOCK_VAULT_DATA,
  MOCK_POOLED_STAKES_DATA,
  MOCK_EXCHANGE_RATE } from
'../../../components/UI/Stake/__mocks__/earnControllerMockData';
