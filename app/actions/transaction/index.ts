...
/**
 * Asset object accepted by the transaction actions. Only `isETH` and `tokenId`
 * are read to derive the asset type, but callers pass a wide variety of richer
 * asset objects (typed assets as well as plain object literals).
 */
export type TransactionAsset =
  | { isETH?: boolean; tokenId?: string }
  | Record<string, unknown>;

/**
 * A loosely-typed transaction object. The legacy transaction state stores an
 * open-ended object that is refined elsewhere in the app.
 */
