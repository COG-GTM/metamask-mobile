...
/**
 * Asset used to start or update a transaction. Only the fields read by the
 * action creators (`isETH`, `tokenId`) are declared; callers pass richer asset
 * objects (tokens, collectibles, native currency), so arbitrary extra fields
 * are allowed.
 */
...
/**
 * A transaction object holding an arbitrary set of transaction params.
 */
