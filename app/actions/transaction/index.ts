...
/**
 * Asset used to start or update a transaction. The reducer only reads `isETH`
 * and `tokenId` to derive the asset type; other fields vary by asset kind.
 */
...
/**
 * Transaction object handled by the transaction reducer. Fields are optional
 * because callers dispatch partial updates.
 */
