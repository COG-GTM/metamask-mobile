...
export interface StoreFaviconAction extends Favicon {
 ...
 *
 * @param id - The Tab ID
 * @param data - The tab properties to update
 */
export function updateTab(id: number, data: BrowserTabData): UpdateTabAction {
  return {
    type: UPDATE_TAB,
    id,
    data,
