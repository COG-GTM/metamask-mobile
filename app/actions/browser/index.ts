...
export interface AddToHistoryAction extends AddToHistoryPayload {
...
export interface StoreFaviconPayload {
  origin: string;
  url: string;
}

export interface StoreFaviconAction extends StoreFaviconPayload {
...
export function addToHistory({
  url,
  name,
}: AddToHistoryPayload): AddToHistoryAction {
  return {
 ...
 */
export function updateTab(id: number, data: TabUpdateData): UpdateTabAction {
  return {
    type: UPDATE_TAB,
    id,
    data,
...
export function storeFavicon({
  origin,
  url,
}: StoreFaviconPayload): StoreFaviconAction {
  return {
