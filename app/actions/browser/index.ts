...
/**
 * Browser action types available for Redux
 */
...
// Keep backward compatibility for the old BrowserActionTypes object
export const BrowserActionTypes = {
  ADD_TO_VIEWED_DAPP: BrowserActionType.ADD_TO_VIEWED_DAPP,
};

export interface AddToViewedDappAction extends Action {
  type: BrowserActionType.ADD_TO_VIEWED_DAPP;
  hostname: string;
}

export interface AddToHistoryAction extends Action {
  type: BrowserActionType.ADD_TO_BROWSER_HISTORY;
  url: string;
  name: string;
}

export interface ClearHistoryAction extends Action {
...
export interface AddToWhitelistAction extends Action {
  type: BrowserActionType.ADD_TO_BROWSER_WHITELIST;
  url: string;
}

export interface CloseAllTabsAction extends Action {
  type: BrowserActionType.CLOSE_ALL_TABS;
}

export interface CreateNewTabAction extends Action {
...
export interface SetActiveTabAction extends Action {
  type: BrowserActionType.SET_ACTIVE_TAB;
  id: number;
}

export interface UpdateTabAction extends Action {
  type: BrowserActionType.UPDATE_TAB;
  id: number;
  data: Record<string, unknown>;
}

export interface StoreFaviconAction extends Action {
