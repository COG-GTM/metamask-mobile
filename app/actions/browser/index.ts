...
/**
 * Updates an exiting tab
 *
 * @param id - The Tab ID
 * @param data - tab metadata to merge
 */
export function updateTab(id: number, data: UpdateTabPayload): UpdateTabAction {
  return {
    type: UPDATE_TAB,
    id,
    data,
...
export function storeFavicon({
  origin,
  url,
}: FaviconPayload): StoreFaviconAction {
  return {
