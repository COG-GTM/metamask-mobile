...
/**
 * Keep backward-compatible BrowserActionTypes export
 */
...
export interface AddToViewedDappAction
  extends Action<BrowserActionType.ADD_TO_VIEWED_DAPP> {
  hostname: string;
}

export interface AddToHistoryAction
  extends Action<BrowserActionType.ADD_TO_BROWSER_HISTORY> {
  url: string;
  name: string;
}

export interface ClearHistoryAction
  extends Action<BrowserActionType.CLEAR_BROWSER_HISTORY> {
  id: number;
...
export interface AddToWhitelistAction
  extends Action<BrowserActionType.ADD_TO_BROWSER_WHITELIST> {
  url: string;
}
...
export interface CreateNewTabAction
  extends Action<BrowserActionType.CREATE_NEW_TAB> {
  url: string;
  linkType?: string;
  id: number;
}
...
export interface SetActiveTabAction
  extends Action<BrowserActionType.SET_ACTIVE_TAB> {
  id: number;
}
...
export interface StoreFaviconAction
  extends Action<BrowserActionType.STORE_FAVICON_URL> {
  origin: string;
  url: string;
}
