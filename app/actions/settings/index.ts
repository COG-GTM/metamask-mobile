...
export interface SetSearchEngineAction extends Action {
  type: SettingsActionType.SET_SEARCH_ENGINE;
  searchEngine: string;
}

export interface SetShowHexDataAction extends Action {
  type: SettingsActionType.SET_SHOW_HEX_DATA;
  showHexData: boolean;
}

export interface SetShowCustomNonceAction extends Action {
  type: SettingsActionType.SET_SHOW_CUSTOM_NONCE;
  showCustomNonce: boolean;
}

export interface SetShowFiatOnTestnetsAction extends Action {
  type: SettingsActionType.SET_SHOW_FIAT_ON_TESTNETS;
  showFiatOnTestnets: boolean;
}

export interface SetHideZeroBalanceTokensAction extends Action {
  type: SettingsActionType.SET_HIDE_ZERO_BALANCE_TOKENS;
  hideZeroBalanceTokens: boolean;
}

export interface SetLockTimeAction extends Action {
  type: SettingsActionType.SET_LOCK_TIME;
  lockTime: number;
}

export interface SetPrimaryCurrencyAction extends Action {
  type: SettingsActionType.SET_PRIMARY_CURRENCY;
  primaryCurrency: string;
}

export interface SetUseBlockieIconAction extends Action {
  type: SettingsActionType.SET_USE_BLOCKIE_ICON;
  useBlockieIcon: boolean;
}

export interface ToggleBasicFunctionalityAction extends Action {
  type: SettingsActionType.TOGGLE_BASIC_FUNCTIONALITY;
  basicFunctionalityEnabled: boolean;
}

export interface ToggleDeviceNotificationAction extends Action {
  type: SettingsActionType.TOGGLE_DEVICE_NOTIFICATIONS;
  deviceNotificationEnabled: boolean;
}

export interface SetTokenSortConfigAction extends Action {
...
export function setShowHexData(
  showHexData: boolean,
): SetShowHexDataAction {
  return {
    type: SettingsActionType.SET_SHOW_HEX_DATA,
