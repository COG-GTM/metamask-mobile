const SET_SEARCH_ENGINE = 'SET_SEARCH_ENGINE' as const;
const SET_SHOW_HEX_DATA = 'SET_SHOW_HEX_DATA' as const;
const SET_SHOW_CUSTOM_NONCE = 'SET_SHOW_CUSTOM_NONCE' as const;
const SET_SHOW_FIAT_ON_TESTNETS = 'SET_SHOW_FIAT_ON_TESTNETS' as const;
const SET_HIDE_ZERO_BALANCE_TOKENS =
  'SET_HIDE_ZERO_BALANCE_TOKENS' as const;
const SET_LOCK_TIME = 'SET_LOCK_TIME' as const;
const SET_PRIMARY_CURRENCY = 'SET_PRIMARY_CURRENCY' as const;
const SET_USE_BLOCKIE_ICON = 'SET_USE_BLOCKIE_ICON' as const;
const TOGGLE_BASIC_FUNCTIONALITY = 'TOGGLE_BASIC_FUNCTIONALITY' as const;
const TOGGLE_DEVICE_NOTIFICATIONS =
  'TOGGLE_DEVICE_NOTIFICATIONS' as const;
const SET_TOKEN_SORT_CONFIG = 'SET_TOKEN_SORT_CONFIG' as const;
