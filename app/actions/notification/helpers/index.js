 ...
 */
export const fetchAccountNotificationSettings = async (accounts) => {
  assertIsFeatureEnabled();
 ...
 */
export const deleteNotificationsForAccount = async (accounts) => {
  assertIsFeatureEnabled();
 ...
 */
export const createNotificationsForAccount = async (accounts) => {
  assertIsFeatureEnabled();
