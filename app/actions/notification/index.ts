...
export function modifyOrShowTransactionNotificationById({
  ...
  transaction,
  status,
}: TransactionNotification): ModifyOrShowTransactionNotificationAction {
  return {
...
export function modifyOrShowSimpleNotificationById({
  ...
  description,
  status,
}: SimpleNotification): ModifyOrShowSimpleNotificationAction {
  return {
...
export function showTransactionNotification({
  ...
  transaction,
  status,
}: TransactionNotification): ShowTransactionNotificationAction {
  return {
