...
export const HIDE_CURRENT_NOTIFICATION = ACTIONS.HIDE_CURRENT_NOTIFICATION;
export const HIDE_NOTIFICATION_BY_ID = ACTIONS.HIDE_NOTIFICATION_BY_ID;
export const MODIFY_OR_SHOW_TRANSACTION_NOTIFICATION = ACTIONS.MODIFY_OR_SHOW_TRANSACTION_NOTIFICATION;
export const MODIFY_OR_SHOW_SIMPLE_NOTIFICATION = ACTIONS.MODIFY_OR_SHOW_SIMPLE_NOTIFICATION;
export const REPLACE_NOTIFICATION_BY_ID = ACTIONS.REPLACE_NOTIFICATION_BY_ID;
export const REMOVE_NOTIFICATION_BY_ID = ACTIONS.REMOVE_NOTIFICATION_BY_ID;
export const REMOVE_CURRENT_NOTIFICATION = ACTIONS.REMOVE_CURRENT_NOTIFICATION;
export const REMOVE_NOT_VISIBLE_NOTIFICATIONS = ACTIONS.REMOVE_NOT_VISIBLE_NOTIFICATIONS;
export const SHOW_SIMPLE_NOTIFICATION = ACTIONS.SHOW_SIMPLE_NOTIFICATION;
export const SHOW_TRANSACTION_NOTIFICATION = ACTIONS.SHOW_TRANSACTION_NOTIFICATION;
...
interface ModifyOrShowTransactionNotificationAction {
  ...
  autodismiss: number;
  transaction: TransactionNotificationPayload;
  status: string;
}
