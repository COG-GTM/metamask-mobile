# Session A — Redux state foundation

**Slice:** `app/reducers/**` and `app/actions/**`
**Files:** 25
**Branch:** `devin/ts-migration-a-redux-state`
**File list (authoritative):** `docs/ts-migration/filelists/A.txt`

## Slice-specific notes

- This slice is the **typed foundation** other slices consume, so it is the highest priority:
