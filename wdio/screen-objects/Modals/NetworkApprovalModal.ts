...
class NetworkApprovalModal {
  ...
  async isApproveNetworkModal() {
    const element = (await this.ApproveNetworkModal) as WebdriverIO.Element;
    await element.waitForDisplayed();
  }

  async isApproveNetworkButton() {
    const element = (await this.ApproveNetworkApproveButton) as WebdriverIO.Element;
    await element.waitForDisplayed();
  }

  async isCloseNetworkButton() {
    const element = (await this.closeNetworkButton) as WebdriverIO.Element;
    await element.waitForDisplayed();
  }
  ...
  async isSwitchToNetworkButtonDisplayed() {
    const element = (await this.SwitchToNetworkButton) as WebdriverIO.Element;
    await element.waitForDisplayed();
  }
}
