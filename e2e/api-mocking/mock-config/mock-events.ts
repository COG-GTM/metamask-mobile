...
import gasApiResponses from '../mock-responses/gas-api-responses.json';

const suggestedGasApiResponses = gasApiResponses.suggestedGasApiResponses as Record<string, unknown>;
const suggestedGasFeesApiGanache = gasApiResponses.suggestedGasFeesApiGanache;
