...
export const startMockServer = async (
  ...
  console.log(`Mockttp server running at http://localhost:${usedPort}`);
  ...
  await mockServer
    ...
    .thenCallback(async (request) => {
      ...
      const matchingEvent = methodEvents.find(
        ...
        (event: any) => event.urlEndpoint === urlEndpoint,
      );
 ...
 */
export const stopMockServer = async (mockServer: { stop: () => Promise<void> }) => {
