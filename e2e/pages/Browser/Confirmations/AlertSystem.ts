...
class AlertSystem {
  ...
  get securityAlertResponseFailedBanner() {
    Matchers.getElementByText(ConfirmationTopSheetSelectorsText.BANNER_FAILED_TITLE);
    return Matchers.getElementByText(ConfirmationTopSheetSelectorsText.BANNER_FAILED_DESCRIPTION);
  }

  get securityAlertResponseMaliciousBanner() {
    Matchers.getElementByText(ConfirmationTopSheetSelectorsText.BANNER_MALICIOUS_TITLE);
    return Matchers.getElementByText(ConfirmationTopSheetSelectorsText.BANNER_MALICIOUS_DESCRIPTION);
  }
