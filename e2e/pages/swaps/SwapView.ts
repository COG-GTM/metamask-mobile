...
} from '../../selectors/swaps/SwapsView.selectors';
...
class SwapView {
  ...
  async isButtonEnabled(
    targetElement: Detox.IndexableNativeElement | Detox.NativeElement,
  ) {
    const attributes = (await targetElement.getAttributes()) as {
      enabled?: boolean;
    };
