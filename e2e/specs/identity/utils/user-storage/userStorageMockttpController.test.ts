...
} from './userStorageMockttpController';
import { USER_STORAGE_FEATURE_NAMES } from '@metamask/profile-sync-controller/sdk';

describe('UserStorageMockttpController', () => {
  let mockServer: MockttpServerLike;
  // Track which arguments narrow further down — mockttp's runtime instance is
  // structurally compatible with `MockttpServerLike`.
  void ({} as Mockttp);
  ...
  describe('mimics user storage behaviour', () => {
    mockServer = getLocal({ cors: true }) as unknown as MockttpServerLike;
