...
describe(SmokeNotifications('Notification Mark As Read'), () => {
  ...
  it('shows notification in the menu', async () => {
  ...
  it('marks notification as read after viewing details', async () => {
    const notificationId = getMockWalletNotificationItemId();

    // Tap on notification to view details (this triggers mark-as-read)
