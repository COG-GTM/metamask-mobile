...
describe(SmokeNetworkAbstractions('Notification Settings Flow'), () => {
  ...
  it('disables notifications', async () => {
    ...
    await Assertions.checkIfNotVisible(
      /** @type {Promise<import('detox/detox').IndexableNativeElement>} */ NotificationSettingsView.pushNotificationsToggle,
    );
    await Assertions.checkIfNotVisible(
      /** @type {Promise<import('detox/detox').IndexableNativeElement>} */ NotificationSettingsView.featureAnnonucementsToggle,
    );
    await Assertions.checkIfNotVisible(
      /** @type {Promise<import('detox/detox').IndexableNativeElement>} */ NotificationSettingsView.accountActivitySection,
    );
  });
});
