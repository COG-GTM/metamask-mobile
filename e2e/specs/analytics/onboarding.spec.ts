...
import { getEventsPayloads, MetaMetricsEventPayload } from './helpers';
    ...
    await withFixtures(
      ...
      async ({ mockServer }: { mockServer: Mockttp }) => {
        ...
        await Assertions.checkIfObjectsMatch(
          (walletSetupCompletedEvent as MetaMetricsEventPayload).properties,
          {
        ...
        await Assertions.checkIfObjectsMatch(
          (walletImportedEvent as MetaMetricsEventPayload).properties,
          {
