...
import { getEventsPayloads, AnalyticsMockServer } from './helpers';
  ...
  it('should track analytics events during wallet import flow', async () => {
    await withFixtures(
      ...
      async ({ mockServer }) => {
        ...
        const events = await getEventsPayloads(mockServer as AnalyticsMockServer, [
